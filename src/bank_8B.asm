...
InitFunc_CinematicSpriteObject_IntroMotherBrainExplosion_Big:
    ...
    TAX 
    LDA.W #$0038 
    CLC : ADC.W .Xposition,X 
    STA.W $1A7D,Y 
    LDA.W #$006F 
    CLC : ADC.W .Yposition,X 
    STA.W $1A9D,Y 
...
.timerExpired:
    ...
    TAX 
    LDA.W $1991 
    CLC : ADC.W .shakingXVelocities+2,X 
    STA.W $1991 
    LDA.W $1993 
...
.loopProcess:
    ...
    TAX 
    LDA.W $000C,Y 
    CLC : ADC.W ShootingStar_Table_Xaccel,X 
    CLC : ADC.W ShootingStar_Table_Xaccel,X 
    STA.W $000C,Y 
    LDA.W $000E,Y 
    CLC : ADC.W ShootingStar_Table_Yaccel,X 
    CLC : ADC.W ShootingStar_Table_Yaccel,X 
    STA.W $000E,Y 
    BRA + 
