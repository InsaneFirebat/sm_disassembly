...
Function_Boulder_WaitForSamusToGetNear:
    ...
    BMI .return 
    CMP.L $7E780C,X : BPL .return 
    LDA.W $0FB0,X : BNE .left 
    JSL.L Get_SamusX_minus_EnemyX 
    BMI .return 
    CMP.L $7E7800,X : BPL .return 
    LDA.W #Function_Boulder_Falling : STA.W $0FA8,X 
    LDA.L $7E780E,X : BEQ .return 
...
Function_Boulder_Falling:
    ...
    LDA.W $0F7E,X : CMP.L $7E780A,X : BMI .notReachedTarget 
...
Function_Boulder_Bounce_Rising:
    ...
    TAY 
    JSR.W MoveBoulderVertically 
    LDA.W $0FAC,X : SEC : SBC.W #$0100 : STA.W $0FAC,X 
...
.negativeSpeedTableIndex:
    ...
    ASL #3
    TAY 
    LDA.W $0FB0,X : BEQ .right 
    INY #4
    .right:
    JSR.W MoveBoulderHorizontally 
    LDA.W $0FAA,X : CLC : ADC.W #$0020 : STA.W $0FAA,X 
    CMP.W #$5000 : BMI .return 
...
Function_Boulder_Bounce_Falling:
    ...
    LDA.W $0FB0,X : CMP.W #$0002 : BNE .right 
    LDA.W $0F86,X : ORA.W #$0200 : STA.W $0F86,X 
...
Function_Boulder_Rolling:
    ...
    TAY 
    LDA.W CommonEnemySpeeds_QuadraticallyIncreasing,Y : STA.B $12 
    LDA.W CommonEnemySpeeds_QuadraticallyIncreasing+2,Y : CLC : ADC.L $7E7802,X : STA.B $14 
    PHY 
    JSL.L MoveEnemyDownBy_14_12 
    PLY 
    LDA.W $0F7E,X : SEC : SBC.L $7E7802,X : STA.W $0F7E,X 
    LDA.W $0FB0,X : BEQ .right 
    INY #4
    .right:
    LDA.W CommonEnemySpeeds_QuadraticallyIncreasing,Y : STA.B $12 
...
.notCollidedWithWall:
  ...
  + LDA.W $0F7E,X : CMP.L $7E7806,X : BNE .return 
    LDA.W $0F80,X : CMP.L $7E7804,X : BNE .return 
...
MoveBoulderHorizontally:
    LDX.W $0E54 
    LDA.W $0F7C,X : CLC : ADC.W CommonA6EnemySpeeds_QuadraticallyIncreasing,Y : BCC + 
    INC.W $0F7A,X 

  + STA.W $0F7C,X 
    LDA.W $0F7A,X : CLC : ADC.W CommonA6EnemySpeeds_QuadraticallyIncreasing+2,Y : STA.W $0F7A,X 
    RTS 
...
UNUSED_MoveBoulderHorizontallyWithLinearSpeedTable_A68A1D:
    LDX.W $0E54 
    LDA.W $0F7C,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing+2,Y : BCC + 
    INC.W $0F7A,X 

  + STA.W $0F7C,X 
    LDA.W $0F7A,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing,Y : STA.W $0F7A,X 
    RTS 
endif ; !FEATURE_KEEP_UNREFERENCED
...
MoveBoulderVertically:
    LDX.W $0E54 
    LDA.W $0F80,X : CLC : ADC.W CommonEnemySpeeds_QuadraticallyIncreasing,Y : BCC + 
    INC.W $0F7E,X 

  + STA.W $0F80,X 
    LDA.W $0F7E,X : CLC : ADC.W CommonEnemySpeeds_QuadraticallyIncreasing+2,Y : STA.W $0F7E,X 
    RTS 
...
Function_Kzan_Falling:
    ...
    LDA.W $0F7E,X : CMP.W $0FAE,X : BMI .notReachedTarget 
...
.notTouchingSamusFromBelow:
    LDA.L $7E7804,X : CLC : ADC.W #$0008 : CMP.W #$0200 : BMI + 
    LDA.W #$0200 
...
Function_Kzan_Rising:
    ...
    LDA.W $0F7E,X : CMP.W $0FAC,X : BPL .notReachedTarget 
    LDA.W #Function_Kzan_WaitingToFall : STA.W $0FA8,X 
...
CheckIfKzanIsTouchingSamusFromBelow:
  ...
  + SEC : SBC.W $0AFE : BCC .YPosition 
    CMP.W $0F82,X : BCC .YPosition 
    LDA.W #$0000 
    RTL 


.YPosition:
    LDA.W $0AFA : CLC : ADC.W #$0005 : SEC : SBC.W $0F7E,X : BPL .returnNotTouchingSamus 
    EOR.W #$FFFF 
    INC A 
    SEC : SBC.W $0B00 : BCC .returnTouchingSamus 
    CMP.W $0F84,X : BEQ .returnTouchingSamus 
...
Instruction_Hibashi_ActivityFrame0:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_0 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame1:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_1 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame2:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_2 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame3:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_3 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame4:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_4 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame5:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_5 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame6:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_6 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame7:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_7 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame8:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_8 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame9:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_9 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrameA:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_A : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrameB:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_B : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrameC:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_C : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrameD:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_D : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrameE:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_E : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrameF:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_F : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame10:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_10 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame11:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_11 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame12:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_12 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame13:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_13 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame14:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_14 : STA.W $0FBE,X 
...
Instruction_Hibashi_ActivityFrame15:
    LDX.W $0E54 
    LDA.W $0FAE,X : SEC : SBC.W Hibashi_YOffset_15 : STA.W $0FBE,X 
...
Function_Puromi_Active:
    ...
    STA.B $1E 
    PHA 
    CMP.L $7E8026,X : BEQ .matchingExplosionReason 
    LDX.W $0E54 
    LDA.W $0F7A,X : STA.B $12 
    LDA.W $0F7E,X : STA.B $14 
    LDA.W #$002E : STA.B $16 
    ...
    LDA.W $0F7A,X : STA.B $12 
    LDA.W $0F7E,X : STA.B $14 
    LDA.B $1A : CLC : ADC.W #$002C : STA.B $16 
    LDA.L $7E8028,X : STA.B $18 
    JSL.L Create_Sprite_Object 
...
HandlePuromiProjectiles:
    LDX.W $0E54 
    LDA.W #$0008 : STA.L $7E8014,X 
    LDA.L $7E8002,X : CLC : ADC.L $7E8018,X : STA.B $24 

.loop:
    LDX.W $0E54 
    LDA.B $24 : SEC : SBC.L $7E8016,X : STA.B $24 
    PHX 
    LDA.L $7E8014,X : CLC : ADC.W $0E54 : TAX 
    LDA.L $7E7800,X 
    TAY 
    ...
    STA.B $1E 
    PHA 
    CMP.L $7E7810,X : BEQ .matchingExplosionReason 
    PHX 
    LDX.W $0E54 
...
.loop:
    ...
    STA.B $1E 
    PHA 
    CMP.L $7E7830,X : BEQ .matchingExplosionReason 
    PHX 
    LDX.W $0E54 
    ...
    LDA.L $7EF0F8,X : STA.B $12 
    LDA.L $7EF1F8,X : STA.B $14 
    LDA.W #$002C : CLC : ADC.B $1A : STA.B $16 
    LDA.B $26 : STA.B $18 
    JSL.L Create_Sprite_Object 
    JSR.W PlayPuromiExplosionSFX 
    PLX 
...
ClampAngle_CheckInactivityCondition:
    ...
    PLA 
    CMP.L $7E801C,X : BMI .afterFinish 
    CMP.L $7E8006,X : BPL .beforeStart 
    BRA .return 


.notClockwise:
    PLA 
    CMP.L $7E801C,X : BPL .afterFinish 
    CMP.L $7E8006,X : BMI .beforeStart 
    BRA .return 


.afterFinish:
    INC.B $1C 
    LDA.L $7E801C,X : BRA .return 


.beforeStart:
    LDA.L $7E8006,X : BRA .return 
...
CheckExplosionCondition:
    ...
    LDA.W $0FB0,X : BNE .notClockwise 
    PLA 
    CMP.L $7E801E,X : BMI .clockwiseFalling 
    CMP.L $7E8020,X : BMI .clockwiseRising 
    LDA.W #$0000 : BRA .return 


.notClockwise:
    PLA 
    CMP.L $7E801E,X : BPL .antiClockwiseFalling 
    CMP.L $7E8020,X : BPL .antiClockwiseRising 
    LDA.W #$0000 : BRA .return 
...
PlayPuromiExplosionSFX:
    PHY : PHX 
    LDA.B $1E : CMP.W #$0002 : BEQ .return 
...
HandleMiniKraidSpike:
    ...
    STX.B $12 
    CLC : ADC.B $12 : TAX 
    LDA.L $7E7806,X : BEQ .timerExpired 
    DEC A 
    STA.L $7E7806,X 
    PLX 
    RTS 
...
Instruction_MiniKraid_FireSpitRight:
    PHY 
    LDY.W #$0008 
    LDA.W #$0004 : BRA FireMiniKraidSpit_Common 
...
.manualReturn:
    LDA.W $093F : BNE .return 
    LDA.L $7E7804 : BEQ HandleBabyMetroidCapsuleInteractions 
...
RNGChanceToChooseNewTailSwingDelay:
    LDA.W $05E5 : CMP.W #$FF00 : BCC .return 
    LDA.W $05E5 ; >.<
    AND.W #$000F 
    ADC.W #$0007 : STA.L $7E201E 
...
HandleBabyMetroidCapsuleInteractions:
    ...
    LDA.L $7E7804 : BEQ EnemyGraphicsDrawnHook_RidleyCeres_DrawBabyMetroidAndDoor 
...
EnemyGraphicsDrawnHook_RidleyCeres_DrawBabyMetroidAndDoor:
    LDA.W $093F : BNE .skipBaby 
    JSR.W DrawBabyMetroid 

.skipBaby:
    LDA.W $0FEA : BEQ .return 
...
Function_Ridley_Startup_EyesAppear_Wait:
    ...
    TAY 
    INC.W $0FB2 
    LDA.W $0FB2 : CMP.W #$0001 : BCC .return 
    STZ.W $0FB2 
    TYX 
...
Function_Ridley_Startup_MainBodyAppears:
    INC.W $0FB2 
    LDA.W $0FB2 : CMP.W #$0002 : BCC .return 
    STZ.W $0FB2 
    LDY.W $0FB0 
    LDA.W #$0122 : STA.B $12 
    LDA.W #$01E2 : STA.B $14 
...
.done:
    LDA.W $079F : CMP.W #$0002 : BNE .notCeres 
...
Function_Ridley_Startup_RidleyRoars:
    ...
    LDA.W $079F : CMP.W #$0002 : BEQ Function_Ridley_Startup_RidleyRoars_return 
...
Function_Ridley_Startup_ColorBGInNorfair_RaiseAcid_MainAI:
    LDA.W $079F : CMP.W #$0002 : BNE .ceres 
    DEC.W $0FB2 
    BPL Function_Ridley_Startup_RidleyRoars_return 
...
Function_RidleyCeres_StartupLiftoff_FacingLeft:
    ...
    LDA.W $0F7E : CMP.W #$0070 : BMI .reachedTarget 
    RTS 
...
Function_RidleyCeres_StartupLiftoff_FacingLeft_SlowingDown:
    ...
    LDA.W $0F7E : CMP.W #$0050 : BPL .return 
...
Function_RidleyCeres_MainAI:
    LDA.L $7E781A : CMP.W #$0064 : BCS .shot100Times 
    LDA.W $09C2 : CMP.W #$001E : BPL .SamusNotLowEnergy 
    LDA.W #$0000 : STA.L $7E7802 
...
Function_RidleyCeres_StartFireballing:
  ...
  + STA.W $0FAC 
    ...
    LDY.W #$0000 
    JSR.W AccelerateCeresRidleyTowardDesiredXY 
    LDA.W $0F7E : CMP.W #$0050 : BMI .reachedTarget 
...
Function_RidleyCeres_Lunging:
    LDA.W $0AF6 : STA.B $12 
    LDA.W $0AFA : SEC : SBC.W #$0044 : CMP.W #$0040 : BPL + 
    LDA.W #$0040 
...
Function_RidleyCeres_FlyToSwoopSetupPosition:
    ...
    LDY.W #$0001 
    JSR.W AccelerateCeresRidleyTowardDesiredXY 
    LDA.W $0F7E : CMP.W #$0060 : BMI .reachedTarget 
    RTS 
...
Function_RidleyCeres_FlyAwayToEndFight:
    ...
    LDY.W #$0001 
    JSR.W AccelerateCeresRidleyTowardDesiredXY 
    LDA.W $0F7E : CMP.W #$FF80 : BMI Function_RidleyCeres_FlyAwayToEndFight_reachedTarget 
...
.dontPushSamus:
    LDA.W CeresRidleyMode7GetawayBackgroundParameters,X : CMP.W #$FFFF : BEQ .done 
    STA.L $7E8020 
...
Mode7Math_A6AC0E:
  ...
  + STA.B $26 
    LDA.B $12 : BRA Mode7Math_Common_A6AC30 
...
Mode7Math_Common_A6AC30:
    ...
    AND.W #$01FE 
    TAX 
    LDA.L SineCosineTables_8bitSine_SignExtended,X : BEQ .return 
    STA.B $16 
    BPL + 
    EOR.W #$FFFF 
    INC A 
...
MainAI_Ridley:
    LDA.L $7E8008 : SEC : SBC.W #$0004 : BPL .greaterThan4 
    LDA.W #$0000 
...
.manualReturn:
    LDA.L $7E7804 : BEQ .notActiveNotHoldingSamus 
    JSR.W MakeRidleysWingsAndTailFlashWhenHit 
    JSR.W HandleMovementAndMainBodyWallCollisions 
    JSR.W HandleWingFlapping 
    JSR.W HandleRidleyTailAI 
    ...
    JSR.W DrawRidleysWings 
    JSR.W AnimateRidleysRibs 
    LDA.L $7E7836 : BEQ .notActiveNotHoldingSamus 
...
.manualReturn:
    LDA.L $7E7804 : BEQ .checkHoldingSamus 
    JSR.W HandleMovementAndMainBodyWallCollisions 
    JSR.W HandleWingFlapping 
    JSR.W HandleRidleyTailAI 
...
.timeIsFrozen:
    ...
    JSR.W DetermineAndSetRidleySpeedAndColorPalette 
    JSR.W AnimateRidleysRibs 
    LDA.L $7E8008 : CLC : ADC.W #$0001 : CMP.W RidleyHurtAIMaxTimer : BMI + 
    LDA.W RidleyHurtAIMaxTimer 

  + STA.L $7E8008 
    LDA.L $7E8008 ; >.<
    CMP.W RidleyHurtAIMaxTimer : BMI .return 

.checkHoldingSamus:
    LDA.L $7E7836 : BEQ .return 
    JSR.W MoveSamusToWithinRidleysClawsIfHolding 
...
GetNewRidleyAIScript:
    ...
    CMP.W #$0003 : BNE .SamusNotSpinJumping 
    LDA.W #CheckIfRidleyBelowHalfHealth_spinJumping : STA.B $12 
    RTS 


.SamusNotSpinJumping:
    LDA.W $0F8C : BNE .RidleyNotDead 
...
.RidleyNotDead:
    CMP.W #$3840 : BPL .notBelowHalfHealth 
...
CheckIfRidleyBelowHalfHealth:
    ...
    LDA.W $0F8C : CMP.W #$2328 : BPL .notBelowHalf 
...
Function_Ridley_USwoop_FirstDive:
    LDA.L $7E7820 : BNE .notFacingLeft 
    LDA.W #$FFE0 : STA.B $12 
    LDA.W #$FE00 : STA.B $14 
    BRA + 
...
FlyTowardTargetXPositionAndSamusYPosition:
    LDA.W $0AFA : CMP.W #$0160 : BMI .minY160 
    LDA.W #$0160 
...
.minY160:
    ...
    LDA.W #$0001 : STA.L $7E2004 
    LDA.W $0A1F : AND.W #$00FF 
    CMP.W #$0003 : BNE .returnSamusSpinJumping 
    LDA.W $05E5 : AND.W #$00FF 
    CMP.W #$0080 : BCC .returnSamusNotSpinJumping 
    LDA.L $7E781E : BNE .returnSamusNotSpinJumping 
    LDA.L $7E7820 
    DEC A 
...
Function_Ridley_FlyToTailbouncingStartPosition:
    LDA.W $0F7E : CMP.W #$0120 : BMI .startTailbouncing 
    LDA.L $7E7820 
    ASL A 
    TAY 
...
.grabFailed:
    LDA.W $0FAC : CLC : ADC.L $7E200C : CMP.W #$0600 : BMI .minimum600 
    LDA.W #$0600 
...
.minimum600:
    ...
    LDA.L $7E20A6 : CLC : ADC.W #$000C : STA.B $14 
    LDA.W #$0009 
    LDY.W #EnemyProjectile_MiscDust 
    JSL.L SpawnEnemyProjectileY_ParameterA_RoomGraphics 
    ...
    LDA.L $7E800C 
    INC A 
    CMP.W #$0002 : BMI .everyOtherBounce 
    LDA.L $7E7820 
    DEC A 
    BEQ .RidleyTurning 
    LDA.W #InstList_Ridley_FacingLeft_Fireballing_0 : JSR.W SetRidleyInstList 
...
Function_Ridley_Tailbouncing_HitGround:
    ...
    DEC.W $0FB2 
    BMI .nextFunction 
    LDA.W $0FAC : CLC : ADC.L $7E200E : STA.W $0FAC 
    BMI .return 
...
CheckForTailbounceCollisionWithSolidBlock:
    LDA.L $7E20A4 
    TAX 
    LDA.L $7E20A6 : CLC : ADC.W #$0010 : TAY 
    JSL.L CheckForCollisionWithNonAirBlock 
    BCS .return 
    LDA.L $7E2090 
    TAX 
    LDA.L $7E2092 : CLC : ADC.W #$0012 : TAY 
    JSL.L CheckForCollisionWithNonAirBlock 
    BCS .return 
    LDA.L $7E207C 
    TAX 
    LDA.L $7E207E : CLC : ADC.W #$0012 : TAY 
    JSL.L CheckForCollisionWithNonAirBlock 
    BCS .return 
    LDA.L $7E2068 
    TAX 
    LDA.L $7E206A : CLC : ADC.W #$0012 : TAY 
    JSL.L CheckForCollisionWithNonAirBlock 
    BCS .return 
    LDA.L $7E2054 
    TAX 
    LDA.L $7E2056 : CLC : ADC.W #$0012 : TAY 
    JSL.L CheckForCollisionWithNonAirBlock 
    BCS .return 
    NOP ; >.<
...
AttemptToGrabSamus_SkipSpinCheck:
    ...
    ASL A 
    TAY 
    LDA.W HoldingSamusXDispacement,Y : CLC : ADC.W $0F7A : STA.B $12 
    LDA.L $7E783A 
    TAY 
    LDA.W HoldingSamusYDispacement,Y : CLC : ADC.W $0F7E : STA.B $14 
...
.storeXSpeed:
    ...
    BMI + 
    LDA.W $0F7A : CMP.L $7E8004 : BMI .crossedLeftBoundary 
    CMP.L $7E8006 : BPL .crossedRightBoundary 
    LDA.W $05E5 : CMP.W #$0555 : BCC .return 
...
.return:
  ...
  + LDA.W $0F7A : CMP.L $7E8004 : BMI .crossedLeftBoundary 
    CMP.L $7E8006 : BPL .crossedRightBoundary 
    LDA.W $05E5 : CMP.W #$0555 : BCC .changeDirection 
    RTS 


.crossedLeftBoundary:
    LDA.W $0FAA : BMI .changeDirection 
    RTS 


.crossedRightBoundary:
    LDA.W $0FAA : BPL .changeDirection 
    RTS 
...
SetSpeedsForTailbouncing:
    ...
    LDA.L $7E7824 : CLC : ADC.W #$0002 : ASL A 
    TAY 
...
MoveSamusToWithinRidleysClawsIfHolding:
    LDA.L $7E7828 : BEQ .noSamusXDisplacement 
    STA.B $12 
    BPL + 
    EOR.W #$FFFF 
    INC A 

  + SEC : SBC.W #$0004 : BPL .positive 
    LDA.W #$0000 : BRA + 
...
.noSamusXDisplacement:
    LDA.L $7E782A : BEQ .noSamusYDisplacement 
    STA.B $12 
    BPL + 
    EOR.W #$FFFF 
    INC A 

  + SEC : SBC.W #$0004 : BPL .positive2 
    LDA.W #$0000 : BRA + 
...
SetDisplacementForRidleyGrabbingSamus:
    ...
    LDA.L $7E783A 
    TAY 
    LDA.W HoldingSamusYDispacement,Y : CLC : ADC.W $0F7E : SEC : SBC.W $0AFA : EOR.W #$FFFF 
    INC A 
    STA.L $7E782A 
    RTS 
...
CheckIfRidleyIsReadyToExplode:
    LDA.L $7E800A : CMP.W #$000A : BMI .notDead 
...
CheckFor_Deathswoop_PowerBombDodge_MoveToCenter_RamGrabSamus:
    ...
    LDA.L $7E783E : BNE CheckIfRidleyIsReadyToExplode 
    LDA.L $7E7820 
    ASL A 
    TAY 
    LDA.W .signedBitmask,Y : STA.B $12 
    LDA.W $0F7A : SEC : SBC.W $0AF6 : STA.B $14 
    EOR.B $12 
    BPL + 
    LDA.B $14 : BPL .positive 
    EOR.W #$FFFF 
    INC A 

.positive:
    CMP.W #$0020 : BPL CheckIfRidleyIsReadyToExplode 

  + LDA.W $0F7E : CLC : ADC.W #$0023 : SEC : SBC.W $0AFA : BPL CheckIfRidleyIsReadyToExplode 
    LDX.W #$FFF0 
    LDA.L $7E7820 : BEQ .facingLeft 
    LDX.W #$0010 
...
.facingLeft:
    TXA 
    CLC : ADC.W $0AF6 : STA.B $12 
    LDA.W $0AFA : CLC : ADC.W #$FFFC : STA.B $14 
    LDX.W #$0000 
    LDA.L $7E7824 
    ASL A 
    TAY 
    ...
    TAY 
    LDA.W HoldingSamusXDispacement,Y : CLC : ADC.W $0F7A : STA.B $12 
    LDA.W #$0023 : CLC : ADC.W $0F7E : STA.B $14 
    LDA.W #$0008 : STA.B $16 
    LDA.W #$000C : STA.B $18 
...
.collision:
    ...
    LDA.W $0F8C : BEQ .dead 
    LDA.W $0CEE 
    LDA.W $0CEE : BEQ Function_Ridley_InPositionToGrabSamus_NoPowerBomb 
    JSR.W GrabSamus 
    LDA.W #Function_Ridley_DodgingPowerbomb_MaybeHoldingSamus : STA.W $0FA8 
    JMP.W Function_Ridley_DodgingPowerbomb_MaybeHoldingSamus 
...
Function_Ridley_InPositionToGrabSamus_NoPowerBomb:
    ...
    LDA.W $0F7E : CLC : ADC.W #$FFC0 : CMP.W #$0100 : BPL .minimum100 
    LDA.W #$0100 
...
CheckIfSamusIsBelowTailbounceThreshold:
    LDA.W $0AFA : CMP.W #$0160 : BPL .aboveThreshold 
    CLC 
    RTS 
...
PowerBombCheck:
    ...
    LDA.W $0CEE : BEQ .return 
    LDA.L $7E7836 : BNE .return 
    JSR.W RidleyGrabbedSamus_ResetTailAI 
    LDY.W #CheckFor_Deathswoop_PowerBombDodge_MoveToCenter_RamGrabSamus 
    STY.W $0FA8 
...
Function_Ridley_DodgingPowerbomb_MaybeHoldingSamus:
    ...
    LDY.W #$0050 
    LDA.W $0CE2 : CMP.W #$0080 : BPL + 
    LDY.W #$00C0 

  + STY.B $12 
    LDY.W #$00C0 
    LDA.W $0CE4 : CMP.W #$0100 : BPL + 
    LDY.W #$0180 
...
.powerBombActive:
    LDA.W #$0001 : STA.L $7E7802 
    LDY.W #DetermineAndExecuteNewRidleyAIScript 
    LDA.L $7E7836 : BEQ .notHoldingSamus 
...
Function_RidleyCeres_InitializeBabyMetroidDrop:
    ...
    LDY.W #$0001 
    JSR.W AccelerateCeresRidleyTowardDesiredXY 
    LDA.W $0F7A : CMP.W #$00C0 : BMI .return 
...
Function_RidleyCeres_DropBabyMetroid:
    ...
    LDY.W #$0001 
    JSR.W AccelerateCeresRidleyTowardDesiredXY 
    LDA.W $0F7E : CMP.W #$0020 : BPL Function_RidleyCeres_PickupBabyMetroid_return 
...
Function_RidleyCeres_PickupBabyMetroid:
    LDA.L $7E8804 : CLC : ADC.W #$FFF6 : STA.B $12 
    LDA.L $7E8808 : CLC : ADC.W #$FFC8 : STA.B $14 
    LDX.W #$0000 
    LDY.W #$000C 
    JSR.W AccelerateRidleyTowardDesiredXYPosition_NoDecelerationBoost 
    LDA.W #$000E : CLC : ADC.W $0F7A : STA.B $12 
    LDA.W #$0042 : CLC : ADC.W $0F7E : STA.B $14 
    LDA.W #$0004 : STA.B $16 
    LDA.W #$0004 : STA.B $18 
...
CheckIfRidleyIsWithinRangeToPickupBabyMetroid:
    LDA.L $7E8804 : SEC : SBC.B $12 : BPL + 
    EOR.W #$FFFF 
    INC A 

  + SEC : SBC.W #$0004 : BCC + 
    CMP.B $16 : BCS .returnNotGrabbed 

  + LDA.L $7E8808 : SEC : SBC.B $14 : BPL + 
    EOR.W #$FFFF 
    INC A 

  + SEC : SBC.W #$0004 : BCC .returnGrabbed 
    CMP.B $18 : BCC .returnGrabbed 
...
UpdateBabyMetroidPosition_CarriedInArms:
    LDA.W #$FFF0 : CLC : ADC.W $0F7A : STA.L $7E8804 
    LDA.W #$0016 : CLC : ADC.W $0F7E : STA.L $7E8808 
    RTS 


UpdateBabyMetroidPosition_CarriedInFeet:
    LDA.W #$000E : CLC : ADC.W $0F7A : STA.L $7E8804 
    LDA.W #$0042 : CLC : ADC.W $0F7E : STA.L $7E8808 
    RTS 
...
BabyMetroidDropped:
    LDA.L $7E880C : CLC : ADC.W #$0008 : STA.L $7E880C 
    SEP #$20 
    CLC : ADC.L $7E8807 : STA.L $7E8807 
    REP #$20 
    AND.W #$FF00 
    XBA 
    BPL + 
...
Instruction_BabyMetroidCutscene_GotoXIfNotFalling:
    LDA.L $7E880C : BEQ Instruction_BabyMetroidCutscene_NextInstruction 
...
ProcessEscapeTimerTileTransfers:
    LDX.W $0FB0 
    LDY.W $0330 
    LDA.W $0000,X : BEQ .returnCarrySet 
    STA.W $00D0,Y 
    LDA.W $0003,X : STA.W $00D3,Y 
    LDA.W $0002,X : STA.W $00D2,Y 
    LDA.W $0005,X : STA.W $00D5,Y 
...
.loop:
  ...
  + PHA 
    ...
    PLA 
    SEC : SBC.W #$0041 : CLC : ADC.B $12 : STA.L $7E8034 
    LDA.W #$8034 ; $7E
    STA.W $00D2,Y 
    ...
    INC A 
    STA.L $7E803E 
    CMP.W #$0002 : BMI .returnStillTyping 
    LDA.W #$0000 : STA.L $7E803E 
    LDA.W $079F : CMP.W #$0006 : BNE .introTypewriterSFX 
...
.notA:
    ...
    ASL #2
    TAY 
    LDA.W .XPosition,Y : CLC : ADC.W $0F7A : STA.B $12 
    LDA.W .YPosition,Y : CLC : ADC.W $0F7E : STA.B $14 
    LDA.W #$0003 
    LDY.W #EnemyProjectile_MiscDust 
    JSL.L SpawnEnemyProjectileY_ParameterA_RoomGraphics 
...
RidleyExplosionInitialization_C:
    ...
    LDA.L $7E20A2 : CLC : ADC.L $7E208E : CLC : ADC.W #$0008 : AND.W #$00F0 
    LSR #3
    TAY 
...
RidleyExplosionInitialization_E:
    LDY.W #$0000 
    LDA.L $7E7820 : BEQ .right 
    LDY.W #$0002 

.right:
    LDX.W $0E54 
    LDA.W .XOffsetFromRidleyXPosition,Y : CLC : ADC.W $0F7A : STA.W $0F7A,X 
    LDA.W #$0000 : CLC : ADC.W $0F7E : STA.W $0F7E,X 
...
.right:
    LDX.W $0E54 
    LDA.W .XOffsetFromRidleyXPosition,Y : CLC : ADC.W $0F7A : STA.W $0F7A,X 
    LDA.W #$0016 : CLC : ADC.W $0F7E : STA.W $0F7E,X 
    LDA.W .instListPointer,Y : STA.W $0F92,X 
    RTL 
...
.right:
    LDX.W $0E54 
    LDA.W .XOffsetFromRidleyXPosition,Y : CLC : ADC.W $0F7A : STA.W $0F7A,X 
    LDA.W #$FFE8 : CLC : ADC.W $0F7E : STA.W $0F7E,X 
    LDA.W .instListPointer,Y : STA.W $0F92,X 
    RTL 
...
.right:
    LDX.W $0E54 
    LDA.W .XOffsetFromRidleyXPosition,Y : CLC : ADC.W $0F7A : STA.W $0F7A,X 
    LDA.W #$0007 : CLC : ADC.W $0F7E : STA.W $0F7E,X 
    LDA.W .instListPointer,Y : STA.W $0F92,X 
    RTL 
...
MainAI_RidleyExplosion:
  ...
  + STA.W $0FAA,X 
    LDA.W $0FAC,X : CLC : ADC.W #$0004 : STA.W $0FAC,X 
...
HandleRidleyTailFlingTrigger:
    LDA.W $2004 : BEQ .notFlingingTail 
...
Function_Ridley_Tailbouncing:
    ...
    BCC .checkMoving 
    LDA.W $05E5 : AND.W #$00FF 
    CMP.W #$00F0 : BCS .randomlySkipDistanceCheck 
    LDA.W $0AF6 : SEC : SBC.L $000F7A : BPL .SamusOnRight 
    EOR.W #$FFFF 
    INC A 

.SamusOnRight:
    CMP.W #$0080 : BCS .checkMoving 
...
.SamusOnRight:
    CMP.W #$0080 : BCS .checkTailPartsMoving 
...
UpdateRidleyTailPositions:
    LDA.W $0F7E : CLC : ADC.W $2032 : CLC : ADC.W #$0010 : STA.W $202E 
    CLC : ADC.W $2046 : STA.W $2042 
    CLC : ADC.W $205A : STA.W $2056 
    CLC : ADC.W $206E : STA.W $206A 
    CLC : ADC.W $2082 : STA.W $207E 
    CLC : ADC.W $2096 : STA.W $2092 
    CLC : ADC.W $20AA : STA.W $20A6 
    LDA.W $7820 
    DEC A 
    BEQ .facingForward 
    INC A 
...
.notFacingForward:
    LDA.W $202C : CLC : ADC.W $2044 : STA.W $2040 
    CLC : ADC.W $2058 : STA.W $2054 
    CLC : ADC.W $206C : STA.W $2068 
    CLC : ADC.W $2080 : STA.W $207C 
    CLC : ADC.W $2094 : STA.W $2090 
    CLC : ADC.W $20A8 : STA.W $20A4 
...
RidleyTailExtending:
    LDA.W $203C : BEQ .reachedTargetDistanceFromPreviousTailPart 
    CMP.W $203A : BPL + 
    LDA.W #$0000 : STA.W $203C 

  + LDA.W $203A : CLC : ADC.W $2012 : CMP.W #$1800 : BMI + 
    LDA.W #$1800 
...
.reachedTargetDistanceFromPreviousTailPart:
    LDA.W #$0800 : CMP.W $203A : BPL + 
    LDA.W $203A : SEC : SBC.W #$0080 : STA.W $203A 

  + LDA.W $2050 : BEQ .reachedTargetDistanceFromPreviousTailPart2 
    CMP.W $204E : BPL + 
    LDA.W #$0000 : STA.W $2050 

  + LDA.W $204E : CLC : ADC.W $2012 : CMP.W #$1800 : BMI + 
    LDA.W #$1800 
...
.reachedTargetDistanceFromPreviousTailPart2:
    LDA.W #$0800 : CMP.W $204E : BPL + 
    LDA.W $204E : SEC : SBC.W #$0080 : STA.W $204E 

  + LDA.W $2064 : BEQ .reachedTargetDistanceFromPreviousTailPart3 
    CMP.W $2062 : BPL + 
    LDA.W #$0000 : STA.W $2064 

  + LDA.W $2062 : CLC : ADC.W $2012 : CMP.W #$1600 : BMI + 
    LDA.W #$1600 
...
.reachedTargetDistanceFromPreviousTailPart3:
    LDA.W #$0800 : CMP.W $2062 : BPL + 
    LDA.W $2062 : SEC : SBC.W #$0080 : STA.W $2062 

  + LDA.W $2078 : BEQ .reachedTargetDistanceFromPreviousTailPart4 
    CMP.W $2076 : BPL + 
    LDA.W #$0000 : STA.W $2078 

  + LDA.W $2076 : CLC : ADC.W $2012 : CMP.W #$1600 : BMI + 
    LDA.W #$1600 
...
.reachedTargetDistanceFromPreviousTailPart4:
    LDA.W #$0800 : CMP.W $2076 : BPL + 
    LDA.W $2076 : SEC : SBC.W #$0080 : STA.W $2076 

  + LDA.W $208C : BEQ .reachedTargetDistanceFromPreviousTailPart5 
    CMP.W $208A : BPL + 
    LDA.W #$0000 : STA.W $208C 

  + LDA.W $208A : CLC : ADC.W $2012 : CMP.W #$1200 : BMI + 
    LDA.W #$1200 
...
.reachedTargetDistanceFromPreviousTailPart5:
    LDA.W #$0800 : CMP.W $208A : BPL + 
    LDA.W $208A : SEC : SBC.W #$0080 : STA.W $208A 

  + LDA.W $20A0 : BEQ .reachedTargetDistanceFromPreviousTailPart6 
    CMP.W $209E : BPL + 
    LDA.W #$0000 : STA.W $20A0 

  + LDA.W $209E : CLC : ADC.W $2012 : CMP.W #$0500 : BMI + 
    LDA.W #$0500 
...
.reachedTargetDistanceFromPreviousTailPart6:
    LDA.W #$0500 : CMP.W $209E : BPL .return 
...
SetRidleyTailAngles:
    LDA.W $2020,X : BMI .tailPartMoving 
    LDA.W $202A,X 
    JMP.W .notMoving 
...
.stopTailPartMovement:
  ...
  - LDA.W $2022,X : CLC : ADC.W $2014 : STA.W $2022,X 
    RTS 


.tailPartMoving:
    LDA.W $2022,X : CMP.W $201E : BCC - 
    CMP.W #$FFFF : BEQ + 
    LDA.W #$FFFF : STA.W $2022,X 
    LDA.W #$8000 : STA.W $2034,X 
    LDA.W $2024,X : STA.W $2038,X 

  + LDA.W $2024,X : BMI .clockwiseRotation 
    LDA.W $201C : BMI .noCounterClockwiseTarget 
    LDA.W #$0C00 : STA.W $2028,X 
    LDA.W $202A,X : CLC : ADC.W $2014 : CMP.W $201C : BMI .storeAngle 
    TXA 
    BEQ + 
    LDA.W $200C,X : BNE .tailPartMoving2 
...
.noCounterClockwiseTarget:
    LDA.W $202A,X : CLC : ADC.W $2014 : CMP.W $2018 : BMI .storeAngle 

.tailPartMoving2:
    LDA.W #$8000 : STA.W $2024,X 
    LDA.W $2018 : BRA .storeAngle 


.clockwiseRotation:
    LDA.W $201A : BMI .noClockwiseTarget 
    LDA.W #$0C00 : STA.W $2028,X 
    LDA.W $202A,X : SEC : SBC.W $2014 : DEC A 
    CMP.W $201A : BPL .incrementAngle 
    TXA 
    BEQ + 
    LDA.W $200C,X : BNE .tailPartMoving3 
...
.noClockwiseTarget:
    LDA.W $202A,X : SEC : SBC.W $2014 : DEC A 
    CMP.W $2016 : BPL .incrementAngle 

.tailPartMoving3:
    LDA.W #$0000 : STA.W $2024,X 
    LDA.W $2016 : BRA .storeAngle 
...
.notMoving:
    ...
    TXA 
    BEQ .firstTailPart 
    LDA.B $12 : CLC : ADC.W $2016,X : AND.W #$00FF 
    STA.B $12 
...
.noProjectiles:
  ...
  + PHB : PHK : PLB 
    ...
    LDA.B $12 : CMP.W #$0018 : BCC + 
    CMP.W #$00E8 : BCS + 
    LDA.W #$00E8 

  + CLC : ADC.W #$3F00 : SEC : SBC.W $200A : CMP.W $202A : BCS .returnMiddle 
    STA.W $201A 
    LDA.W #$0008 : STA.W $2014 
...
.facingRight:
  ...
  + CLC : ADC.W #$4000 : CLC : ADC.W $200A : CMP.W $202A : BCC .returnLower 
    STA.W $201C 
    LDA.W #$0008 : STA.W $2014 
...
TargetAMissileOrSuperMissileIfAvailable:
    ...
    LDA.W #$0040 : STA.B $16 
    STA.B $18 
    LDA.W $0CCE : BNE .checkProjectiles 
    CLC 
    RTS 
...
.missileOrSuperMissile:
  ...
  + SEC : SBC.W $0BB4,Y : BCC + 
    CMP.B $16 : BCS .nextProjectile 

  + LDA.W $0B78,Y : SEC : SBC.B $14 : BPL + 
    EOR.W #$FFFF 
    INC A 

  + SEC : SBC.W $0BC8,Y : BCC .targetProjectile 
    CMP.B $18 : BCC .targetProjectile 
...
PlaySwishingSFXIfTailIsMovingFast:
    LDA.L $7E2014 : CMP.W #$0008 : BMI .noSFX 
    LDA.L $7E781C 
    INC A 
    STA.L $7E781C 
...
UNUSED_SetAllTailPartsToNotMoving_A6D3D4:
    LDA.W #$0000 : BRA SetAllTailPartsToMovingOrNotMoving 
endif ; !FEATURE_KEEP_UNREFERENCED
...
HandleRidleyHealthBasedPalette:
    LDA.L $7EC400 : BNE HandleRidleyHealthBasedPalette_return 
    LDA.B $12 
    ASL #3
    SEC : SBC.B $12 : ASL #2
...
AccelerateRidleyTowardDesiredXYPosition:
  ...
  + STA.B $16 
    LDA.W $0FAC,X : BPL + 
    CLC : ADC.B $1A : CLC : ADC.W #$0008 : ADC.B $16 

  + ADC.B $16 : CMP.W #$0500 : BMI + 
    LDA.W #$0500 
...
.belowTarget:
  ...
  + STA.B $16 
    LDA.W $0FAC,X : BMI + 
    SEC : SBC.B $1A : SEC : SBC.W #$0008 : SBC.B $16 

  + SBC.B $16 : CMP.W #$FB00 : BPL + 
    LDA.W #$FB00 
...
AccelerateCeresRidleyTowardDesiredXY:
  ...
  + STA.B $16 
    LDA.W $0FAC,X : BPL .moveDown 
    ADC.B $16 : ADC.B $16 

.moveDown:
    ADC.B $16 : CMP.W #$0500 : BMI .storeYSpeed 
    LDA.W #$0500 
...
UNUSED_A6D734:
    LDA.W $0F7E,X : SEC : SBC.B $14 : BPL .unknown 
...
UNUSED_A6D798:
    LDA.W $0F7A,X : SEC : SBC.B $12 : BPL .unknown 
    EOR.W #$FFFF 
    INC A 
...
UpdateRidleysUSwoopSpeedAndAngle:
    LDA.B $16 : CMP.L $7E7816 : BEQ .checkAngle 
    BPL + 
    LDA.L $7E7816 : SEC : SBC.W #$0020 : CMP.B $16 : BPL .storeSwoopSpeed 
    LDA.B $16 
...
.storeSwoopSpeed:
  ...
  + LDA.L $7E7816 : CLC : ADC.W #$0020 : CMP.B $16 : BMI + 
    LDA.B $16 

  + STA.L $7E7816 

.checkAngle:
    LDA.B $12 : BMI .negativeTargetAngle 
    CLC : ADC.L $7E7814 : CMP.B $14 : BMI .calculateAngle 
    BRA + 


.negativeTargetAngle:
    CLC : ADC.L $7E7814 : CMP.B $14 : BPL .calculateAngle 
...
.checkLeftWall:
    ADC.W $0F7A,X : CMP.L $7E8004 : BPL .checkRightWall 
...
.checkTopWall:
    ADC.W $0F7E,X : CMP.L $7E8000 : BPL .checkBottomWall 
...
CeresRidleyRoomShaking:
    LDA.W $079F : CMP.W #$0002 : BEQ .return 
    LDA.W $0FAA,X : BPL .movingRight 
    EOR.W #$FFFF 
    INC A 
...
.movingDown:
    CMP.B $12 : BCS .XSpeedGreater 
    LDA.B $12 

.XSpeedGreater:
    CMP.W #$0280 : BCC .return 
    LDA.W $079F : CMP.W #$0002 : BEQ .norfair 
    LDA.W #$0021 : BRA + 
...
TurnAroundIfFacingAwayFromRoomCenter:
    ...
    DEC A 
    BEQ .return 
    LDA.W $0F79 : BPL .return 
    LDA.W #InstList_Ridley_TurnFromRightToLeft : BRA + 


.facingLeft:
    LDA.W $0F79 : BMI .return 
...
HandleWingFlapping:
    ...
    LDA.L $7E7812 : SEC : SBC.L $7E7810 : STA.L $7E7812 
    BPL .return 
    LDA.W #$0020 : STA.L $7E7812 
    LDA.L $7E780E 
    INC A 
    CMP.W #$000A : BCC .lessThanA 
    LDA.W #$0000 
...
CalculateWingFlapSpeed:
  ...
  + CLC : ADC.B $12 : BNE .RidleyMoving 
    STA.L $7E7810 
    RTS 


.RidleyMoving:
    SEC : SBC.B $12 : CMP.B $12 : BPL .YSpeedGreater 
    LDA.B $12 
...
.pointer:
    ...
    CMP.B [$03] : BNE .timerDoesNotMatchCounter 
    INX #4
    .manualReturn:
    LDA.W $0000,X : BPL .notInstruction 
...
CheckIfRidleyIsOnScreen:
    LDA.W $0F7E : BMI .offScreen 
    CLC : ADC.W #$0020 : SEC : SBC.W $0915 : BMI .offScreen 
    CMP.W #$0120 : BPL .offScreen 
    LDA.W $0F7A : BMI .offScreen 
    CLC : ADC.W #$0020 : SEC : SBC.W $0911 : BMI .offScreen 
    CMP.W #$0140 : BPL .offScreen 
    CLC 
    RTS 
...
RidleyTail_vs_SamusProjectile_CollisionDetection:
    LDA.W $0CCE : BNE .projectilesToCheck 
    CLC 
    RTS 
...
.loop:
    LDA.W $0C18,Y : BPL .nextProjectile 
    XBA 
    AND.W #$000F 
    CMP.W #$0003 : BPL .nextProjectile 
    LDA.W $0B64,Y : SEC : SBC.B $12 : BPL + 
    EOR.W #$FFFF 
    INC A 

  + SEC : SBC.W $0BB4,Y : BCC .checkYPosition 
    CMP.B $16 : BCS .nextProjectile 
...
.checkYPosition:
  ...
  + SEC : SBC.W $0BC8,Y : BCC .collision 
    CMP.B $18 : BCC .collision 
...
UNUSED_ChangeRidleyProjectileDirection_A6DF08:
    ...
    CMP.W #$0007 : BNE .notFacingLeft 
    LDA.W #$0001 : BRA .done 


.notFacingLeft:
    CMP.W #$0002 : BNE .notLeftOrRight 
    LDA.W #$0008 : BRA .done 
...
EnemyShot_Ridley:
    LDA.W $079F : CMP.W #$0002 : BEQ .NorfairRidley 
    LDY.W #$000D 
...
RidleyTail_vs_Samus_Interaction:
    ...
    LDA.W #$0005 : STA.W $18AA 
    LDY.W #$0000 
    LDA.W $0AF6 : SEC : SBC.L $7E20A4 : BMI .knockbackDirection 
    INY 
...
UNUSED_ProjectileCollision_A6E01B:
  ...
  + PHA 
    ...
    EOR.W $0FAA,X 
    BPL + 
    LDA.B $12 : CLC : ADC.W $0FAA,X : STA.W $0FAA,X 
  ...
  + PLA 
    ...
    EOR.W $0FAC,X 
    BPL .return 
    LDA.B $12 : CLC : ADC.W $0FAC,X : STA.W $0FAC,X 
...
Inst_Ridley_GotoYAndSetTimerTo8IfNotNorfairOrSamusLowEnergy:
    LDA.W $079F : CMP.W #$0002 : BEQ Instruction_Ridley_SkipToNextInstruction 
    LDA.W $09C2 : CMP.W #$001E : BPL Instruction_Ridley_SkipToNextInstruction 
...
Instruction_Ridley_GotoYIfNotFacingLeft:
    LDA.L $7E7820 : BEQ Instruction_Ridley_SkipToNextInstruction 
    BRA Instruction_Ridley_GotoY 


Instruction_Ridley_MoveRidleyWithArgsInY:
    LDA.W $0000,Y : CLC : ADC.W $0F7A : STA.W $0F7A 
    LDA.W $0002,Y : CLC : ADC.W $0F7E : STA.W $0F7E 
    INY #4
    RTL 
...
Instruction_Ridley_CalculateFireballAngleAndXYSpeeds:
    ...
    LDA.W #$FFD5 : CLC : ADC.W $0F7E : STA.B $14 
    LDA.W $0AFA : SEC : SBC.B $14 : STA.B $14 
    JSL.L CalculateAngleOf_12_14_Offset 
    SEC : SBC.W #$0080 : EOR.W #$FFFF 
    INC A 
    AND.W #$00FF 
    CMP.W #$00B0 : BCS .checkEB 
    CMP.W #$0040 : BCC .loadEB 
    LDA.W #$00B0 : BRA + 
...
.facingRight:
    LDA.W #$0019 : CLC : ADC.W $0F7A : STA.B $12 
    LDA.W $0AF6 : SEC : SBC.B $12 : STA.B $12 
    LDA.W #$FFD5 : CLC : ADC.W $0F7E : STA.B $14 
    LDA.W $0AFA : SEC : SBC.B $14 : STA.B $14 
    JSL.L CalculateAngleOf_12_14_Offset 
    ...
    INC A 
    AND.W #$00FF 
    CMP.W #$0050 : BCC .check15 
    CMP.W #$00C0 : BCS .load15 
    LDA.W #$0050 : BRA + 
...
FireLeadsFireball:
    LDA.W #$0000 : BRA SpawnRidleyFireball 
...
Func_CeresSteam_CalculateGraphicalOffsetInRotatingElevRoom:
    ...
    LDX.W $0E54 
    LDA.B $12 : SEC : SBC.W $0F7A,X : STA.L $7E7010,X 
    LDA.B $14 : SEC : SBC.W $0F7E,X : STA.L $7E7012,X 
    RTL 
...
Inst_CeresDoor_GotoYIfSamusIsNotWithing30Pixels:
  ...
  + CMP.W #$0030 : BCS Inst_CeresDoor_GotoYIfSamusIsNotWithin30Pixels_gotoY 
    LDA.W $0F7E,X : SEC : SBC.W $0AFA : BPL + 
    EOR.W #$FFFF 
    INC A 
...
Instruction_CeresDoor_GotoYIfCeresRidleyHasNotEscaped:
    LDA.W $093F : BEQ Inst_CeresDoor_GotoYIfSamusIsNotWithin30Pixels_gotoY 
    BRA Inst_CeresDoor_GotoYIfSamusIsNotWithin30Pixels_outOfRange 


SetElevatorRoomToRotateIfRidleyHasEscaped:
    LDA.W $093F : BEQ .return 
...
InitAI_CeresDoor:
    ...
    LDA.W $0FB4,X : CMP.W #$0003 : BNE .notRidleysRoom 
...
LoadRotatingElevatorRoomPreExplosioNDoorOverlayTilesIfNeeded:
    LDA.W $0FB4,X : CMP.W #$0002 : BNE .return 
    LDY.W $0330 
...
HandleEarthquakeDuringEscape:
    LDA.W $093F : CMP.W #$0002 : BCC .return 
    LDA.W $1840 : BNE .return 
    LDA.W $05E5 : AND.W #$0FFF 
    CMP.W #$0080 : BCC .random 
...
.ceresDoorTimerNotExpired:
    ...
    ASL #2
    TAY 
    LDA.W .XOffset,Y : CLC : ADC.W $0F7A,X : STA.B $12 
    LDA.W .YOffset,Y : CLC : ADC.W $0F7E,X : STA.B $14 
    LDY.W #$0003 
    JSL.L GenerateRandomNumber 
    CMP.W #$4000 : BCS .noSmoke 
    LDY.W #$000C 
...
InitAI_Zebetite:
    ...
    LDA.W $0FB4,X : BEQ .setFunctionPointer 
...
.setFunctionPointer:
    ...
    CMP.W #$0004 : BMI .notAllDestroyed 
    LDA.W $0F86,X : ORA.W #$0200 : STA.W $0F86,X 
    RTL 
...
Function_Zebetite_Active:
    ...
    LDX.W $0E54 
    LDA.W $0F8C,X : BEQ .destroyed 
    CLC : ADC.W #$0001 : CMP.W #$03E8 : BMI + 
    LDA.W #$03E8 
...
.singlePart:
    ...
    LDX.W $0E54 
    LDA.W $0FAE,X : CMP.W #$0004 : BPL .noMore 
