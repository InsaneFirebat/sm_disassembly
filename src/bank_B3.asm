...
Function_Zeb_Zebbo_Rising:
    ...
    LDA.L $7E7800,X : CMP.W $0F7E,X : BMI .return 
    LDA.W $0F7E,X : CMP.W $0AFA : BCC .targetHeight 
    BRA .return 
...
Set_Zeb_Zebbo_InstList:
    LDX.W $0E54 
    LDA.W $0FB0,X : CMP.L $7E7802,X : BEQ .return 
    STA.L $7E7802,X 
    ASL A 
    TAY 
    LDA.W $0FB4,X : BNE .zebbo 
    LDA.W InstListPointers_Zeb,Y : BRA + 
...
Function_Gamet_WaitUntilAllReady:
    ...
    BEQ .return 
    LDA.W $0FE8,X : CMP.W #Function_Gamet_WaitUntilAllReady : BNE .return 
    LDA.W $1028,X : CMP.W #Function_Gamet_WaitUntilAllReady : BNE .return 
    LDA.W $1068,X : CMP.W #Function_Gamet_WaitUntilAllReady : BNE .return 
    LDA.W $10A8,X : CMP.W #Function_Gamet_WaitUntilAllReady : BNE .return 
...
Function_Gamet_WaitForSamusToGetNear:
    ...
    BEQ .return 
    LDA.W $0F7E,X : CMP.W $0AFA : BMI .return 
    INC.W $0FAC,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    JSL.L Get_SamusX_minus_EnemyX 
...
Function_Gamet_Rising:
  ...
  + STA.W $0F80,X 
    LDA.W $0F7E,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing+4,Y : STA.W $0F7E,X 
    CMP.W $0AFA : BPL .return 
...
Function_Gamet_MoveToFormation_UpperMiddle:
  ...
  + STA.W $0F80,X 
    LDA.W $0F7E,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing+4,Y : STA.W $0F7E,X 
    CLC : ADC.W #$0010 : CMP.L $7E7802,X : BPL .return 
    LDA.L $7E7802,X : SEC : SBC.W #$0010 : STA.W $0F7E,X 
    STZ.W $0F80,X 
    LDA.W #Function_Gamet_ShootDelay : STA.W $0FA8,X 
...
Function_Gamet_MoveToFormation_Top:
  ...
  + STA.W $0F80,X 
    LDA.W $0F7E,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing+4,Y : STA.W $0F7E,X 
    CLC : ADC.W #$0020 : CMP.L $7E7802,X : BPL .return 
    LDA.L $7E7802,X : SEC : SBC.W #$0020 : STA.W $0F7E,X 
    STZ.W $0F80,X 
    LDA.W #Function_Gamet_ShootDelay : STA.W $0FA8,X 
...
Function_Gamet_MoveToFormation_LowerMiddle:
    ...
    LDA.W #$0080 
    TAY 
    LDA.W $0F80,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing+2,Y : BCC + 
    INC.W $0F7E,X 

  + STA.W $0F80,X 
    LDA.W $0F7E,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing,Y : STA.W $0F7E,X 
    SEC : SBC.W #$0010 : CMP.L $7E7802,X : BMI .return 
    LDA.L $7E7802,X : CLC : ADC.W #$0010 : STA.W $0F7E,X 
    STZ.W $0F80,X 
    LDA.W #Function_Gamet_ShootDelay : STA.W $0FA8,X 
...
Function_Gamet_MoveToFormation_Bottom:
  ...
  + STA.W $0F80,X 
    LDA.W $0F7E,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing,Y : STA.W $0F7E,X 
    SEC : SBC.W #$0020 : CMP.L $7E7802,X : BMI .return 
    LDA.L $7E7802,X : CLC : ADC.W #$0020 : STA.W $0F7E,X 
    STZ.W $0F80,X 
    LDA.W #Function_Gamet_ShootDelay : STA.W $0FA8,X 
...
Function_Gamet_ShootingLeft:
    ...
    LDA.W $0FAA,X 
    TAY 
    LDA.W $0F7C,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing+6,Y : BCC + 
    INC.W $0F7A,X 

  + STA.W $0F7C,X 
    LDA.W $0F7A,X : CLC : ADC.W CommonEnemySpeeds_LinearlyIncreasing+4,Y : STA.W $0F7A,X 
    RTS 
...
Function_Gamet_ShootDelay:
    LDX.W $0E54 
    INC.W $0FAC,X 
    LDA.W $0FAC,X : CMP.L $7E7804,X : BMI .return 
    STZ.W $0FAC,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
.onScreen:
    LDA.L $7E780C,X : BNE .return 
    LDA.W $0F7A,X : SEC : SBC.W $0AF6 : CMP.W #$0030 : BPL .return 
...
MoveGeegaLeft:
    LDA.W $0F7C,X : CLC : ADC.L $7E7804,X : BCC + 
    INC.W $0F7A,X 
...
.onScreen:
    LDA.L $7E780C,X : BNE .return 
    LDA.W $0F7A,X : SEC : SBC.W $0AF6 : EOR.W #$FFFF 
    INC A 
    CMP.W #$0030 : BPL .return 
...
MoveGeegaRight:
    LDA.W $0FAA,X 
    TAY 
    LDA.W $0F7C,X : CLC : ADC.L $7E7800,X : BCC + 
    INC.W $0F7A,X 
...
.onScreen:
    ...
    JSR.W MoveGeegaUp 
    LDA.W $0F7E,X : CMP.L $7E7810,X : BPL .return 
...
.onScreen:
    ...
    LDA.W $0FB2,X : BNE .moveDown 
    JSR.W MoveGeegaUp 
    LDA.L $7E7810,X : CMP.W $0F7E,X : BMI .return 
    LDA.W #$0001 : STA.L $7E780C,X 
    STA.W $0FB2,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
BotwoonDeathCheck:
    LDX.W $0E54 
    LDA.L $7E801E,X : BEQ .return 
    LDA.L $7E803C,X : BEQ .return 
...
BotwoonHealthBasedPaletteHandling:
    LDX.W $0E54 
    LDA.L $7E881E,X : CMP.W #$0010 : BEQ .return 
    TAY 
    LDA.W $0F8C,X : CMP.W BotwoonHealthThresholdsForPaletteChange,Y : BPL .return 
    LDA.L $7E881E,X 
    ASL #4
    STA.B $12 
...
Function_Botwoon_GoThroughHole:
    LDX.W $0E54 
    LDA.L $7E8038,X : BEQ .moveAround 
    LDA.W #$0000 : STA.L $7E8038,X 
    STZ.B $12 
    LDA.L $7E8026,X : BNE .gotoAction 
    LDA.L $7E8832,X : BNE .gotoAction 
    LDA.L $7E803E,X : BNE .gotoAction 
    JSL.L GenerateRandomNumber 
    AND.W #$000E 
    STA.B $12 
...
.notHidden:
    ...
    LDA.L $7E802E,X 
    ASL #2
    CLC : ADC.B $12 : CLC : ADC.B $14 : STA.L $7E8800,X 
    RTS 


SetBotwoonSpeed:
    LDA.L $7E8026,X : BNE .return 
    LDA.W #$0000 : STA.L $7E803E,X 
    LDA.W $0F8C,X : BEQ .return 
    BMI .return 
    CMP.L $7E8838,X : BPL .return 
    CMP.L $7E883A,X : BPL .halfHealth 
    BRA .quarterHealth 
...
Function_Botwoon_MovingAround:
    LDX.W $0E54 
    LDA.L $7E8038,X : BEQ .notGoingThroughHole 
    LDA.W #$0000 : STA.L $7E8038,X 
    JMP.W + ; >.<
...
Function_Botwoon_Spitting:
    LDX.W $0E54 
    LDA.L $7E8002,X : BNE .timerNotExpired 
    LDA.W #$0000 : STA.L $7E8038,X 
    JMP.W + ; >.<
...
.timerNotExpired:
  ...
  + LDA.W #Function_Botwoon_MovingAround : STA.W $0FAE,X 
    LDA.W #Function_Botwoon_Movement_StartMovingAccordingToMovementData : STA.W $0FB0,X 
    LDA.W #Function_Botwoon_Head_MovingAround : STA.W $0FB2,X 
    LDA.L $7E801E,X : BNE .deathFlagSet 
    JSL.L GenerateRandomNumber 
    AND.W #$0001 
    STA.L $7E8026,X 
    STA.L $7E8028,X 
...
.lessThanC8:
    LDA.L $7E8010,X : CLC : ADC.W #$00C0 : STA.L $7E8010,X 
...
Function_Botwoon_DeathSequence_CrumblingWall:
    LDA.L $7E8006,X : CMP.W #$00C0 : BPL .end 
    CMP.W #$0040 : BPL .wall 
    JMP.W .return 
...
.wall:
    ...
    JSL.L GenerateRandomNumber 
    AND.W #$001F 
    CLC : ADC.W #$00E8 : STA.B $12 
    JSL.L GenerateRandomNumber 
    AND.W #$001F 
    SEC : SBC.W #$0008 : CLC : ADC.L $7E8006,X : STA.B $14 
    LDA.W #$001D : STA.B $16 
    LDA.W #$0A00 : STA.B $18 
...
Function_Botwoon_Movement_DirectlyTowardTargetHole:
    ...
    STA.L $7E8034,X 
    LDA.L $7E8026,X : CMP.L $7E8028,X : BEQ .move 
...
CalculateXYOffsetsToTargetHole:
    LDA.L $7E802E,X 
    TAY 
    LDA.W BotwoonHoleHitboxes_leftBoundary,Y : CLC : ADC.W #$0004 : SEC : SBC.W $0F7A,X : STA.B $12 
...
.merge:
    LDA.W BotwoonHoleHitboxes_topBoundary,Y : CLC : ADC.W #$0004 : SEC : SBC.W $0F7E,X : STA.B $14 
...
UpdateBotwonBodyProjectilePositions:
    LDX.W $0E54 
    LDA.W $0FAA,X : SEC : SBC.W $0FAC,X : AND.W #$03FF 
    STA.B $12 
    LDA.W #$0018 : STA.B $14 
...
.loop:
    ...
    TAY 
    LDX.W $0E54 
    LDA.L $7E802C,X : CMP.B $12 : BNE .toggleVisibilityEnd 
    LDX.B $14 
...
.notHidden:
  ...
  + CPX.W #$0000 
    ...
    STA.L $7E803C,X 
    LDA.W #$FFFF : STA.L $7E802C,X 
    LDA.L $7E8026,X : BNE .toggleVisibilityEnd 
...
.toggleVisibilityEnd:
    ...
    LDX.W $0E54 
    LDA.B $12 : SEC : SBC.W $0FAC,X : AND.W #$03FF 
    STA.B $12 
    DEC.B $14 
    DEC.B $14 
    BMI .return 
...
UpdateBotwoonPositionHistoryIndex:
    LDX.W $0E54 
    LDA.W $0FAA,X : CLC : ADC.W #$0004 : AND.W #$03FF 
    STA.W $0FAA,X 
    RTS 
...
.loop:
    ...
    LDA.L $7E7800,X 
    TAY 
    LDA.L $7E7820,X : BEQ .nothidden 
    LDA.W #$0100 : STA.B $18 

.nothidden:
    LDA.B $16 : CMP.W #$0018 : BEQ .first 
    CMP.W #$0000 : BNE .notZero 
    LDA.B $18 : CLC : ADC.W #$0200 : STA.B $18 

.notZero:
    LDA.W $1A4D,Y : SEC : SBC.W $1A4B,Y : STA.B $12 
    LDA.W $1A95,Y : SEC : SBC.W $1A93,Y : STA.B $14 
    BRA .merge 


.first:
    LDX.W $0E54 
    LDA.W $0F7A,X : SEC : SBC.W $1A4B,Y : STA.B $12 
    LDA.W $0F7E,X : SEC : SBC.W $1A93,Y : STA.B $14 
...
Function_Botwoon_Head_MovingAround:
    LDX.W $0E54 
    LDA.W $0F7A,X : SEC : SBC.L $7E882C,X : STA.B $12 
    LDA.W $0F7E,X : SEC : SBC.L $7E882E,X : STA.B $14 
    JSL.L CalculateAngleOf_12_14_Offset 
    STA.B $16 
    LDA.B $12 : BNE .nonZero 
    LDA.B $14 : BNE .nonZero 
    JMP.W .noHeadUpdate 
...
+   LDA.B $16 
    ...
    ASL A 
    TAY 
    LDA.W InstListPointers_Botwoon,Y : CMP.L $7E8036,X : BEQ .noHeadUpdate 
    STA.W $0F92,X 
    STA.L $7E8036,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
Function_Botwoon_Head_Spitting_SetAngleAndShow:
    ...
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.L $7E803A,X : SEC : SBC.W #$0040 : AND.W #$00FF 
    EOR.W #$FFFF 
    INC A 
    CLC : ADC.W #$0100 : AND.W #$00FF 
    STA.L $7E803A,X 
    LDA.W #Function_Botwoon_Head_Spitting_Spawn5SpitProjectiles : STA.W $0FB2,X 
    LDA.W $0FAE,X : CMP.W #Function_Botwoon_Spitting : BEQ .gotoHeadFunction 
...
Function_Botwoon_Head_Spitting_Spawn5SpitProjectiles:
    LDX.W $0E54 
    LDA.L $7E8834,X : BNE .spitting 
    RTS 


.spitting:
    LDA.L $7E803A,X : SEC : SBC.W #$0020 : AND.W #$00FF 
    STA.W $060B 
...
Function_Botwoon_Head_Spitting_Spawn3SpitProjectiles:
    LDX.W $0E54 
    LDA.L $7E803A,X : SEC : SBC.W #$0010 : AND.W #$00FF 
    STA.W $060B 
...
Botwoon_vs_Hole_CollisionDetection:
    LDA.L $7E802A,X : BEQ .collisionNotDisabled 
    JMP.W .return 
...
.loop:
    LDY.B $12 
    LDX.W $0E54 
    LDA.W $0F7A,X : CMP.W BotwoonHoleHitboxes_leftBoundary,Y : BMI .notInHole 
    LDA.W $0F7A,X : CMP.W BotwoonHoleHitboxes_rightBoundary,Y : BPL .notInHole 
    LDA.W $0F7E,X : CMP.W BotwoonHoleHitboxes_topBoundary,Y : BMI .notInHole 
    LDA.W $0F7E,X : CMP.W BotwoonHoleHitboxes_bottomBoundary,Y : BPL .notInHole 
...
.notInHole:
    LDA.W #$0000 : STA.L $7E802A,X 
    LDA.B $12 : SEC : SBC.W #$0008 : STA.B $12 
    BMI .return 
    JMP.W .loop 
...
EnemyShot_Botwoon:
    ...
    LDA.L $7E8818,X : CMP.W $0F8C,X : BEQ .healthUnchanged 
    JSL.L RTL_B3957A ; >.<
...
Function_Botwoon_Movement_StartMovingAccordingToMovementData:
    ...
    LDA.W #$0000 : STA.L $7E8038,X 
    LDA.L $7E8800,X : CLC : ADC.W #BotwoonMovementTable : TAY 
    ...
    LDA.L $7E8804,X : SEC : SBC.W #$0004 : STA.L $7E8804,X 
...
.loop:
    ...
    LDA.L $7E8804,X : CLC : ADC.B $16 : STA.L $7E8804,X 
    DEC.B $18 
    BNE .loop 
    LDA.L $7E8808,X : BPL .positive 
    LDA.B $12 
    EOR.W #$FFFF 
    INC A 
    STA.B $12 
...
.positive:
    ...
    LDA.W $0F7E,X : CLC : ADC.B $14 : STA.W $0F7E,X 
    RTS 
...
Instruction_EtecoonEscape_GotoY_IfAcidPositionLessThanCE:
    LDA.W $1962 : CMP.W #$00CE : BCS .greaterThanCE 
    LDA.W $0000,Y 
    TAY 
    RTL 
...
Function_EtecoonEscape_RunningAroundAimlessly:
  ...
  + STA.B $13 
    ...
    STA.W $0FA8,X 
    BPL .greaterThan0 
    LDA.W #InstList_EtecoonEscape_RunningLeft_LowTide_0 : BRA + 
...
InstList_DachoraEscape_XPositionMinus6:
    LDX.W $0E54 
    LDA.W $0F7A,X : SEC : SBC.W #$0006 : STA.W $0F7A,X 
    RTL 


InstList_DachoraEscape_XPositionPlus6:
    LDX.W $0E54 
    LDA.W $0F7A,X : CLC : ADC.W #$0006 : STA.W $0F7A,X 
    RTL 
