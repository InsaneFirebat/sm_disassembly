...
Function_PirateWall_ClimbingLeftWall:
    ...
    BEQ RTS_B2F04D 
    LDA.W #InstList_PirateWall_FireLaser_WallJumpRight 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    RTS 
...
Function_PirateWall_WallJumpingRight:
    ...
    CMP.L $7E8000,X 
    BNE .return 
    LDA.W #InstList_PirateWall_LandingOnRightWall 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W $0F7A,X 
...
Function_PirateWall_ClimbingRightWall:
    ...
    JSL.L IsSamusWithingAPixelRowsOfEnemy 
    BEQ RTS_B2F0E1 
    LDA.W #InstList_PirateWall_FireLaser_WallJumpLeft 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    RTS 
...
Function_PirateWall_WallJumpingLeft:
    ...
    CMP.L $7E8002,X 
    BNE .return 
    LDA.W #InstList_PirateWall_LandedOnLeftWall 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W $0F7A,X 
...
PirateNinja_ProjectileClawAttackTrigger:
    ...
    SBC.W $0AF6 
    BPL .return 
    LDA.W #InstList_PirateNinja_ProjectileClawAttack_Right 
    STA.W $0F92,X 
    BRA .set1Timer 
...
.reachedLeftPost:
    ...
    SBC.W $0AF6 
    BMI .return 
    LDA.W #InstList_PirateNinja_ProjectileClawAttack_Left 
    STA.W $0F92,X 
...
.falling:
    LDA.W #Function_PirateNinja_SpinJumpLeft_Falling 
    STA.W $0FA8,X 
    RTS 
...
.landing:
    LDA.W #RTS_B2804B 
    STA.W $0FA8,X 
    LDA.W #InstList_PirateNinja_Land_FacingLeft_0 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W $0FB0,X 
...
.falling:
    LDA.W #Function_PirateNinja_SpinJumpRight_Falling 
    STA.W $0FA8,X 
    RTS 
...
.landing:
    LDA.W #RTS_B2804B 
    STA.W $0FA8,X 
    LDA.W #InstList_PirateNinja_Land_FacingRight_0 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W $0FB2,X 
...
.negativeSpeed:
    LDA.W #Instruction_PirateNinja_DivekickLeft_Divekick 
    STA.W $0FA8,X 
    LDA.W #InstList_PirateNinja_DivekickLeft_Divekick 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #$0600 
...
.collision:
    LDA.W #Instruction_PirateNinja_DivekickLeft_WalkToLeftPost 
    STA.W $0FA8,X 
    LDA.W #InstList_PirateNinja_DivekickLeft_WalkToLeftPost_0 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.L $7E7810,X 
...
.negativeSpeed:
    LDA.W #Instruction_PirateNinja_DivekickRight_Divekick 
    STA.W $0FA8,X 
    LDA.W #InstList_PirateNinja_DivekickRight_Divekick 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #$0600 
...
.landing:
    LDA.W #Instruction_PirateNinja_DivekickRight_WalkToRightPost 
    STA.W $0FA8,X 
    LDA.W #InstList_PirateNinja_DivekickRight_WalkToRightPost_0 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.L $7E7810,X 
...
.collision:
    LDA.W #InstList_PirateWalking_LookingAround_FacingLeft 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
...
.collision:
    LDA.W #InstList_PirateWalking_LookingAround_FacingRight 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
