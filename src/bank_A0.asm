...
.timerExpired:
    LDA.B $B1 
    CLC : ADC.W BGShakeDisplacements_BG1X,X 
    STA.B $B1 
    LDA.B $B3 
    CLC : ADC.W BGShakeDisplacements_BG1Y,X 
    STA.B $B3 
    LDA.B $B5 
    CLC : ADC.W BGShakeDisplacements_BG2X,X 
    STA.B $B5 
    LDA.B $B7 
    CLC : ADC.W BGShakeDisplacements_BG2Y,X 
    STA.B $B7 
...
.hit:
    ...
    TAX 
    LDA.L $A0001A,X 
    CMP.W #Common_GrappleAI_NoInteraction 
...
EightBitSineMultiplication_A0B0DA:
    ...
    AND.W #$007F 
    TAY 
    LDA.W SineCosineTables_8bitSine,Y 
    AND.W #$00FF 
    SEP #$20 
    STA.W $4202 
...
; Where # is the origin and | is the negative y axis
    PHB 
    PHX 
    PEA.W UnsignedSineTable>>8&$FF00 ; $A000
    PLB 
    PLB 
    REP #$30 
    LDA.B $12 
...
EnemyBlockCollisionReaction_Horizontal_Slope_Square:
    ...
    AND.W #$0008 
    BNE .checkBothHalves 
    LDA.L SquareSlopeDefinitions_BankA0-1,X 
    BMI .solid 
