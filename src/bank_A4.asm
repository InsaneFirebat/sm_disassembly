...
.loopTargetPalette:
    LDA.W Palette_Crocomire_Sprite2,X 
    STA.L $7EC340,X 
...
.dead:
    ...
    LDA.W #$0054 
    STA.W $0FA8 
    LDA.W #InstList_CrocomireCorpse_Skeleton_Dead 
    STA.W $0F92 
    LDA.W #$0001 
    STA.W $0F94 
    LDA.W #$0240 
...
.collapseBridge:
    ...
    LDA.W #InstList_CrocomireTongue_BridgeCollapsed 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W $0F86,X 
    ...
    LDA.W #$7FFF 
    STA.W $0FD4,X 
    LDA.W #InstList_Crocomire_Sleep 
    STA.W $0FD2,X 
    LDA.W $0FC6 
    ORA.W #$0100 
    STA.W $0FC6 
...
MainAI_Crocomire_DeathSequence_3C_Hop_6_Sinking:
    ...
    LDA.W #$0058 
    STA.W $0FA8 
    LDA.W #InstList_CrocomireCorpse_Skeleton_FlowingDownTheRiver 
    STA.W $0F92 
    LDA.W #$0101 
    STA.L $7ECD24 
    STZ.W $05F7 
...
MainAI_Crocomire_DeathSequence_10_Hop_3_LoadMeltingTilemap:
    ...
    INC.W $0FA8,X 
    INC.W $0FA8,X 
    LDA.W #InstList_Crocomire_Melting1_TopRow 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #$0001 
    STA.W $0E1E 
    LDA.W #InstList_CrocomireTongue_Melting 
    STA.W $0FD2,X 
    LDA.W #$0001 
    STA.W $0FD4,X 
    LDA.W $0FC6,X 
...
.done:
    TXA 
    CLC 
    ADC.W #$0400 ; fallthrough to WriteCrocomireBG2Tilemap
    TAX 
...
MainAI_Crocomire_DeathSequence_2C_Hop_6_LoadMeltingTilemap:
    ...
    STA.W $068C 
    STA.W $0688 
    LDA.W #InstList_Crocomire_Melting2_TopRow 
    STA.W $0F92,X 
    LDX.W #$0000 
    LDA.W #$0338 
...
MainAI_Crocomire_DeathSequence_12_2E_Hop_3_4_LoadMeltTiles:
    ...
    STA.W $0696 
    LDA.W MeltingCrocomireTilesLoadingTable_Melting1_0+4,X 
    STA.W $068E 
    STZ.B $00 
    LDA.W MeltingCrocomireTilesLoadingTable_Melting1_0+6,X 
    STA.B $02 
    TXA 
    CLC 
    ADC.W #$0008 
...
MainAI_Crocomire_DeathSequence_42_BehindWall_NoMoreRumbling:
  ...
  + LDX.W $0330 
    LDA.W #$0200 
    STA.B $D0,X 
    LDA.W .skeletonSpriteTilesSourceAddress,Y 
    STA.B $D2,X 
    LDA.W #$00AD 
    STA.B $D4,X 
    LDA.B $52 
...
.zero:
    ...
    LDA.W #$0029 
    JSL.L QueueSound_Lib2_Max6 
    LDA.W #InstList_CrocomireCorpse_Skeleton_FallsApart_0 
    STA.W $0F92 
    LDA.W #$0001 
    STA.W $0F94 
    LDA.W #$0000 
...
EnemyTouch_Crocomire_Claws:
    ...
    STA.W $0FAA 
    LDA.W #$FFFC 
    STA.W $0B58 ; fallthrough to RTL_A4B950
...
EnemyShot_Crocomire_OpenMouth:
    ...
    BIT.W #$0010 
    BNE .damage 
    LDA.W CrocomireConstants_mouthOpenInstructionTimer 
    STA.W $0F94 
...
InitAI_CrocomireTongue:
    ...
    BNE .dead 
    LDX.W $0E54 
    LDA.W #InstList_CrocomireTongue_Fight 
    STA.W $0F92,X 
    LDA.W $0F88,X 
    ORA.W #$0404 
    STA.W $0F88,X 
