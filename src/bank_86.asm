...
PreInstruction_EnemyProjectile_KagoBug_Falling:
    ...
    BCS .hitFloor 
    LDA.W $1ADB,X 
    ADC.W KagoBug_Constants_Yacceleration : STA.W $1ADB,X 
    RTS 
...
.subtract:
  ...
  + STA.W $1A4B,Y 
    ...
    BMI .return 
    LDA.W $0F7A,X : SEC : SBC.W $0F82,X : SEC : SBC.W #$0101 : CMP.W $0911 
    BPL .return 
...
.enemyHasDrops:
    ...
    STZ.B $18 
    LDY.W #$0001 
    LDA.W $09C2 : CLC : ADC.W $09D6 : CMP.W #$001E 
    BCC .healthBombFlag 
    CMP.W #$0032 
    BCC .gracePeriod 
    DEY 
...
.loopMinorDrops:
    ...
    NOP 
    REP #$20 
    LDA.B $18 : CLC : ADC.W $4214 : CMP.B $1A 
    BCS .return 
    STA.B $18 
...
.positiveVelocity:
    CLC 
    LDA.W $1A6F,X 
    ADC.W $1AB7,X : STA.W $1A6F,X 
    LDA.W $1A93,X 
    ADC.W $1ADB,X : STA.W $1A93,X 
    CLC 
    LDA.W $1A27,X 
    ADC.W $1AFF,X : STA.W $1A27,X 
    LDA.W $1A4B,X 
    ADC.W $1B23,X : STA.W $1A4B,X 
    LDA.W $05B5 
    BIT.W #$0003 
    BNE .return 
    LDA.W $1A4B,X : STA.B $12 
