...
Function_MamaTurtle_RisingToPeak:
    ...
    LDA.W $0F7E,X 
    SEC : SBC.W MamaTurtleConstants_risingToPeakSpeed 
    STA.W $0F7E,X 
    LDA.W $0B5C 
    SEC : SBC.W MamaTurtleConstants_risingToPeakSpeed 
    STA.W $0B5C 
...
.loop:
    LDA.B $16 
    CLC : ADC.W PuyoHopTable_XSpeed,Y 
    STA.B $16 
    AND.W #$FF00 
    XBA 
    ASL #3
...
.noCollision:
    ...
    LDA.W $0FAA,X 
    SEC : SBC.W PuyoHopTable_YSpeedTableIndexDelta,Y 
    STA.W $0FAA,X 
    BRA + 
...
..falling:
    ...
    LDA.W $0FAA,X 
    CLC : ADC.W PuyoHopTable_YSpeedTableIndexDelta,Y 
    STA.W $0FAA,X 
...
.upsideDown:
  ...
  + LDA.W $0FB4,X 
    ...
    TAY 
    LDA.W $0F7A,X 
    CLC : ADC.W CacatacMaxTravelDistances,Y 
    STA.L $7E7802,X 
    LDA.W $0F7A,X 
    SEC : SBC.W CacatacMaxTravelDistances,Y 
    STA.L $7E7800,X 
    LDA.W $0FB7,X 
    AND.W #$00FF 
    ASL #3
...
InitAI_Owtch:
    ...
    TAY 
    LDA.W $0F7A,X 
    CLC : ADC.W OwtchConstants_XDistanceRanges,Y 
    STA.L $7E7804,X 
    LDA.W $0F7A,X 
    SEC : SBC.W OwtchConstants_XDistanceRanges,Y 
    STA.L $7E7802,X 
    LDA.W $0FB5,X 
    AND.W #$00FF 
    ASL A 
...
Function_Ship_LandingOnZebes_ApplyBrakes:
    ...
    TAY 
    LDA.W $0AFA 
    CLC : ADC.W ShipBrakesMovementData,Y 
    STA.W $0AFA 
    LDA.W $0FFE,X 
    CLC : ADC.W ShipBrakesMovementData,Y 
    STA.W $0FFE,X 
...
Function_Choot_Jumping:
    ...
    TAY 
    LDA.W $0F80,X 
    CLC : ADC.W CommonEnemySpeeds_QuadraticallyIncreasing+4,Y 
    BCC + 
    INC.W $0F7E,X 

  + STA.W $0F80,X 
    LDA.W $0F7E,X 
    CLC : ADC.W CommonEnemySpeeds_QuadraticallyIncreasing+6,Y 
    STA.W $0F7E,X 
    LDA.W $0FAA,X 
    SEC : SBC.W #$0200 
    STA.W $0FAA,X 
