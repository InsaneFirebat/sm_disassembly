...
Instruction_Evir_SetInitialRegenerationXOffset:
    LDX.W $0E54 
    LDA.L $7E7782,X 
    CMP.W #InstList_Evir_Body_FacingRight 
    BEQ .facingRight 
    LDA.W #$0008 
    STA.W $0FB2,X 
    BRA .return 
...
Instruction_Evir_FinishRegeneration:
    ...
    STA.L $7E7818,X 
    STA.L $7E7816,X 
    LDA.W #Function_EvirProjectile_Idle 
    STA.W $0FAC,X 
    RTL 
...
.nonZeroParam1:
  ...
  + LDA.W #$0000 
    STA.L $7E7800,X 
    STA.L $7E7802,X 
    LDA.W #Function_Evir_HandleBodyArms 
    STA.W $0FAC,X 
    RTL 
...
.SamusToTheRight:
  ...
  + LDA.W #InstList_Evir_Body_FacingLeft 
    STA.L $7E7804,X 
    LDA.W $0FAA,X 
    BEQ .keepLeft 
    LDA.W #InstList_Evir_Body_FacingRight 
    STA.L $7E7804,X 
...
HandleEvirArms:
    ...
    ADC.W #$000A 
    STA.W $0F7E,X 
    LDA.W #InstList_Evir_Arms_FacingLeft 
    STA.L $7E7804,X 
    JSR.W SetEvirInstList 
    BRA .return 
...
.facingRight:
    ...
    ADC.W #$000A 
    STA.W $0F7E,X 
    LDA.W #InstList_Evir_Arms_FacingRight 
    STA.L $7E7804,X 
    JSR.W SetEvirInstList 
...
InitAI_EvirProjectile:
    LDX.W $0E54 
    LDA.W #InstList_Evir_Projectile_Normal 
    STA.L $7E7804,X 
    JSR.W SetEvirInstList 
    LDA.W $0F16,X 
    STA.W $0F96,X 
...
.angleInitialized:
    LDA.L $7E7818,X 
    BEQ .doneSpawning 
    LDA.W #InstList_Evir_Projectile_Regenerating_0 
    STA.L $7E7804,X 
    JSR.W SetEvirInstList 
    BRA .merge 
...
ShootEvirProjectileAtSamus:
    ...
    LDA.W #$0001 
    STA.L $7E7816,X 
    LDA.W #Function_EvirProjectile_Moving 
    STA.W $0FAC,X 
...
StartEvirProjectileRegeneratingIfFarOffScreen:
    ...
    LDA.W #$0001 
    STA.L $7E7818,X 
    LDA.W #Function_EvirProjectile_Regenerating 
    STA.W $0FAC,X 
    LDA.W #$0001 
    STA.L $7E7818,X 
    LDA.W #InstList_Evir_Projectile_Regenerating_0 
...
.notDead:
    ...
    STA.W $0FCA,X 
    LDA.W $102C,X 
    CMP.W #Function_EvirProjectile_Moving 
    BEQ .return 
    LDA.W $100A,X 
    ORA.W #$0004 
    STA.W $100A,X 
...
InitAI_Eye:
    ...
    ORA.W #$2000 
    STA.W $0F86,X 
    LDA.W #Spritemap_CommonA8_Nothing 
    STA.W $0F8E,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W $0FB6,X 
    BMI .mountPart 
    LDA.W #Function_Eye_WaitForSamusToGetNear 
    STA.W $0FB2,X 
    LDA.W $0FB4,X 
    BIT.W #$0001 
    BEQ .facingRight 
    LDA.W #InstList_Eye_FacingLeft_Closed 
    STA.W $0F92,X 
    BRA .return 


.facingRight:
    LDA.W #InstList_Eye_FacingRight_Closed 
    STA.W $0F92,X 
    BRA .return 
...
Function_Eye_WaitForSamusToGetNear:
    ...
    BIT.W #$0001 
    BEQ .zeroParam 
    LDA.W #InstList_Eye_FacingLeft_Activating 
    STA.W $0F92,X 
    BRA + 


.zeroParam:
    LDA.W #InstList_Eye_FacingRight_Activating 
    STA.W $0F92,X 

  + LDA.W #Function_Eye_Activating 
    STA.W $0FB2,X 
...
.notInProximity:
    ...
    BIT.W #$0001 
    BEQ .zeroParam 
    LDA.W #InstList_Eye_FacingLeft_Deactivating 
    STA.W $0F92,X 
    BRA + 


.zeroParam:
    LDA.W #InstList_Eye_FacingRight_Deactivating 
    STA.W $0F92,X 

  + LDA.W #Function_Eye_Deactivating 
    STA.W $0FB2,X 
    BRA .merge 
...
Instruction_FuneNamihe_FinishActivity:
    ...
    LDA.W $0FAE,X 
    BEQ .return 
    LDA.W #Function_Namihe_WaitForSamusToGetNear 
    STA.W $0FAA,X 
...
InitAI_Fune_Namihe:
    LDX.W $0E54 
    LDA.W #InstListPointers_Fune_Namihe+$4 
    STA.W $0FA8,X 
    LDA.W #Function_Fune_WaitForTimer 
    STA.W $0FAA,X 
    LDA.W $0FB4,X 
    ...
    LDA.W #InstListPointers_Fune_Namihe+$C 
    STA.W $0FA8,X 
    LDA.W #Function_Namihe_WaitForSamusToGetNear 
    STA.W $0FAA,X 
...
InitAI_Coven:
    ...
    STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #InstList_Coven 
    STA.W $0F92,X 
    LDA.W #Function_Coven_Dematerialized_Asleep 
    STA.W $0FA8,X 
...
.next:
    ...
    BMI .return 
    LDX.W $0E54 
    LDA.W #Function_Coven_Materialize_FadeFromWhite 
    STA.W $0FA8,X 
    LDA.W $0F96,X 
    XBA 
    ASL A 
...
Function_Coven_Materialize_FadeFromWhite:
    ...
    AND.W #$FEFF 
    STA.W $0F86,X 
    LDA.W #Function_Coven_Materialized 
    STA.W $0FA8,X 
    LDA.W $0F7E,X 
    STA.L $7E7800,X 
    LDA.W #$0001 
    ...
    LDA.W #$0000 
    STA.L $7E7802,X 
    LDA.W CovenConstants_InitialHoveringYVelocity 
    STA.L $7E7804,X 
    LDA.W CovenConstants_MaterializeTimer 
    STA.W $0FAA,X 
    LDA.W #$0004 
    STA.L $7E780A,X 
    LDA.W $0AF6 
    ...
    STA.L $7E7816,X 
    STA.L $7E7818,X 
    LDA.W CovenConstants_SamusStationaryFramesThreshold 
    STA.L $7E781A,X 
    LDA.W CovenConstants_SamusMovementCounterThreshold 
    STA.L $7E781C,X 
...
HandleFadeInTimerAndIndex:
    ...
    LDA.W $0FAC,X 
    TAY 
    LDA.W CovenPaletteTransitionDelayTable,Y 
    BMI .terminator 
    STA.W $0FAA,X 
    TYA 
    INC A 
...
Function_Coven_Materialized:
    ...
    LDA.L $7E7802,X 
    SEC 
    SBC.W CovenConstants_HoveringYAccelerationDeceleration 
    STA.L $7E7802,X 
    LDA.L $7E7804,X 
    SBC.W #$0000 
    STA.L $7E7804,X 
...
.subvelocity:
    LDA.L $7E7802,X 
    CLC 
    ADC.W CovenConstants_HoveringYAccelerationDeceleration 
    STA.L $7E7802,X 
    LDA.L $7E7804,X 
    ADC.W #$0000 
    STA.L $7E7804,X 
  ...
  + LDA.W $0FAA,X 
    ...
    STA.W $0FAA,X 
    BNE .return 
    LDA.W #Function_Coven_Dematerializing 
    STA.W $0FA8,X 
    LDA.W $0F86,X 
    ORA.W #$0400 
    STA.W $0F86,X 
...
.timerExpired:
    ...
    LDA.W #$0002 
    STA.W $0FAC,X 
    LDA.W #Function_Coven_Dematerialized_Awake 
    STA.W $0FA8,X 
...
.materialize:
    LDA.W #Function_Coven_Materialize_FadeToWhite 
    STA.W $0FA8,X 
    LDA.W CovenConstants_SamusStationaryFramesThreshold 
    STA.L $7E781A,X 
    LDA.W CovenConstants_SamusMovementCounterThreshold 
    ...
    LDA.W $0AF6,X 
    CLC 
    ADC.W CovenConstants_OffsetsFromSamusToMaterialize_X,Y 
    STA.W $0F7A,X 
    LDA.W $0AFA,X 
    CLC 
    ADC.W CovenConstants_OffsetsFromSamusToMaterialize_Y,Y 
    STA.W $0F7E,X 
    RTL 
...
.checkYMovementDirection:
    TYA 
    CMP.L $7E7812,X 
    BEQ .matchingYMovementDirection 
    TYA 
    STA.L $7E7812,X 
    LDA.W CovenConstants_SamusMovementCounterThreshold 
    STA.L $7E781C,X 
...
.updateZone:
    ...
    STA.L $7E780C,X 
    SEC 
    SBC.W CovenStationaryZoneXRadius 
    STA.L $7E780E,X 
    LDA.W $0AF6 
    CLC 
    ADC.W CovenStationaryZoneXRadius 
    STA.L $7E7810,X 
    LDA.W $0AFA 
    STA.L $7E7814,X 
    SEC 
    SBC.W CovenStationaryZoneYRadius 
    STA.L $7E7816,X 
    LDA.W $0AFA 
    CLC 
    ADC.W CovenStationaryZoneYRadius 
    STA.L $7E7818,X 
    RTL 
...
Instruction_YappingMaw_OffsetSamusUpRight:
    LDX.W $0E54 
    LDA.W YappingMawSamusOffsets_X_UpRight 
    STA.L $7E8024,X 
    LDA.W YappingMawSamusOffsets_Y_UpRight 
    STA.L $7E8026,X 
    RTL 
...
Instruction_YappingMaw_OffsetSamusUpLeft:
    LDX.W $0E54 
    LDA.W YappingMawSamusOffsets_X_UpLeft 
    STA.L $7E8024,X 
    LDA.W YappingMawSamusOffsets_Y_UpLeft 
    STA.L $7E8026,X 
    RTL 
...
Instruction_YappingMaw_OffsetSamusDownRight:
    LDX.W $0E54 
    LDA.W YappingMawSamusOffsets_X_DownRight 
    STA.L $7E8024,X 
    LDA.W YappingMawSamusOffsets_Y_DownRight 
    STA.L $7E8026,X 
    RTL 
...
Instruction_YappingMaw_OffsetSamusDownLeft:
    LDX.W $0E54 
    LDA.W YappingMawSamusOffsets_X_DownLeft 
    STA.L $7E8024,X 
    LDA.W YappingMawSamusOffsets_Y_DownLeft 
    STA.L $7E8026,X 
    RTL 
...
Instruction_YappingMaw_OffsetSamusUp:
    LDX.W $0E54 
    LDA.W YappingMawSamusOffsets_X_Up 
    STA.L $7E8024,X 
    LDA.W YappingMawSamusOffsets_Y_Up 
    STA.L $7E8026,X 
    RTL 
...
Instruction_YappingMaw_OffsetSamusDown:
    LDX.W $0E54 
    LDA.W YappingMawSamusOffsets_X_Down 
    STA.L $7E8024,X 
    LDA.W YappingMawSamusOffsets_Y_Down 
    STA.L $7E8026,X 
    RTL 
...
InitAI_YappingMaw:
    ...
    LDA.W #$0040 
    STA.W $0FB0,X 
    LDA.W #InstList_YappingMaw_Attacking_FacingUp 
    STA.W $0F92,X 
    LDA.W #$0039 
    STA.B $24 
    LDA.W #$0008 
    ...
    LDA.W $0FB6,X 
    BNE .keepUp 
    LDA.W #InstList_YappingMaw_Attacking_FacingDown 
    STA.W $0F92,X 
    LDA.W #$0038 
    STA.B $24 
    LDA.W #$FFF8 
...
.keepUp:
    ...
    STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #Function_YappingMaw_Neutral 
    STA.W $0FA8,X 
    LDA.W $0F96,X 
    AND.W #$0E00 
    STA.L $7E880A,X 
...
Function_YappingMaw_Neutral:
  ...
  + LDA.W $0E3A 
    STA.L $7E7814,X 
    LDA.W #Function_YappingMaw_Attack 
    STA.W $0FA8,X 
...
.targetAngleGreaterThanEqualTo80:
  ...
  + JSR.W CalculateYappingMawOriginPosition 
    ...
    STA.L $7E8028,X 
    TAY 
    LDA.W InstListPointers_YappingMaw,Y 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    STZ.W $0F90,X 
    ...
    ASL A 
    TAY 
    LDA.W YappingMawSamusOffsets_X_Up,Y 
    STA.L $7E8024,X 
    LDA.W YappingMawSamusOffsets_Y_Up,Y 
    STA.L $7E8026,X 
    LDA.W #Function_YappingMaw_Attacking 
    STA.W $0FA8,X 
    RTS 
...
.cooldown:
    LDA.W #Function_YappingMaw_Cooldown 
    STA.W $0FA8,X 
    LDA.W #$0030 
    STA.L $7E802A,X 
    LDA.L $7E8028,X 
...
.upRight:
    LDA.W #InstList_YappingMaw_Cooldown_FacingUpRight 
    STA.W $0F92,X 
    BRA .upMerge 


.upLeft:
    LDA.W #InstList_YappingMaw_Cooldown_FacingUpLeft_0 
    STA.W $0F92,X 
    BRA .upMerge 
...
.downRight:
    LDA.W #InstList_YappingMaw_Cooldown_FacingDownRight 
    STA.W $0F92,X 
    BRA .moveSamus 


.downLeft:
    LDA.W #InstList_YappingMaw_Cooldown_FacingDownLeft_0 
    STA.W $0F92,X 
    BRA .moveSamus 


.down:
    LDA.W #InstList_YappingMaw_Cooldown_FacingDown_0 
    STA.W $0F92,X 
    BRA .return 
...
InitAI_Kago:
    ...
    STZ.W $0F90,X 
    STZ.W $0FB0,X 
    LDA.W #InstList_Kago_Initial_SlowAnimation 
    STA.W $0F92,X 
    LDA.W #Function_Kago_Nothing 
    STA.W $0FA8,X 
    STZ.W $0FB2,X 
    LDA.W $0FB4,X 
    STA.L $7E7808,X 
...
Function_Kago_Nothing:
    LDA.W #RTL_A8AB81 
    STA.W $0FA8,X ; fallthrough to RTL_A8AB81
...
EnemyShot_Kago:
    ...
    LDA.W #$0001 
    STA.W $0FAA,X 
    LDA.W #InstList_Kago_TakenHit_FastAnimation 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
...
.keepLeft:
    LDA.L $7E7800,X 
    LDA.W #InstList_Magdollite_Idling_FacingLeft 
    STA.W $0FAE,X 
    LDA.L $7E7800,X 
    BNE .keepLeft2 
    LDA.W #InstList_Magdollite_Idling_FacingRight 
    STA.W $0FAE,X 

.keepLeft2:
    JSR.W CheckIfMagdolliteInstListChanged 
    LDA.W #Function_Magdollite_WaitForSamusToGetNear 
    STA.W $0FB2,X 
    RTS 
...
Function_Magdollite_Init_Slave1:
    ...
    LDA.W #$0001 
    STA.L $7E781A,X 
    LDA.W #InstList_Magdollite_Slave1_NarrowPillar_FacingLeft 
    STA.W $0FAE,X 
    JSR.W CheckIfMagdolliteInstListChanged 
    LDA.W $0F7E,X 
    CLC 
    ADC.W #$0020 
    STA.W $0F7E,X 
    LDA.W #Function_Magdollite_Slave1_WaitForAttackToBeTriggered 
    STA.W $0FB2,X 
    LDA.W $0F86,X 
    ORA.W #$0100 
    STA.W $0F86,X 
...
Function_Magdollite_Init_Slave2:
    ...
    STA.W $0FAC,X 
    STA.L $7E7808,X 
    LDA.W #InstList_Magdollite_Slave2_PillarCap 
    STA.W $0FAE,X 
    JSR.W CheckIfMagdolliteInstListChanged 
    LDA.W $0F7E,X 
    CLC 
    ADC.W #$0020 
    STA.W $0F7E,X 
    LDA.W #Function_Magdollite_Slave2_Idling_WaitingForTrigger 
    STA.W $0FB2,X 
    LDA.W $0F86,X 
    ORA.W #$0100 
    STA.W $0F86,X 
...
SetMagdolliteGraphicsDrawnHook:
    LDA.W #EnemyGraphicsDrawnHook_Magdollite_PeriodicallyCyclePalettes 
    STA.W $178C 
    LDA.W #EnemyGraphicsDrawnHook_Magdollite_PeriodicallyCyclePalettes>>16 
    STA.W $178E 
    LDA.W $0F96,X 
    AND.W #$0E00 
    LSR #4CLC 
...
EnemyGraphicsDrawnHook_Magdollite_PeriodicallyCyclePalettes:
    ...
    STA.B $12 
    LDA.W Palette_Magdollite_Glow_1,Y 
    STA.B $14 
    LDA.W Palette_Magdollite_Glow_2,Y 
    STA.B $16 
    LDA.W Palette_Magdollite_Glow_3,Y 
    STA.B $18 
    LDA.W $1794 
    TAX 
    LDA.B $12 
...
.facingDirectionChosen:
    ...
    JSL.L IsSamusWithinAPixelColumnsOfEnemy 
    BEQ .return 
    LDA.W #InstList_Magdollite_SplashIntoLavaAndFormBasePillar_Left_0 
    STA.W $0FAE,X 
    LDA.L $7E7800,X 
    BEQ .keepLeft 
    LDA.W #InstList_Magdollite_SplashIntoLavaAndFormBasePillar_Right_0 
    STA.W $0FAE,X 

.keepLeft:
    JSR.W CheckIfMagdolliteInstListChanged 
    LDA.W #Function_Magdollite_WaitUntilBasePillarFormed 
    STA.W $0FB2,X 
...
Function_Magdollite_WaitUntilBasePillarFormed:
    ...
    LDA.W #$0000 
    STA.L $7E785A,X 
    LDA.W #Function_Magdollite_WaitForOtherPartsToFinish 
    STA.W $0FB2,X 
...
Function_Magdollite_WaitForOtherPartsToFinish:
    ...
    LDA.L $7E7804,X 
    BNE .return 
    LDA.W #InstList_Magdollite_UnformBasePillar_SplashBackToIdle_Left_0 
    STA.W $0FAE,X 
    JSL.L Get_SamusX_minus_EnemyX 
    BMI .facingDirectionChosen 
    LDA.W #InstList_Magdollite_UnformBasePillar_SplashBackToIdle_Right_0 
    STA.W $0FAE,X 

.facingDirectionChosen:
    JSR.W CheckIfMagdolliteInstListChanged 
    LDA.W #Function_Magdollite_UnformBasePillarBackToHeadIdling 
    STA.W $0FB2,X 
...
Function_Magdollite_Slave1_WaitForAttackToBeTriggered:
    ...
    LDA.L $7E781A,X 
    BNE .return 
    LDA.W #Function_Magdollite_Slave1_HandlePillarGrowth 
    STA.W $0FB2,X 
    LDA.W #$0000 
    STA.W $0FB0,X 
    STA.L $7E781A,X 
...
Function_Magdollite_Slave1_AddPillarStacksToReachSamusHeight:
    ...
    LDA.W $0F7E,X 
    SEC 
    SBC.W MagdolliteYOffsetAimingAtSamus,Y 
    CMP.W $0AFA 
    BMI .doneGrowing 
    LDA.W $0FB0,X 
    EOR.W #$FFFF 
    INC A 
    CMP.W MagdolliteArmHeightThreshold,Y 
    BPL .increasePillarStack 
    BRA .return 


.doneGrowing:
    LDA.W #Function_Magdollite_Slave1_GetEnemyIndex 
    STA.W $0FB2,X 
    LDA.W #$0001 
    STA.L $7E7818,X 
    LDA.W $0FB0,X 
...
.increasePillarStack:
    ...
    STA.W $0F7E,X 
    LDY.W $0FAA,X 
    LDA.W MagdolliteSlave1InstListPointers,Y 
    STA.W $0FAE,X 
    JSR.W CheckIfMagdolliteInstListChanged 
...
Function_Magdollite_Slave2_Idling_WaitingForTrigger:
    LDX.W $0E54 
    LDA.W $0F32,X 
    CMP.W #Function_Magdollite_WaitUntilBasePillarFormed 
    BNE .return 
    LDA.W #Function_Magdollite_Slave2_SetToThrowFireballsAfterGrowing 
    STA.W $0FB2,X 
...
Function_Magdollite_Slave2_SetSlave1ToShrinkAfterFireballs:
    ...
    STA.W $0FAE,X 
    JSR.W CheckIfMagdolliteInstListChanged 
    LDA.W #Function_Magdollite_Slave1_HandlePillarShrinking 
    STA.W $0F72,X 
    LDA.W #Function_Magdollite_Slave2_GoBackToIdlingAfterPillarShrinks 
    STA.W $0FB2,X 
    LDA.W #$0000 
    STA.L $7E77D8,X 
    LDA.L $7E7824,X 
...
Function_Magdollite_Slave2_SetToThrowFireballsAfterGrowing:
    ...
    LDA.L $7E77D8,X 
    BEQ .waiting 
    LDA.W #InstList_Magdollite_Slave2_ThrowFireballs_FacingLeft 
    STA.W $0FAE,X 
    LDA.W #$0000 
    STA.W $0FAA,X 
    JSL.L Get_SamusX_minus_EnemyX 
    BMI .directionChosen 
    LDA.W #InstList_Magdollite_ThrowFireballs_FacingRight 
    STA.W $0FAE,X 
    LDA.W #$0001 
    STA.W $0FAA,X 
...
.directionChosen:
    JSR.W CheckIfMagdolliteInstListChanged 
    LDA.W #Function_Magdollite_Slave2_SetSlave1ToShrinkAfterFireballs 
    STA.W $0FB2,X 
    LDA.W $0F7A,X 
    STA.L $7E7824,X 
    LDA.W $0F7E,X 
...
Function_Magdollite_Slave2_GoBackToIdlingAfterPillarShrinks:
    LDX.W $0E54 
    LDA.W $0F32,X 
    CMP.W #Function_Magdollite_WaitForSamusToGetNear 
    BNE .notWaitingForTrigger 
    LDA.W #Function_Magdollite_Slave2_Idling_WaitingForTrigger 
    STA.W $0FB2,X 
    BRA .done 
...
InitAI_Beetom:
    ...
    JSR.W Beetom_CalculateInitialHopSpeed 
    STA.L $7E7808,X 
    LDA.W #InstList_Beetom_Crawling_FacingRight_0 
    STA.L $7E7800,X 
    JSL.L Get_SamusX_minus_EnemyX 
    BPL .SamusToTheLeft 
    LDA.W #InstList_Beetom_Crawling_FacingLeft_0 
    STA.L $7E7800,X 

.SamusToTheLeft:
    JSR.W SetBeetomInstList 
    LDA.W #Function_Beetom_DecideAction 
    STA.W $0FAC,X 
    RTL 
...
Function_Beetom_DecideAction:
    ...
    JSL.L IsSamusWithinAPixelColumnsOfEnemy 
    BEQ .notInProximity 
    LDA.W #Function_Beetom_DecideAction_SamusInProximity 
    STA.W $0FAC,X 
    BRA .return 


.notInProximity:
    LDA.W #Function_Beetom_DecideAction_SamusNotInProximity 
    STA.W $0FAC,X 
...
Function_Beetom_DecideAction_SamusNotInProximity:
    ...
    ASL A 
    TAY 
    LDA.W SamusNotInProximityBeetomFunctionPointers,Y 
    STA.W $0FAC,X 
    LDA.W $05E5 
    AND.W #$0001 
    STA.L $7E7812,X 
...
Function_Beetom_StartCrawlingLeft:
    LDX.W $0E54 
    LDA.W #Function_Beetom_CrawlingLeft 
    STA.W $0FAC,X 
    LDA.W #InstList_Beetom_Crawling_FacingLeft_0 
    STA.L $7E7800,X 
    JSR.W SetBeetomInstList 
...
Function_Beetom_StartCrawlingRight:
    LDX.W $0E54 
    LDA.W #Function_Beetom_CrawlingRight 
    STA.W $0FAC,X 
    LDA.W #InstList_Beetom_Crawling_FacingRight_0 
    STA.L $7E7800,X 
    JSR.W SetBeetomInstList 
...
Function_Beetom_StartShortHopRight:
    ...
    LDA.L $7E7804,X 
    STA.W $0FAA,X 
    LDA.W #Function_Beetom_ShortHopLeft 
    STA.W $0FAC,X 
    LDA.W #$0000 
    STA.L $7E780A,X 
    LDA.W #InstList_Beetom_Hop_FacingLeft 
    STA.L $7E7800,X 
    JSR.W SetBeetomInstList 
    RTS 
...
Function_Beetom_StartShortHopLeft:
    ...
    LDA.L $7E7804,X 
    STA.W $0FAA,X 
    LDA.W #Function_Beetom_ShortHopRight 
    STA.W $0FAC,X 
    LDA.W #$0000 
    STA.L $7E780A,X 
    LDA.W #InstList_Beetom_Hop_FacingRight 
    STA.L $7E7800,X 
    JSR.W SetBeetomInstList 
    RTS 
...
Function_Beetom_StartLongHopLeft:
    ...
    LDA.L $7E7806,X 
    STA.W $0FAA,X 
    LDA.W #Function_Beetom_LongHopLeft 
    STA.W $0FAC,X 
    LDA.W #$0000 
    STA.L $7E780A,X 
    LDA.W #InstList_Beetom_Hop_FacingLeft 
...
Function_Beetom_StartLongHopRight:
    ...
    LDA.L $7E7806,X 
    STA.W $0FAA,X 
    LDA.W #Function_Beetom_LongHopRight 
    STA.W $0FAC,X 
    LDA.W #$0000 
    STA.L $7E780A,X 
    LDA.W #InstList_Beetom_Hop_FacingRight 
...
Function_Beetom_DecideAction_SamusInProximity:
    ...
    LDA.W #InstList_Beetom_Hop_FacingRight 
    STA.L $7E7800,X 
    LDA.W #Function_Beetom_LungeRight 
    STA.W $0FAC,X 
    LDA.W #$0001 
    STA.L $7E7812,X 
    JSL.L Get_SamusX_minus_EnemyX 
    ...
    LDA.W #InstList_Beetom_Hop_FacingLeft 
    STA.L $7E7800,X 
    LDA.W #Function_Beetom_LungeLeft 
    STA.W $0FAC,X 
    LDA.W #$0000 
    STA.L $7E7812,X 
...
Function_Beetom_StartDrainingSamus_FacingLeft:
    LDX.W $0E54 
    LDA.W #InstList_Beetom_DrainingSamus_FacingLeft_0 
    STA.L $7E7800,X 
    JSR.W SetBeetomInstList 
    LDA.W #Function_Beetom_DrainingSamus_FacingLeft 
    STA.W $0FAC,X 
    RTS 
...
Function_Beetom_StartDrainingSamus_FacingRight:
    LDX.W $0E54 
    LDA.W #InstList_Beetom_DrainingSamus_FacingRight_0 
    STA.L $7E7800,X 
    JSR.W SetBeetomInstList 
    LDA.W #Function_Beetom_DrainingSamus_FacingRight 
    STA.W $0FAC,X 
    RTS 
...
.keepLeft:
    ...
    LDA.W #$0000 
    STA.L $7E780A,X 
    LDA.W #Function_Beetom_Dropping 
    STA.W $0FAC,X 
    RTS 
...
Function_Beetom_StartBeingFlung:
    ...
    LDA.W #$0000 
    STA.W $0FAA,X 
    LDA.W #Function_Beetom_BeingFlung 
    STA.W $0FAC,X 
    RTS 
...
Function_Beetom_CrawlingLeft:
    ...
    LDA.W #Function_Beetom_StartCrawlingRight 
    STA.W $0FAC,X 
    DEC.W $0F7E,X 
    LDA.W $0F7A,X 
    CLC 
...
Function_Beetom_CrawlingRight:
    ...
    JSL.L MoveEnemyDownBy_14_12 
    BCS .collidedWithBlock 
    LDA.W #Function_Beetom_StartCrawlingLeft 
    STA.W $0FAC,X 
    DEC.W $0F7E,X 
    LDA.W $0F7A,X 
    SEC 
...
.falling:
  ...
  + LDA.W #$FFFF 
    ...
    EOR.W #$0001 
    STA.L $7E7812,X 
    LDA.W #Function_Beetom_StartDropping 
    STA.W $0FAC,X 
...
.notCollidedWithWall:
    LDA.W #$0000 
    STA.L $7E7810,X 
    LDA.W #Function_Beetom_StartBeingFlung 
    STA.W $0FAC,X 
    BRA .return 
...
EnemyTouch_Beetom:
    ...
    LDA.L $7E7812,X 
    BNE .right 
    LDA.W #Function_Beetom_StartDrainingSamus_FacingLeft 
    STA.W $0FAC,X 
    BRA + 


.right:
    LDA.W #Function_Beetom_StartDrainingSamus_FacingRight 
    STA.W $0FAC,X 
...
EnemyShot_Beetom:
    ...
    BEQ .return 
    LDA.W $0FAC,X 
    CMP.W #Function_Beetom_DrainingSamus_FacingRight 
    BEQ .startDropping 
    CMP.W #Function_Beetom_DrainingSamus_FacingLeft 
    BNE .return 
...
InitAI_Powamp:
    ...
    LDA.W #$003C 
    STA.W $0FB0,X 
    LDA.W #Function_Powamp_Deflated_Resting 
    STA.W $0FB2,X 
    LDA.W #InstList_Powamp_Body_SlowAnimation 
    STA.W $0F92,X 
    BRA .return 
...
.balloon:
    ...
    LDA.W #RTL_A8C568 
    STA.W $0FB2,X 
    LDA.W #InstList_Powamp_Balloon_Deflated 
    STA.W $0F92,X 
    LDA.W $0FB6,X 
    STA.W $0FAE,X 
...
HandlePowampBalloonYOffset:
    ...
    SBC.W #$0004 
    SEC 
    SBC.W #InstList_Powamp_Balloon_StartingToRise 
    LSR A 
    CMP.W #$0006 
    BMI + 
    LDA.W #$0000 
...
.sinking:
    ...
    SBC.W #$0004 
    SEC 
    SBC.W #InstList_Powamp_Balloon_StartSinking 
    LSR A 
    CMP.W #$0006 
    BMI + 
    LDA.W #$0000 
...
.timerExpired:
    LDA.W #$0001 
    STA.W $0F54,X 
    LDA.W #InstList_Powamp_Balloon_StartingToRise 
    STA.W $0F52,X 
    LDA.W #Function_Powamp_Inflating 
    STA.W $0FB2,X 
    LDA.W #$000A 
    STA.W $0FB0,X 
...
.timerExpired:
    LDA.W #Function_Powamp_Inflated_RiseToTargetHeight 
    STA.W $0FB2,X 
    LDA.W Powamp_InitialYVelocity_Rising 
    STA.W $0FA8,X 
    LDA.W Powamp_InitialYVelocity_Rising+2 
    STA.W $0FAA,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #InstList_Powamp_Body_FastAnimation 
    STA.W $0F92,X 
...
Function_Powamp_Inflated_RiseToTargetHeight:
    ...
    BIT.W #$0001 
    BEQ .notGrappleAI 
    LDA.W #Function_Powamp_Grappled_RiseToTargetHeight 
    STA.W $0FB2,X 
...
.timerNotExpired:
    ...
    LDA.W $0F6A,X 
    SEC 
    SBC.W PowampTravelDistanceWhenNotGrappled 
    CMP.W $0F7E,X 
    BMI .done 
...
.doneRising:
    ...
    CMP.W #$0006 
    BEQ .centered 
    LDA.W #Function_Powamp_Inflated_FinishWiggle 
    STA.W $0FB2,X 
    BRA .done 


.centered:
    LDA.W #Function_Powamp_Deflating 
    STA.W $0FB2,X 
    LDA.W #$000A 
    STA.W $0FB0,X 
    LDA.W #$0001 
    STA.W $0F54,X 
    LDA.W #InstList_Powamp_Balloon_StartSinking 
    STA.W $0F52,X 
...
.doneSinking:
    ...
    CMP.W #$0006 
    BEQ .centered 
    LDA.W #Function_Powamp_Grappled_FinishWiggle 
    STA.W $0FB2,X 
    BRA .return 


.centered:
    LDA.W #Function_Powamp_Grappled_Resting 
    STA.W $0FB2,X 
...
.timerExpired:
    LDA.W #Function_Powamp_Deflated_Sinking 
    STA.W $0FB2,X 
    LDA.W Powamp_InitialYVelocity_Sinking 
    STA.W $0FA8,X 
    LDA.W Powamp_InitialYVelocity_Sinking+2 
    STA.W $0FAA,X 
...
Function_Powamp_FatalDamage:
  ...
  + LDA.W #Function_Powamp_DeathSequence 
    STA.W $0FB2,X 
    LDA.W #$0020 
    STA.W $0FB0,X 
    JSR.W HandlePowampBalloonYOffset 
...
.notHurtAI:
    LDA.W $0F8C,X 
    BNE .return 
    LDA.W #Function_Powamp_FatalDamage 
    STA.W $0FB2,X 
    LDA.W #$0001 
    STA.W $0FB6,X 
...
InitAI_Robot:
    ...
    LDX.W $0E54 
    SEP #$20 
    LDA.B #EnemyGraphicsDrawnHook_Robot_PeriodicallyCyclePalettes>>16 
    STA.W $178E 
    REP #$20 
    LDA.W #EnemyGraphicsDrawnHook_Robot_PeriodicallyCyclePalettes 
    STA.W $178C 
    LDA.W $0F86,X 
    ORA.W #$A000 
    STA.W $0F86,X 
...
.again:
    LDA.W .paletteColor9,Y 
    BMI .zero 
    STA.L $7EC112,X 
    LDA.W .paletteColorA,Y 
    STA.L $7EC114,X 
    LDA.W .paletteColorB,Y 
    STA.L $7EC116,X 
    LDA.W .paletteColorC,Y 
    STA.L $7EC118,X 
    LDA.W .timer,Y 
    STA.L $7ED654 
    TYA 
...
Instruction_Robot_TryShootingLaserUpRight:
    LDA.W #InstList_Robot_FacingRight_ShotLaserUpRight 
    STA.B $32 
    LDA.W #EnemyProjectile_RobotLaser_UpRight 
    STA.B $30 
    BRA HandleFiringLaser_Upwards 


Instruction_Robot_TryShootingLaserUpLeft:
    LDA.W #InstList_Robot_FacingLeft_ShotLaserUpLeft 
    STA.B $32 
    LDA.W #EnemyProjectile_RobotLaser_UpLeft 
    STA.B $30 ; fallthrough to HandleFiringLaser_Upwards
...
Instruction_Robot_TryShootingLaserRight:
    LDA.W #InstList_Robot_FacingRight_ShotLaserRight 
    STA.B $32 
    BRA HandleFiringLaser_Horizontal 


Instruction_Robot_TryShootingLaserLeft:
    LDA.W #InstList_Robot_FacingLeft_ShotLaserLeft 
    STA.B $32 
...
Instruction_Robot_TryShootingLaserDownRight:
    LDA.W #EnemyProjectile_RobotLaser_DownRight 
    STA.B $30 
    LDA.W #InstList_Robot_FacingRight_ShotLaserDownRight 
    STA.B $32 
    BRA HandleFiringLaser_Downwards 


Instruction_Robot_TryShootingLaserDownLeft:
    LDA.W #EnemyProjectile_RobotLaser_DownLeft 
    STA.B $30 
    LDA.W #InstList_Robot_FacingLeft_ShotLaserDownLeft 
    STA.B $32 
...
InitAI_Bull:
    ...
    STA.L $7E780A,X 
    STA.W $0FB2,X 
    LDA.W BullAccelerationIntervalTable_decel,Y 
    STA.L $7E780C,X 
    LDA.W #$0010 
    STA.W $0FB0,X 
    LDA.W #Function_Bull_MovementDelay 
    STA.W $0FA8,X 
    LDA.W $0FB6,X 
    ASL A 
    TAY 
    LDA.W BullConstants_MaxSpeeds,Y 
    STA.L $7E7800,X 
    RTL 
...
Function_Bull_MovementDelay:
    ...
    LDA.W #$0010 
    STA.W $0FB0,X 
    LDA.W #Function_Bull_TargetSamus 
    STA.W $0FA8,X 
...
Function_Bull_TargetSamus:
    ...
    STA.L $7E7802,X 
    STA.L $7E7804,X 
    LDA.W #Function_Bull_Accelerating 
    STA.W $0FA8,X 
    LDA.W #$0018 
    STA.W $0FAC,X 
    RTS 
...
TriggerBullDecelerationIfTooFarOffTarget:
    ...
    CMP.W #$0030 
    BMI .return 
    LDA.W #Function_Bull_Decelerating 
    STA.W $0FA8,X 
    LDA.W #$0018 
    STA.W $0FAC,X 
...
.noDamage:
    ...
    ASL A 
    TAY 
    LDA.W BullConstants_AngleToMove_upFacingRight,Y 
    STA.L $7E7804,X 
    LDA.W #$0100 
    STA.W $0FAA,X 
    LDA.W #$0600 
...
InitAI_Alcoon:
    ...
    ORA.W #$2000 
    STA.W $0F86,X 
    LDA.W #InstList_Alcoon_FacingLeft_Walking_0 
    STA.W $0F92,X 
    LDA.W #Function_Alcoon_WaitForSamusToGetNear 
    STA.W $0FA8,X 
...
.SamusBelowSpawn:
  ...
  + CMP.W AlcoonConstants_XThresholdToEmerge 
    BPL .returnPLP 
    JSR.W SetupAlcoonJumpMovement 
...
.SamusToTheRight:
    ...
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #Function_Alcoon_Emerging_Rising 
    STA.W $0FA8,X 
    LDA.W #$005E 
    JSL.L QueueSound_Lib2_Max6 
...
.falling:
    LDA.W #Function_Alcoon_Emerging_Falling 
    STA.W $0FA8,X 
...
.directionChosen:
    ...
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #Function_Alcoon_MoveHorizontally_SpitFireballsAtSamus 
    STA.W $0FA8,X 
    LDA.W #$0001 
    STA.L $7E7808,X 
    RTL 
...
.farAway:
    LDA.W #Function_Alcoon_Hiding_Rising 
    STA.W $0FA8,X 
    LDA.W #$FFFC 
    STA.W $0FAA,X 
    LDA.W #$0000 
...
Function_Alcoon_Hiding_Rising:
    ...
    JSR.W AlcoonYAcceleration 
    BMI .return 
    LDA.W #Function_Alcoon_Hiding_Falling 
    STA.W $0FA8,X 
...
Instruction_Alcoon_DecrementStepCounter_MoveHorizontally:
    LDX.W $0E54 
    LDA.L $7E7808,X 
    BEQ Instruction_Alcoon_MoveHorizontally_TurnIfWallCollision 
    DEC A 
...
ChooseAtomicYMovementFunction:
    LDX.W $0E54 
    LDA.W #Function_Atomic_MoveUp 
    STA.W $0FA8,X 
    JSL.L Get_SamusY_minus_EnemyY 
    BMI .return 
    LDA.W #Function_Atomic_MoveDown 
    STA.W $0FA8,X 
...
ChooseAtomicXMovementFunction:
    LDX.W $0E54 
    LDA.W #Function_Atomic_MoveLeft 
    STA.W $0FAA,X 
    JSL.L Get_SamusX_minus_EnemyX 
    BMI .return 
    LDA.W #Function_Atomic_MoveRight 
    STA.W $0FAA,X 
...
.timerExpired:
    LDA.W #Function_Spark_Intermittent_Active 
    STA.W $0FAA,X 
    LDA.W #InstList_Spark_FlickerOn 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    STZ.B $12 
...
.timerExpired:
    LDA.W #Function_Spark_Intermittent_Inactive 
    STA.W $0FAA,X 
    LDA.W #InstList_Spark_FlickerOut 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #$0008 
...
InitAI_FaceBlock:
    LDX.W $0E54 
    LDA.W #InstList_FaceBlock_FacingForward 
    STA.W $0F92,X 
...
InitAI_Kihunter:
    ...
    STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #InstList_Kihunter_Idling_FacingLeft 
    STA.W $0F92,X 
    LDA.W #$0000 
    STA.W $0FB2,X 
    LDA.W #Function_Kihunter_Winged_IdleFlying 
    STA.W $0FA8,X 
    LDA.W #$0000 
    STA.L $7E7810,X 
    LDA.W #$0001 
    ...
    LDA.W #$0001 
    STA.L $7E7828,X 
    LDA.W #Function_Kihunter_Wingless_InitialFalling 
    STA.W $0FA8,X 
    LDA.W #$0000 
    STA.L $7E7810,X 
    LDA.W #$0001 
...
InitAI_KihunterWings:
    ...
    STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #InstList_KihunterWings_FacingLeft 
    STA.W $0F92,X 
    LDA.W $0F3E,X 
    STA.W $0F7E,X 
    LDA.W $0F3A,X 
    STA.W $0F7A,X 
    LDA.W #Function_KihunterWings_Attached 
    STA.W $0FA8,X 
    LDA.W $0F56,X 
    STA.W $0F96,X 
    LDA.W $0F58,X 
...
.movingLeft:
    LDA.W .instListPointers_kihunter,Y 
    STA.W $0F92,X 
    LDA.W .instListPointers_wings,Y 
    STA.W $0FD2,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    STA.W $0FD4,X 
...
.noCollision:
  ...
  + STA.B $14 
    CMP.W KihunterConstants_XProximityToActivateSwoop 
    BMI + 
    RTL 
...
.rightOfSamus:
  ...
  + LDA.W .instListPointers_kihunter,Y 
    ...
    LDA.W $0F7E,X 
    STA.W $0FAC,X 
    LDA.W #Function_Kihunter_Winged_Swoop 
    STA.W $0FA8,X 
    LDA.B $18 
    STA.L $7E7824,X 
    LDA.B $14 
...
.arcingRight:
    LDA.W $0FB2,X 
    CMP.L $7E781C,X 
    BMI .noInstListChange 

  + LDA.L $7E7820,X 
    BNE .noInstListChange 
    LDA.W #$0001 
    STA.L $7E7820,X 
...
.collidedVertically:
    LDA.W #Function_Kihunter_Winged_BackOff 
    STA.W $0FA8,X 
    LDA.W #$0000 
    STA.L $7E7810,X 
    LDA.W #$FFFF 
...
Instruction_Kihunter_SetIdlingInstListsFacingForwards:
    ...
    LDA.W #InstList_KihunterWings_FacingRight 
    STA.B $12 
...
.keepLeft:
    ...
    STA.W $0F94,X 
    LDA.W $0FE8,X 
    CMP.W #Function_KihunterWings_Attached 
    BNE .return 
    LDA.B $12 
    STA.W $0FD2,X 
    LDA.W #$0001 
...
Function_Kihunter_Wingless_InitialFalling:
    ...
    JSL.L MoveEnemyDownBy_14_12 
    BCC .notCollidedWithBlock 
    LDA.W #Function_Kihunter_Wingless_PrepareToHop 
    STA.W $0FA8,X 
    RTL 
...
.notCollidedWithBlock:
    LDA.L $7E7810,X 
    CLC 
    ADC.W KihunterConstants_fallingAcceleration_hop 
    STA.L $7E7810,X 
    LDA.L $7E7812,X 
...
Function_Kihunter_Wingless_PrepareToHop:
    ...
    LDA.W #$0002 
    STA.L $7E780E,X 
    LDA.W #InstList_Kihunter_Hop_FacingRight 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    RTL 
...
.rightOfSamus:
    ...
    LDA.W #$FFFE 
    STA.L $7E780E,X 
    LDA.W #InstList_Kihunter_Hop_FacingLeft 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0F94,X ; fallthrough to RTL_A8F5E3
...
Instruction_Kihunter_SetFunctionToHop:
    PHX 
    LDX.W $0E54 
    LDA.W #Function_Kihunter_Wingless_Hop 
    STA.W $0FA8,X 
    PLX 
    RTL 
...
.collidedVertically:
    ...
    LDA.W $0F92,X 
    CMP.W #InstList_Kihunter_Hop_FacingRight 
    BMI .keepLeft 
...
Instruction_Kihunter_SetFunctionTo_Wingless_Thinking:
    PHX 
    LDX.W $0E54 
    LDA.W #Function_Kihunter_Wingless_Thinking 
    STA.W $0FA8,X 
    PLX 
    RTL 
...
.clipWings:
    ...
    LDA.W #$E000 
    STA.W $0FB2,X 
    LDA.W #Function_KihunterWings_Falling 
    STA.W $0FA8,X 
    LDA.W #Function_KihunterWings_Falling_DriftingLeft 
    STA.L $7E7800,X 
    LDA.L $7E780E,X 
    SEC 
    SBC.L $7E7816,X 
    ...
    LDA.L $7E7814,X 
    STA.W $0FAA,X 
    LDA.W #InstList_KihunterWings_Falling 
    STA.W $0F92,X 
    LDA.W #Spritemap_CommonA8_Nothing 
    STA.W $0F8E,X 
    LDA.W #$0001 
...
Function_KihunterWings_Falling_DriftingLeft:
    ...
    LDA.W $0FB2,X 
    CLC 
    ADC.W CommonEnemySpeeds_QuadraticallyIncreasing+5,Y 
    STA.W $0FB2,X 
...
SetupFallingKihunterWingsDriftingRight:
    LDA.W #Function_KihunterWings_Falling_DriftingRight 
    STA.L $7E7800,X 
    LDA.L $7E7814,X 
    STA.W $0FAA,X 
    LDA.W #$A000 
