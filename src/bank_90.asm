...
.periodicDamage:
    LDA.W $0A4E 
    CLC : ADC.W SamusPhysicsConstants_LavaSubDamagePerFrame 
    STA.W $0A4E 
    LDA.W $0A50 
...
AnimateSamus_FX_Acid:
  ...
  + LDA.W $0A4E 
    CLC : ADC.W SamusPhysicsConstants_AcidSubDamagePerFrame 
    STA.W $0A4E 
    LDA.W $0A50 
...
Calculate_CameraXSpeed:
  ...
  + LDA.W $0B12 
    ...
    LDA.W $0B10 
    SBC.W $0AF6 
    CLC : ADC.W SamusPhysicsConstants_CameraXOffsetFromSamusWhenTurning 
    STA.W $0DA2 
    BRA .return 
...
.accelerating:
    LDA.W $0B44 
    CLC : ADC.W SamusPhysicsConstants_XSubAccelerations_DashHeld,X 
    STA.W $0B44 
    LDA.W $0B42 
...
.trail:
  ...
  + LDA.W $0C04,X 
    ...
    TAY 
    LDA.W $0BDC,X 
    CLC : ADC.W ProjectileAccelerations_X,Y 
    STA.W $0BDC,X 
    LDA.W $0BF0,X 
    CLC : ADC.W ProjectileAccelerations_Y,Y 
    STA.W $0BF0,X 
    TYX 
    JSR.W (.pointers,X) 
...
AccelerateMissile:
    ...
    BNE .initialized 
    LDA.W $0C7C,X 
    CLC : ADC.W MissileInitializedBitset 
    STA.W $0C7C,X 
    AND.W #$FF00 
    BEQ .return 
...
.powerBombsSelected:
    ...
    TAX 
    LDA.W $09CE 
    SEC : SBC.W CostOfSBAsInPowerBombs,X 
    BPL + 
    LDA.W #$0000 
...
.loop:
    ...
    XBA 
    AND.W #$0003 
    CLC : ADC.W BombSpreadData_YSpeeds,Y 
    EOR.W #$FFFF 
    INC A 
    STA.W $0BF0,X 
    STA.W $0CA4,X 
...
UNUSED_ProjectilePreInstruction_UnknownProjectile27_90EFD3:
    LDA.W $0B64,X 
    CLC : ADC.W .XVelocities,X 
    STA.W $0B64,X 
    LDA.W $0B78,X 
    CLC : ADC.W .YVelocities,X 
    STA.W $0B78,X 
    CMP.W $0AFA 
    BNE .return 
    LDA.W $0C7C,X 
