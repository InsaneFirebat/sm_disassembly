...
.SamusInvincible:
    JSR.W PushSamusBack 
    LDA.W #Function_KraidLint_FireLint 
    STA.W $10A8 
...
InitAI_Kraid:
    ...
    STA.W $0603 
    REP #$20 
    LDA.W #UnpauseHook_KraidIsAlive 
    STA.W $0604 
    LDA.W #PauseHook_Kraid 
    STA.W $0601 
...
.loopBG2Tilemap:
    ...
    LDA.W #$0200 
    STA.B $D0,X 
    LDA.W #Tiles_KraidRoomBackground 
    STA.B $D2,X 
    SEP #$20 
    LDA.B #Tiles_KraidRoomBackground>>16 
    STA.B $D4,X 
    REP #$20 
    LDA.B $5D 
    AND.W #$000F 
    ...
    LDA.W #Function_Kraid_FadeInRegularBG_ClearBG2TilemapTopHalf 
    STA.W $0FA8 
    RTL 
...
.loopKraidHealth:
    ...
    ORA.W #$0400 
    STA.W $0F86 
    LDA.W #Function_Kraid_RestrictSamusXPositionToFirstScreen 
    STA.W $0FA8 
    LDA.W #$012C 
    STA.W $0FB2 
    LDA.W #Function_Kraid_RaiseThruFloor_LoadTilemapTopHalf 
    STA.L $7E7800 
    LDA.W #$0040 
    STA.W $0FAC 
...
InitAI_KraidArm:
    ...
    LDA.W #RTL_A7BA2D 
    STA.W $0FE8 
    LDA.W #InstList_KraidArm_RisingSinking 
    STA.W $0FD2 
    LDA.W #$0001 
    STA.W $0FD4 
    STZ.W $0FEA 
...
InitAI_KraidLintTop:
    ...
    LDA.W #$7FFF 
    STA.W $1014 
    LDA.W #InstList_KraidLint_Initial 
    STA.W $1012 
    LDA.W #Spritemap_KraidLint_Initial 
    STA.W $100E 
    LDA.W #RTL_A7B831 
    STA.W $1028 
    LDA.W #$7FFF 
...
InitAI_KraidFoot:
    ...
    LDA.W $0F96 
    STA.W $10D6 
    LDA.W #InstList_KraidFoot_Initial 
    STA.W $10D2 
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #RTL_A7BA2D 
...
.done:
    ...
    CMP.W #$0128 
    BPL .return 
    LDA.W #Function_Kraid_KraidGetsBig_SetBG2TilemapPriorityBits 
    STA.W $0FA8 
...
.loop:
    ...
    AND.W #$FBFF 
    STA.W $0FC6 
    LDA.W #Function_Kraid_KraidGetsBig_FinishUpdatingBG2Tilemap 
    STA.W $0FA8 
    JMP.W UpdateBG2TilemapTopHalf 


Function_Kraid_KraidGetsBig_FinishUpdatingBG2Tilemap:
    LDA.W #Function_Kraid_KraidGetsBig_DrawRoomBackground 
    STA.W $0FA8 
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #InstList_KraidFoot_KraidIsBig_Neutral 
    STA.W $10D2 
    LDA.W #InstList_KraidLint_KraidIsBig 
    STA.W $1012 
    STA.W $1052 
    STA.W $1092 
    LDA.W #ExtendedSpritemap_KraidLint_KraidIsBig 
    STA.W $100E 
    STA.W $104E 
    STA.W $108E 
...
Function_Kraid_KraidGetsBig_DrawRoomBackground:
    LDA.W #Function_Kraid_KraidGetsBig_FadeInRoomBackground 
    STA.W $0FA8 
    STZ.W $0FB0 
...
SetupKraidMainLoop_Thinking:
    LDA.W #Function_Kraid_MainLoop_Thinking 
    STA.W $0FA8 
...
.reachedTargetColor:
    ...
    JSR.W EnableKraidLints 
    LDA.W #Function_KraidNail_Initialize 
    STA.L $7E7980 
    STA.L $7E79C0 
    LDA.W #Function_Kraid_HandleFunctionTimer 
    STA.W $1128 
    STA.W $1168 
    LDA.W #$0040 
    STA.W $1132 
    ...
    LDA.W #$0001 
    STA.W $0FEC 
    LDA.W #InstList_Kraid_Roar_1 
    STA.W $0FAA 
    LDA.W #$0120 
    STA.L $7E781E 
    LDA.W #Function_KraidFoot_Phase2Setup_WalkToStartingPoint 
    STA.W $10E8 
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #InstList_KraidFoot_KraidIsBig_WalkingBackwards_0 
    STA.W $10D2 
    RTL 
...
EnableKraidLints:
    STA.W $0FB2,X 
    LDA.W #Function_KraidNail_HorizontallyAlignEnemyToKraid 
    STA.W $0FA8,X 
    LDA.W #Function_KraidLint_ProduceLint 
    STA.L $7E7800,X 
    STZ.W $0FAA,X 
    RTS 
...
Function_Kraid_MainLoop_Thinking:
    ...
    STA.L $7E7806 
    BNE .return 
    LDA.W #Function_KraidMainLoop_AttackingWithMouthOpen 
    STA.W $0FA8 
    LDA.W #InstList_Kraid_Roar_1 
    STA.W $0FAA 
    LDA.W InstList_Kraid_Roar_0 
    STA.W $0FAC 
...
Function_Kraid_KraidGetsBig_Thinking:
    ...
    STA.L $7E7806 
    BNE .return 
    LDA.W #Function_Kraid_KraidShot_KraidsMouthIsOpen 
    STA.W $0FA8 
    LDA.W #InstList_Kraid_Roar_1 
    STA.W $0FAA 
    LDA.W InstList_Kraid_Roar_0 
...
Function_Kraid_KraidShot_KraidsMouthIsOpen:
    ...
    LDA.W #$0040 
    STA.W $0FB2 
    LDA.W #Function_Kraid_KraidShot_InitializeEyeGlowing 
    STA.L $7E7800 
    LDA.W #$0002 
    STA.L $7E7802 
...
KraidsMouth_vs_Projectile_CollisionHandling:
    ...
    PHX 
    LDA.W $0FA8 
    CMP.W #KraidDeath_SinkThroughFloor 
    BMI .notDying 
    PLX 
    RTS 
...
.dead:
    LDA.W $0FA8 
    CMP.W #KraidDeath_Initialize 
    BPL .return 
    LDA.W #KraidDeath_Initialize 
    STA.W $0FA8 
    LDA.W #$0000 
    STA.L $7E780A 
    LDA.W $0F86 
...
.loopSetIntangible:
    ...
    LDA.W $0FAA 
    CMP.W #InstList_Kraid_DyingRoar_0 
    BPL .return 
    CLC 
    ADC.W #$003C 
    STA.W $0FAA 
...
.loop:
  ...
  + LDA.W HitboxDefinitionTable_KraidBody_left,X 
    CLC 
    ADC.W $0F7A 
    SEC 
    SBC.B $12 
...
.loopBody:
  ...
  + LDA.W HitboxDefinitionTable_KraidBody_left,Y 
    CLC 
    ADC.W $0F7A 
    SEC 
    SBC.B $12 
...
.loopPalette:
    LDA.W Palette_Kraid_BG_HurtFlash,Y 
    STA.L $7EC0E0,X 
    LDA.W Palette_Kraid_Sprite_HurtFlash,Y 
    STA.L $7EC1E0,X 
    INY #2
...
Function_Kraid_KraidShot_InitializeEyeGlowing:
    LDA.W #Function_Kraid_KraidShot_KraidsMouthIsOpen 
    STA.W $0FA8 
    LDA.W #Function_Kraid_KraidShot_GlowEye 
    STA.W $0FA8 
    LDA.W #InstList_Kraid_EyeGlowing_1 
    STA.W $0FAA 
    LDA.W InstList_Kraid_EyeGlowing_0 
    STA.W $0FAC ; fallthrough to Function_Kraid_KraidShot_GlowEye
...
.loop:
  ...
  + STA.B $14 
    ...
    CPY.W #$0006 
    BMI .return 
    LDA.W #Function_Kraid_KraidShot_UnglowEye 
    STA.W $0FA8 
...
Function_KraidLint_ProduceLint:
    ...
    CMP.W #$0020 
    BMI .return 
    LDA.W #Function_KraidLint_ChargeLint 
    STA.W $0FA8,X 
    LDA.W #$001E 
    STA.W $0FB2,X 
...
Function_KraidLint_FireLint:
    LDA.W $0F7C,X 
    SEC 
    SBC.W KraidLint_XSubSpeed 
    STA.W $0F7C,X 
    LDA.W $0F7A,X 
    SBC.W KraidLint_XSpeed 
    STA.W $0F7A,X 
    CMP.W #$0038 
...
Function_KraidNail_HorizontallyAlignEnemyToKraid:
    ...
    SEC 
    SBC.W $0F82,X 
    STA.W $0F7A,X ; fallthrough to Function_Kraid_HandleFunctionTimer
...
SetKraidWalkingBackwards:
    ...
    TYA 
    STA.L $7E7940 
    LDA.W #Function_KraidFoot_Phase2_WalkingBackward 
    STA.W $10E8 
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #InstList_KraidFoot_KraidIsBig_WalkingBackwards_0 
...
SetKraidWalkingForwards:
    ...
    TYA 
    STA.L $7E7940 
    LDA.W #Function_KraidFoot_Phase2_WalkingForward 
    STA.W $10E8 
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #InstList_KraidFoot_KraidIsBig_WalkingForward_0 
    STA.W $10D2 
    RTS 
...
.walking:
    LDA.W $10D2 
    CMP.W #InstList_KraidFoot_KraidIsBig_WalkingBackwards_1 
    BMI .return 
    LDA.W #Function_KraidFoot_Phase2_Thinking 
    STA.W $10E8 
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #InstList_KraidFoot_KraidIsBig_Neutral 
...
.walking:
    ...
    LDA.W #$00B4 
    STA.W $10F2 
    LDA.W #Function_KraidFoot_Phase2Setup_InitializePhase2 
    STA.L $7E7940 
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #InstList_KraidFoot_KraidIsBig_Neutral 
...
Function_KraidFoot_Phase2_WalkingForward:
    ...
    STA.W $0F7A 
    LDA.W $10D2 
    CMP.W #InstList_KraidFoot_KraidIsBig_WalkingForward_1 
    BNE .return 
    LDA.W #Function_KraidFoot_Phase2_Thinking 
    STA.W $10E8 
    LDA.W #$0001 
...
.lunge:
    LDA.W #$0001 
    STA.W $10D4 
    LDA.W #InstList_KraidFoot_LungeForward_0 
    STA.W $10D2 
    RTL 
...
InitAI_KraidNail_Common:
    ...
    LDA.W #$7FFF 
    STA.W $0F94,X 
    LDA.W #InstList_KraidNail 
    STA.W $0F92,X 
    LDA.W InstList_KraidNail+2 
    STA.W $0F8E,X 
    LDA.W #Function_KraidNail_Initialize 
    STA.L $7E7800,X 
    LDA.W #Function_Kraid_HandleFunctionTimer 
...
.notKraidNailBad:
    ...
    LDA.W #$0000 
    STA.W $0FB0,X 
    LDA.W #Function_KraidNail_WaitUntilTopLintXPosition100Plus 
    STA.W $0FA8,X 
    LDA.W #Function_KraidNail_Fire 
    STA.L $7E7800,X 
    LDA.W $0F86,X 
...
Function_KraidFoot_Phase1_PrepareToLungeForward:
    JSR.W HandleKraidPhase1 
    LDA.W $0FD2 
    CMP.W #InstList_KraidArm_Normal_1 
    BMI .return 
    ...
    LDA.W #InstList_KraidFoot_LungeForward_0 
    STA.W $10D2 
    LDA.W #Function_KraidFoot_Phase1_LungeForward 
    STA.W $10E8 
    LDA.W #$0000 
    STA.W $10F2 
...
.done:
    LDA.W #Function_KraidFoot_Phase1_RetreatFromLunge 
    STA.L $7E7940 
    LDA.W #Function_KraidFoot_StartRetreat 
    STA.W $10E8 
    LDA.W #$0001 
    STA.W $10F2 
    LDA.W #$0001 
...
.done:
    LDA.W #InstList_KraidArm_Normal_0 
    STA.W $0FD2 
    LDA.W #$0001 
    STA.W $0FD4 
    LDA.W #$0001 
    ...
    LDA.W #InstList_KraidFoot_KraidIsBig_Neutral 
    STA.W $10D2 
    LDA.W #Function_KraidFoot_Phase1_Thinking 
    STA.W $10E8 
    LDA.W #$012C 
    STA.W $10F2 
    LDA.W #Function_KraidFoot_Phase1_PrepareToLungeForward 
    STA.L $7E7940 
...
.getBig:
    LDA.W #Function_Kraid_ProcessKraidInstruction 
    STA.W $0FA8 
    LDA.W #$00B4 
    STA.W $0FB2 
    LDA.W #Function_Kraid_GetBig_ReleaseCamera 
    STA.L $7E7800 
    LDA.W $0FAA 
    TAX 
    LDA.W $0002,X 
  ...
  + TYA 
    CLC 
    ADC.W #InstList_Kraid_Roar_1 
    STA.W $0FAA 
    LDA.W InstList_Kraid_Roar_0,Y 
    STA.W $0FAC 
    LDA.W #$0004 
    STA.W $183E 
    LDA.W #$0154 
...
Function_Kraid_GetBig_ReleaseCamera:
    LDA.W #Function_Kraid_KraidGetsBig_BreakCeilingIntoPlatforms 
    STA.W $0FA8 
    LDA.W #$0202 
    STA.L $7ECD20 
    LDA.W #$0101 
...
UnpauseHook_KraidIsAlive:
    ...
    dw $0400 
    LDA.B #$02 
    STA.W $420B ; fallthrough to TransferKraidTopHalfTilemapToVRAM
...
.loop:
    ...
    BEQ .return 
    LDA.W $0F7E 
    CMP.W ShrinkingKraidTable_KraidYPosition,Y 
    BMI .return 
    LDA.W #$0040 
    STA.B $D0,X 
    LDA.W #$2FC0 
    ...
    XBA 
    CLC 
    ADC.W ShrinkingKraidTable_VRAMBG2TilemapOffset,Y 
    STA.B $D5,X 
    TXA 
    CLC 
    ADC.W #$0007 
...
.loopPalette7:
    ...
    LDA.W #$0001 
    STA.W $0FD4 
    LDA.W #KraidDeath_FadeOutBackground 
    STA.W $0FA8 
    LDA.W #InstList_Kraid_Dying_1 
    STA.W $0FAA 
    LDA.W InstList_Kraid_Dying_0 
    STA.W $0FAC 
    LDX.W $0E54 
    PHX 
    LDA.W $1106 
...
KraidDeath_FadeOutBackground:
    ...
    JSL.L Advance_GradualColorChange_ofBGPalette6 
    BCC .return 
    LDA.W #KraidDeath_UpdateBG2TilemapTopHalf 
    STA.W $0FA8 
    LDA.W #$0001 
    STA.L $7E782C 
    STA.L $7E782A 
...
KraidDeath_UpdateBG2TilemapTopHalf:
    JSR.W KraidInstListHandling 
    LDA.W #KraidDeath_UpdateBG2TilemapBottomHalf 
    STA.W $0FA8 
    LDA.W #Function_KraidNail_HorizontallyAlignEnemyToKraid 
    STA.W $1028 
    STA.W $1068 
...
KraidDeath_UpdateBG2TilemapBottomHalf:
    ...
    STA.W $0606 
    REP #$20 
    LDA.W #UnpauseHook_KraidIsSinking 
    STA.W $0604 
    LDA.W #KraidDeath_SinkThroughFloor 
    STA.W $0FA8 
    LDA.W #$002B 
    STA.L $7E9000 
    LDA.W $0F86 
...
.loop:
    ...
    ADC.W #$0007 
    STA.W $0330 
    LDA.W #Function_Kraid_FadeInRegularBG_ClearBG2TilemapBottomHalf 
    STA.W $0FA8 
    RTL 
...
Function_Kraid_FadeInRegularBG_ClearBG2TilemapBottomHalf:
    ...
    ADC.W #$0007 
    STA.W $0330 
    LDA.W #Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_0 
    STA.W $0FA8 
    RTL 


Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_0:
    LDA.W #UnpauseHook_KraidIsDead 
    STA.W $0604 
    LDA.W #Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_1 
    STA.W $0FA8 
    LDX.W $0330 
    LDA.W #$0400 
    STA.B $D0,X 
    LDA.W #Tiles_Standard_BG3 
    STA.B $D2,X 
    LDA.W #Tiles_Standard_BG3>>16 
    STA.B $D4,X 
    LDA.W #$4000 
    STA.B $D5,X 
    TXA 
...
Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_1:
    LDA.W #Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_2 
    STA.W $0FA8 
    LDX.W $0330 
    LDA.W #$0400 
    STA.B $D0,X 
    LDA.W #Tiles_Standard_BG3+$400 
    STA.B $D2,X 
    LDA.W #Tiles_Standard_BG3>>16 
    STA.B $D4,X 
    LDA.W #$4200 
...
Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_2:
    LDA.W #Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_3 
    STA.W $0FA8 
    LDX.W $0330 
    LDA.W #$0400 
    STA.B $D0,X 
    LDA.W #Tiles_Standard_BG3+$800 
    STA.B $D2,X 
    LDA.W #Tiles_Standard_BG3>>16 
    STA.B $D4,X 
    LDA.W #$4400 
...
Function_Kraid_FadeInRegularBG_LoadStandardBG3Tiles_3:
    LDA.W #Function_Kraid_FadeInRegularBG_FadeInBGPalette6 
    STA.W $0FA8 
    LDX.W $0330 
    LDA.W #$0400 
    STA.B $D0,X 
    LDA.W #Tiles_Standard_BG3+$C00 
    STA.B $D2,X 
    LDA.W #Tiles_Standard_BG3>>16 
    STA.B $D4,X 
    LDA.W #$4600 
...
Function_Kraid_FadeInRegularBG_FadeInBGPalette6:
    ...
    ORA.W #$0001 
    STA.L $7ED828,X 
    LDA.W #Function_Kraid_FadeInRegularBG_SetToDead_KraidWasAlive 
    STA.W $0FA8 
...
.KraidIsDead:
    LDA.W #Function_Kraid_FadeInRegularBG_SetToDead_KraidWasDead 
    STA.W $0FA8 
    RTL 
...
Function_Kraid_RaiseThruFloor_LoadTilemapTopHalf:
    JSR.W RestrictSamusXPositionToFirstScreen 
    LDA.W #Function_Kraid_RaiseThruFloor_LoadTilemapBottomHalf_ShakeScn 
    STA.W $0FA8 ; fallthrough to UpdateBG2TilemapTopHalf
...
Function_Kraid_RaiseThruFloor_LoadTilemapBottomHalf_ShakeScn:
    JSR.W RestrictSamusXPositionToFirstScreen 
    LDA.W #Function_Kraid_RaiseThruFloor_SpawnRNGEarthquakeProjEvery10f 
    STA.W $0FA8 
    LDA.W #$0078 
    STA.W $0FB2 
    LDA.W #$01F0 
...
Function_Kraid_RaiseThruFloor_SpawnRNGEarthquakeProjEvery10f:
    ...
    STA.W $0FB2 
    BNE .timerNotExpired 
    LDA.W #Function_Kraid_RaiseThruFloor_SpawnRNGEarthquakeProjEvery8f 
    STA.W $0FA8 
    LDA.W #$0060 
    STA.W $0FB2 
    RTL 
...
Function_Kraid_RaiseThruFloor_SpawnRNGEarthquakeProjEvery8f:
    ...
    STA.W $0FB2 
    BNE .timerNotExpired 
    LDA.W #Function_Kraid_RaiseThruFloor_RaiseKraid 
    STA.W $0FA8 
    LDA.W #$0120 
    STA.W $0FB2 
    RTL 
...
InitAI_Phantoon_Eye_Tentacles_Mouth:
    LDX.W $0E54 
    LDA.W #Spritemap_CommonA7_Nothing 
    STA.W $0F8E,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    STZ.W $0F90,X 
    ...
    STA.W $0F92,X 
    LDA.W #Function_Phantoon_FightIntro_SpawnCircleOfFlames 
    STA.W $0FB2,X 
    STZ.W $1074 
    LDA.W #$FFFF 
    STA.W $106C 
...
.nonZeroTimer:
  ...
  + LDA.W #$0001 
    STA.W $1054,X 
    LDA.W #InstList_Phantoon_Mouth_SpawnFlame 
    STA.W $1052,X 
...
SetupEyeOpenPhantoonState:
    ...
    STA.W $0F94 
    STA.W $0FD4 
    LDA.W #InstList_Phantoon_Body_EyeHitboxOnly 
    STA.W $0F92 
    LDA.W #InstList_Phantoon_Eyeball_Centered 
    STA.W $0FD2 
    LDA.W $0F86 
    AND.W #$FBFF 
    STA.W $0F86 
    ...
    ASL A 
    TAY 
    LDA.W Phantoon_Figure8_VulnerableWindowTimers,Y 
    STA.W $0FB0 
    LDA.W #Function_Phantoon_Figure8_VulnerableWindow 
    STA.W $0FB2 
    RTS 
...
PickNewPhantoonPattern:
    ...
    ASL A 
    TAY 
    LDA.W Phantoon_EyeClosedTimers,Y 
    STA.W $0FE8 
    LDA.W $05B6 
    BIT.W #$0001 
    BNE .reversed 
...
.merge:
    LDA.W $0FB6 
    BNE + 
    LDA.W #Function_Phantoon_Figure8_Moving 
    STA.W $0FB2 
    RTS 


  + STZ.W $0FF2 
    LDA.W #Function_Phantoon_FlameRain_InitialFlameRain 
    STA.W $0FB2 
    RTS 
...
.stage0:
    LDA.W $0FAA 
    CLC 
    ADC.W Phantoon_Figure8_SubAcceleration_SlowStage 
    STA.W $0FAA 
    LDA.W $0FAC 
    ADC.W Phantoon_Figure8_Acceleration_SlowStage 
    STA.W $0FAC 
...
.stage1:
    LDA.W $0FAA 
    CLC 
    ADC.W Phantoon_Figure8_SubAcceleration_FastStages 
    STA.W $0FAA 
    LDA.W $0FAC 
    ADC.W Phantoon_Figure8_Acceleration_FastStages 
    STA.W $0FAC 
    CMP.W Phantoon_Figure8_SpeedCaps_Stage1Max 
    BMI ..return 
    LDA.W Phantoon_Figure8_SpeedCaps_Stage1Max 
    STA.W $0FAC 
    STZ.W $0FAA 
    INC.W $0FAE 
...
.stage2:
    LDA.W $0FAA 
    SEC 
    SBC.W Phantoon_Figure8_SubAcceleration_FastStages 
    STA.W $0FAA 
    LDA.W $0FAC 
    SBC.W Phantoon_Figure8_Acceleration_FastStages 
    STA.W $0FAC 
...
.stage0:
    LDA.W $0FAA 
    SEC 
    SBC.W Phantoon_ReverseFigure8_SubAcceleration_SlowStage 
    STA.W $0FAA 
    LDA.W $0FAC 
    SBC.W Phantoon_ReverseFigure8_Acceleration_SlowStage 
    STA.W $0FAC 
...
.stage1:
    LDA.W $0FAA 
    SEC 
    SBC.W Phantoon_ReverseFigure8_SubAcceleration_FastStages 
    STA.W $0FAA 
    LDA.W $0FAC 
    SBC.W Phantoon_ReverseFigure8_Acceleration_FastStages 
    STA.W $0FAC 
...
.stage2:
    LDA.W $0FAA 
    CLC 
    ADC.W Phantoon_ReverseFigure8_SubAcceleration_FastStages 
    STA.W $0FAA 
    LDA.W $0FAC 
    ADC.W Phantoon_ReverseFigure8_Acceleration_FastStages 
    STA.W $0FAC 
    CMP.W Phantoon_ReverseFigure8_SpeedCaps_Stage2Min 
    BMI ..return 
    LDA.W Phantoon_ReverseFigure8_SpeedCaps_Stage2Min 
    STA.W $0FAC 
    STZ.W $0FAA 
    STZ.W $0FAE 
...
StartPhantoonSwoopingPattern:
    ...
    STA.W $102E 
    STZ.W $1030 
    LDA.W #Function_Phantoon_Swooping_Opaque 
    STA.W $0FB2,X 
    LDA.W #$0168 
    STA.W $0FB0,X 
    RTS 
...
StartPhantoonDeathSequence:
    ...
    BEQ .swooping 
    LDA.W #Function_Phantoon_DeathSequence_FadingInAndOut 
    STA.W $0FB2,X 
    BRA + 


.swooping:
    LDA.W #Function_Phantoon_Swooping_FatalDamage 
    STA.W $0FB2,X 
...
.timerExpired:
    ...
    STZ.W $0FA8 
    STZ.W $102A,X 
    LDA.W #Function_Phantoon_FightIntro_SpinCircleOfFlames 
    STA.W $0FB2,X 
    LDA.W #$001E 
    STA.W $0FB0,X 
    JSL.L Spawn_Hardcoded_PLM 
...
.timerExpired:
    ...
    LDA.W #$0001 
    STA.W $0FAA,X 
    LDA.W #Function_Phantoon_FightIntro_StartWavyFadeIn 
    STA.W $0FB2,X 
...
.timerExpired:
    ...
    ORA.W #$4000 
    STA.W $1988 
    LDA.W #Function_Phantoon_FightIntro_WavyFadeIn 
    STA.W $0FB2,X 
    LDA.W #$8001 
    STA.W $1074 
    LDA.W #$0078 
    STA.W $0FB0,X 
    LDA.W WavyPhantoonConstants_phaseDelta 
    STA.B $16 
    LDA.W #$0002 
    JSL.L Spawn_WavyPhantoon_HDMAObject 
    LDA.W WavyPhantoonConstants_Intro_maxAmplitude 
    STA.W $106E 
    STZ.W $0FF2 
    LDA.W #$0005 
    JSL.L QueueMusicDataOrTrack_8FrameDelay 
...
Function_Phantoon_FightIntro_WavyFadeIn:
    ...
    LDA.W WavyPhantoonConstants_Intro_amplitudeDelta 
    STA.B $12 
    LDA.W WavyPhantoonConstants_Intro_maxAmplitude 
    STA.B $14 
...
.timerExpired:
    ...
    LDA.W #$0001 
    STA.W $0FD4 
    LDA.W #InstList_Phantoon_Eye_Open 
    STA.W $0FD2 
    STZ.W $0FB6 
...
.timerExpired:
    ...
    LDA.W #$003C 
    STA.W $0FB0,X 
    LDA.W #Function_Phantoon_Figure8_SwoopingTriggered 
    STA.W $0FB2,X 
    BRA .waiting 
...
.swoopingNotTriggered:
    ...
    STA.W $0F94 
    STA.W $0FD4 
    LDA.W #InstList_Phantoon_Body_Invulnerable 
    STA.W $0F92 
    LDA.W #InstList_Phantoon_Eye_Close_PickNewPattern 
    STA.W $0FD2 
    LDA.W $0F86 
    ORA.W #$0400 
    STA.W $0F86 
...
Function_Phantoon_Figure8_SwoopingTriggered:
    ...
    LDA.W #$0001 
    STA.W $0F94 
    LDA.W #InstList_Phantoon_Body_FullHitbox 
    STA.W $0F92 
    RTS 
...
.timerExpired:
    LDA.W #Function_Phantoon_Swooping_FadeOut 
    STA.W $0FB2,X 
    LDA.W $1988 
    ORA.W #$4000 
    STA.W $1988 
    ...
    LDA.W #InstList_Phantoon_Body_Invulnerable 
    STA.W $0F92 
    LDA.W #InstList_Phantoon_Eye_Close 
    STA.W $0FD2 
    LDA.W $0F86 
    ORA.W #$0400 
    STA.W $0F86 
...
Function_Phantoon_Swooping_FadeOut:
    ...
    LDA.W $0FF2 
    BEQ .return 
    LDA.W #Function_Phantoon_HidingBeforeFigure8_Hiding 
    STA.W $0FB2,X 
    LDA.W #$0078 
    STA.W $0FB0,X 
...
.timerExpired:
    LDA.W #Function_Phantoon_HidingBeforeFigure8_PlacePhantoon 
    STA.W $0FB2,X 
...
.leftSidePattern:
  ...
  + STZ.W $0FEC 
    ...
    LDA.W #Function_Phantoon_HidingBeforeFigure8_FadingIn 
    STA.W $0FB2,X 
    STZ.W $0FF2 
    RTS 
...
Function_Phantoon_FlameRain_ShowPhantoon:
    ...
    LDA.W #InstList_Phantoon_Eyeball_Centered 
    STA.W $0FD2 
    LDA.W #Function_Phantoon_FlameRain_MakePhantoonVulnerable 
    STA.W $0FB2,X 
    RTS 
...
Function_Phantoon_FlameRain_MakePhantoonVulnerable:
    ...
    AND.W #$FBFF 
    STA.W $0F86 
    LDA.W #Function_Phantoon_FlameRain_VulnerableWindow 
    STA.W $0FB2,X 
    LDA.W #$005A 
    STA.W $0FB0 
...
.endVulnerableWindow:
    LDA.W #Function_Phantoon_FlameRain_FadingOut 
    STA.W $0FB2,X 
    STZ.W $0FF2 
    LDA.W #$0001 
    STA.W $0F94 
...
.fadeComplete:
    LDA.W #Function_Phantoon_FlameRain_SubsequentFlameRain 
    STA.W $0FB2,X 
    JSL.L GenerateRandomNumber 
    AND.W #$0007 
    ASL A 
    TAY 
    LDA.W Phantoon_FlameRain_HidingTimers,Y 
    STA.W $0FB0,X 
    RTS 
...
.timerExpired:
    ...
    STA.W $0FA8 
    LDA.W Phantoon_FlameRain_PositionTable_XPosition,Y 
    STA.W $0F7A 
    LDA.W Phantoon_FlameRain_PositionTable_YPosition,Y 
    STA.W $0F7E 
    STZ.W $0FEC 
    LDA.W #Function_Phantoon_FlameRain_ShowPhantoon 
    STA.W $0FB2,X 
    PLA 
...
Function_Phantoon_Enraged_FadingOutBeforeRage:
    ...
    LDA.W $0FF2 
    BEQ .return 
    LDA.W #Function_Phantoon_Enraged_Hiding 
    STA.W $0FB2,X 
    LDA.W #$0078 
    STA.W $0FB0,X 
...
.timerExpired:
    LDA.W #Function_Phantoon_Enraged_FadingIn 
    STA.W $0FB2,X 
    LDA.W #$0080 
    STA.W $0F7A 
    LDA.W #$0020 
...
Function_Phantoon_Enraged_FadingIn:
    ...
    LDA.W $0FF2 
    BEQ .return 
    LDA.W #Function_Phantoon_Enraged_Rage 
    STA.W $0FB2 
    LDA.W #$0004 
    STA.W $0FB0,X 
    STZ.W $0FF2 
...
.doneRaging:
    ...
    STA.W $0FD2 
    STZ.W $0FF2 
    LDA.W #Function_Phantoon_Enraged_FadingOutAfterRage 
    STA.W $0FB2,X 
...
.fadeComplete:
    ...
    CMP.W #$000A 
    BMI .return 
    LDA.W #Function_Phantoon_DeathSequence_Exploding 
    STA.W $0FB2,X 
    LDA.W #$000F 
    STA.W $0FB0,X 
    STZ.W $1032 
...
.PhantoonExplosion:
  ...
  + PLY 
    ...
    CMP.W #$0003 
    BMI .return 
    LDA.W #Function_Phantoon_DeathSequence_SetupWavyMosaicPhantoon 
    STA.W $0FB2,X 
...
Function_Phantoon_DeathSequence_SetupWavyMosaicPhantoon:
    ...
    JSL.L Spawn_WavyPhantoon_HDMAObject 
    STZ.W $106E 
    LDA.W #Function_Phantoon_DeathSequence_WavyMosaicPhantoon 
    STA.W $0FB2,X 
    LDA.W #$0002 
    STA.W $0FEC 
    LDA.W $0F86 
...
Function_Phantoon_DeathSequence_WavyMosaicPhantoon:
    LDA.W WavyPhantoonConstants_Dying_amplitudeDelta 
    STA.B $12 
    LDA.W WavyPhantoonConstants_Dying_maxAmplitude 
    STA.B $14 
    JSR.W GrowShrinkPhantoonWaveAmplitude 
    LDA.W $0FEC 
    CMP.W #$FFFF 
...
.doneMosaic:
    ...
    LDA.W $0FF2 
    BEQ .return 
    LDA.W #Function_Phantoon_DeathSequence_ClearGraphics 
    STA.W $0FB2,X 
...
Function_Phantoon_DeathSequence_ClearGraphics:
    ...
    LDA.W #$FFFF 
    STA.W $1074 
    LDA.W #Function_Phantoon_DeathSequence_ActivateWreckedShip 
    STA.W $0FB2,X 
    LDA.W #$003C 
    STA.W $0FB0,X 
    STZ.W $0FF2 
...
EnemyShot_Phantoon:
    PHB 
    LDA.W $0FB2 
    CMP.W #Function_Phantoon_DeathSequence_FadingInAndOut 
    BMI .notDead 
    PLB 
    RTL 
...
.vulnerableWindow:
  ...
  + LDA.W $102A,X 
    ...
    AND.W #$0007 
    TAY 
    LDA.W Phantoon_Unknown0FEAValues_A7CDA5,Y 
    AND.W #$00FF 
    STA.W $0FEA 
    TYA 
    STA.W $1076 
...
.enraged:
    LDA.W #Function_Phantoon_Enraged_FadingOutBeforeRage 
    STA.W $0FB2,X 
...
InitAI_Etecoon:
    ...
    STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #InstList_Etecoon_Initial 
    STA.W $0F92,X 
    LDA.W #Function_Etecoon_Initial 
    STA.W $0FB2,X 
    LDA.W #$FFFF 
    STA.W $0FB0,X 
    RTL 
...
.flex:
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #InstList_Etecoon_Flexing_0 
    STA.W $0F92,X 
    LDA.W #$0100 
    STA.W $0FB0,X 
    RTL 
...
.hop:
    LDA.W #InstList_Etecoon_Hopping_FacingLeft 
    STA.W $0F92,X 
    LDA.W #Function_Etecoon_StartHop_BottomOfRoom 
    STA.W $0FB2,X 
    LDA.W #$000B 
    STA.W $0FB0,X 
...
.timerExpired:
    LDA.W EtecoonConstants_initialYVelocityOfHopsAndFailedJumps 
    STA.W $0FA8,X 
    ...
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #Function_Etecoon_Hopping_BottomOfRoom 
    STA.W $0FB2,X 
    LDA.W $0AF6 
    CMP.W #$0100 
    BMI .return 
...
.collision:
    ...
    LDA.W #$0003 
    STA.W $0F94,X 
    LDA.W #InstList_Etecoon_HitCeiling 
    STA.W $0F92,X 
    RTL 
...
.notRising:
    ...
    CMP.W #$0005 
    BPL .left 
    LDA.W #InstList_Etecoon_LookRightAtSamusAndRunLeft 
    STA.W $0F92,X 
    STZ.W $0FB4,X 
    BRA + 
...
.left:
    LDA.W #InstList_Etecoon_LookLeftAtSamusAndRunRight 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0FB4,X 
  ...
  + LDA.W #$0020 
    ...
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #Function_Etecoon_LookAtSamus 
    STA.W $0FB2,X 
    RTL 
...
.timerExpired:
    ...
    STA.W $0FAC,X 
    LDA.W EtecoonConstants_XVelocityRight+2 
    STA.W $0FAE,X 
    LDA.W #Function_Etecoon_RunningRight 
    STA.W $0FB2,X 
    BRA + 


.left:
    LDA.W EtecoonConstants_XVelocityLeft 
    STA.W $0FAC,X 
    LDA.W EtecoonConstants_XVelocityLeft+2 
    STA.W $0FAE,X 
    LDA.W #Function_Etecoon_RunningLeft 
    STA.W $0FB2,X 
...
Function_Etecoon_RunningLeft:
    ...
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #InstList_Etecoon_RunningRight 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0FB4,X 
...
Function_Etecoon_RunningRight:
    ...
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #InstList_Etecoon_JumpingRight 
    STA.W $0F92,X 
    LDA.W #Function_Etecoon_Jumping 
    STA.W $0FB2,X 
    RTL 
...
Function_Etecoon_Jumping:
    ...
    LDA.W $0FB4,X 
    BNE .leftEligible 
    LDA.W #InstList_Etecoon_WallJumpRightEligible 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0FB4,X 
    BRA + 
...
.leftEligible:
    LDA.W #InstList_Etecoon_WallJumpLeftEligible 
    STA.W $0F92,X 
    STZ.W $0FB4,X 

  + LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #Function_Etecoon_WallJump 
    STA.W $0FB2,X 
    LDA.W #$0008 
    STA.W $0FB0,X 
    LDA.W $0AF6 
...
.noWall:
    ...
    LDA.W $0FB4,X 
    BNE .hopLeft 
    LDA.W #InstList_Etecoon_Hopping_FacingRight 
    STA.W $0F92,X 
    BRA + 
...
.hopLeft:
  ...
  + LDA.W #$0001 
    ...
    LDA.W #$000B 
    STA.W $0FB0,X 
    LDA.W #Function_Etecoon_LandedFromJump 
    STA.W $0FB2,X 
    LDA.W EtecoonConstants_initialYVelocityOfHopsAndFailedJumps 
    STA.W $0FA8,X 
    LDA.W EtecoonConstants_initialYVelocityOfHopsAndFailedJumps+2 
...
.timerExpired:
    LDA.W $0FB4,X 
    BEQ .left 
    LDA.W #InstList_Etecoon_WallJumpRight 
    STA.W $0F92,X 
    LDA.W EtecoonConstants_XVelocityRight 
    STA.W $0FAC,X 
    LDA.W EtecoonConstants_XVelocityRight+2 
...
.left:
    LDA.W #InstList_Etecoon_WallJump_0 
    STA.W $0F92,X 
    LDA.W EtecoonConstants_XVelocityLeft 
    STA.W $0FAC,X 
    LDA.W EtecoonConstants_XVelocityLeft+2 
...
RunToLeftRunUpPoint:
    TYX 
    LDA.W #Function_Etecoon_RunToLeftRunUpPoint 
    STA.W $0FB2,X 
    LDA.W #InstList_Etecoon_RunningLeft 
    STA.W $0F92,X 
    LDA.W EtecoonConstants_XVelocityLeft 
    STA.W $0FAC,X 
    LDA.W EtecoonConstants_XVelocityLeft+2 
...
RunToRightRunUpPoint:
    TYX 
    LDA.W #Function_Etecoon_RunToRightRunUpPoint 
    STA.W $0FB2,X 
    LDA.W #InstList_Etecoon_RunningRight 
    STA.W $0F92,X 
    LDA.W EtecoonConstants_XVelocityRight 
...
Function_Etecoon_RunToLeftRunUpPoint:
    ...
    LDA.W #$000B 
    STA.W $0FB0,X 
    LDA.W #Function_Etecoon_StartHop_TopOfRoom 
    STA.W $0FB2,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #InstList_Etecoon_Hopping_FacingLeft 
...
Function_Etecoon_RunningForSuccessfulMorphTunnelJump:
    ...
    CMP.W #$0258 
    BMI .return 
    LDA.W #Function_Etecoon_SuccessfulMorphTunnelJump 
    STA.W $0FB2,X 
    LDA.W EtecoonConstants_initialYVelocityOfSuccessfulJump 
    STA.W $0FA8,X 
    LDA.W EtecoonConstants_initialYVelocityOfSuccessfulJump+2 
    STA.W $0FAA,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #InstList_Etecoon_JumpingRight 
...
Function_Etecoon_SuccessfulMorphTunnelJump:
    ...
    LDA.W #InstList_Etecoon_RunningRight 
    STA.W $0F92,X 
    LDA.W #Function_Etecoon_RunningThroughMorphTunnel 
    STA.W $0FB2,X 
...
Function_Etecoon_RunningThroughMorphTunnel:
    ...
    LDA.W #InstList_Etecoon_JumpingRight 
    STA.W $0F92,X 
    LDA.W #Function_Etecoon_FallingFromMorphTunnelLedge 
    STA.W $0FB2,X 
    LDA.W #$FFFF 
    STA.W $0FA8,X 
    LDA.W EtecoonConstants_initialYVelocityOfSuccessfulJump+2 
...
.successEtecoon:
    ...
    CMP.W #$0340 
    BPL .hop 
    LDA.W #Function_Etecoon_HopUntilSamusIsNear 
    STA.W $0FB2,X 
...
.timerExpired:
    ...
    BIT.W #$0002 
    BNE .notFailedJump 
    LDA.W #Function_Etecoon_RunningForFailedMorphTunnelJump 
    STA.W $0FB2,X 
    LDA.W #InstList_Etecoon_RunningRight 
    STA.W $0F92,X 
    LDA.W EtecoonConstants_XVelocityRight 
...
.timerExpired:
    ...
    LDA.W #InstList_Etecoon_RunningRight 
    STA.W $0F92,X 
    LDA.W #Function_Etecoon_RunningForSuccessfulMorphTunnelJump 
    STA.W $0FB2,X 
    BRA .skipSFX 
...
Function_Etecoon_RunningForFailedMorphTunnelJump:
    ...
    CMP.W #$0258 
    BMI .return 
    LDA.W #Function_Etecoon_FailedTunnelJump 
    STA.W $0FB2,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #InstList_Etecoon_JumpingRight 
...
InitAI_Dachora:
    ...
    BMI .echo 
    BEQ .left 
    LDA.W #InstList_Dachora_Idling_FacingRight 
    STA.W $0F92,X 
    BRA + 


.left:
    LDA.W #InstList_Dachora_Idling_FacingLeft 
    STA.W $0F92,X 

  + LDA.W #Function_Dachora_WaitForSamusToBeNear 
    STA.W $0FB2,X 
    RTL 
...
Function_Dachora_WaitForSamusToBeNear:
    ...
    LDA.W $0FB4,X 
    BEQ .left 
    LDA.W #InstList_Dachora_Blinking_FacingRight 
    STA.W $0F92,X 
    BRA + 


.left:
    LDA.W #InstList_Dachora_Blinking_FacingLeft 
    STA.W $0F92,X 

  + LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #Function_Dachora_StartRunning 
    STA.W $0FB2,X 
    LDA.W DachoraConstants_blinkingDuration 
    STA.W $0FA8,X 
    LDA.W #$001D 
    JSL.L QueueSound_Lib2_Max15 
...
Function_Dachora_StartRunning:
    ...
    LDA.W $0FB4,X 
    BEQ .left 
    LDA.W #InstList_Dachora_RunningRight 
    STA.W $0F92,X 
    LDA.W #Function_Dachora_RunningRight 
    STA.W $0FB2,X 
    BRA + 


.left:
    LDA.W #InstList_Dachora_RunningLeft 
    STA.W $0F92,X 
    LDA.W #Function_Dachora_RunningLeft 
    STA.W $0FB2,X 
...
.noWall:
  ...
  + LDA.W #InstList_Dachora_ChargeShinespark_FacingRight 
    STA.W $0F92,X 
    LDA.W #Function_Dachora_ActivateShinespark 
    STA.W $0FB2,X 
    LDA.W DachoraConstants_delayBeforeActivatingShinespark 
    STA.W $0FA8,X 
    LDA.W $0F7E,X 
    CLC 
    ADC.W #$0008 
...
AccelerateRunningDachora:
    LDA.W $0FA8,X 
    CMP.W DachoraConstants_maxXSpeed 
    BMI .noPaletteChange 
    LDA.W $0FB0,X 
    CMP.W #$0001 
    BNE .animTimer 
...
.noPaletteChange:
    ...
    BMI .increaseSpeed 
    LDA.W $0FAA,X 
    CMP.W DachoraConstants_maxXSpeed+2 
    BMI .increaseSpeed 
    LDA.W DachoraConstants_maxXSpeed 
    STA.W $0FA8,X 
    STA.B $14 
    LDA.W DachoraConstants_maxXSpeed+2 
    STA.W $0FAA,X 
    STA.B $12 
    BRA .return 
...
.increaseSpeed:
    LDA.W $0FAA,X 
    CLC 
    ADC.W DachoraConstants_XAcceleration+2 
    STA.W $0FAA,X 
    STA.B $12 
    LDA.W $0FA8,X 
    ADC.W DachoraConstants_XAcceleration 
    STA.W $0FA8,X 
    STA.B $14 
    CMP.W #$0004 
    BNE .checkMaxSpeed 
...
Function_Dachora_ActivateShinespark:
    ...
    LDA.W #$0001 
    STA.W $0F94,X 
    LDA.W #Function_Dachora_Shinesparking 
    STA.W $0FB2,X 
    STZ.W $0FE8,X 
    STZ.W $0FEE,X 
    STZ.W $102E,X 
...
.move:
    ...
    LDA.W $0FB4,X 
    BNE .right 
    LDA.W #InstList_Dachora_Falling_FacingRight 
    STA.W $0F92,X 
    LDA.W #$0001 
    STA.W $0FB4,X 
    BRA + 
...
.right:
    LDA.W #InstList_Dachora_Falling_FacingLeft 
    STA.W $0F92,X 
    STZ.W $0FB4,X 

  + LDA.W #Function_Dachora_Falling 
    STA.W $0FB2,X 
    LDA.W #$0001 
    STA.W $0F94,X 
    STZ.W $0FA8,X 
...
.timerExpired:
    LDA.W DachoraConstants_echoPositionUpdateInterval 
    STA.W $0FE8,X 
    LDA.W $0FEE,X 
    BNE .echo1 
    LDA.W $0F7A,X 
    ...
    LDA.W $0F7E,X 
    STA.W $0FBE,X 
    LDA.W DachoraConstants_echoLifetime 
    STA.W $0FEE,X 
    RTS 
