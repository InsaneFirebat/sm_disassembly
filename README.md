...
## Getting Started
 ...
 2. If you're on Linux, you'll need to build asar from source. Place it in the `tools` directory and name it `asar-standalone`. https://github.com/RPGHacker/asar
