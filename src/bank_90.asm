...
AnimateSamus_FX_Water:
  ...
  + LDA.W $197E 
    ...
    LDA.W SamusPhysicsConstants_AnimationDelayInWater 
    STA.W $0A9C 
    LDA.W $0AD2 
    CMP.W #$0001 
...
.periodicDamage:
    LDA.W $0A4E 
    CLC 
    ADC.W SamusPhysicsConstants_LavaSubDamagePerFrame 
    STA.W $0A4E 
    LDA.W $0A50 
    ADC.W SamusPhysicsConstants_LavaDamagePerFrame 
    STA.W $0A50 
...
AnimateSamus_FX_Acid:
  ...
  + LDA.W $0A4E 
    CLC 
    ADC.W SamusPhysicsConstants_AcidSubDamagePerFrame 
    STA.W $0A4E 
    LDA.W $0A50 
    ADC.W SamusPhysicsConstants_AcidDamagePerFrame 
    STA.W $0A50 

AnimateSamus_SubmergedInLavaAcid:
    LDA.W SamusPhysicsConstants_AnimationDelayInLavaAcid 
    STA.W $0A9C 
    LDA.W #$0002 
    STA.W $0AD2 
    LDA.B $14 
...
AnimDelay_7_SetDrainedSamusMovementHandler:
    LDA.W #SamusMovementHandler_SamusDrained_Falling 
    STA.W $0A58 
    LDA.W $0A96 
    INC A 
    STA.W $0A96 
...
Handle_NormalAnimationDelay:
    ...
    ASL A 
    TAX 
    LDA.L AnimationDelayTable_Running_SpeedBooster_pointers,X 
    STA.B $00 
    BRA .return 


.noSpeedBooster:
    LDA.L AnimationDelayTable_Running_NoSpeedBooster_pointer 
    STA.B $00 
...
Draw_Samus:
  ...
  + LDA.W $0A1C 
    ...
    TAX 
    PHX 
    LDA.L SamusSpritemapTableIndices_TopHalf,X 
    CLC 
    ADC.W $0A96 
    STA.W $0AC8 
    PHA 
    ...
    BCC .invisible 
    LDX.B $24 
    LDA.L SamusSpritemapTableIndices_BottomHalf,X 
    CLC 
    ADC.W $0A96 
    STA.W $0ACA 
    LDX.W $0B04 
...
.loop:
    ...
    BNE .next 
    PHX 
    LDA.W AtmosphericGraphics_AnimationTimers,X 
    CLC 
    ADC.B $12 
    TAX 
    LDA.W $0000,X 
...
AtmosphericEffects_1_2_FootstepSplashes:
    ...
    STA.W $0371,X 
    PLY 
    LDA.W AtmosphericGraphics_SpriteTileNumberAttributes,Y 
    CLC 
    ADC.B $12 
    TAY 
    LDA.W $0000,Y 
...
.merge:
    JSR.W MoveSamus_Horizontally 
    LDA.W SamusPhysicsConstants_MaximumDistanceFromWallForWallJump 
    STA.B $12 
    STZ.B $14 
...
Calculate_CameraXSpeed:
  ...
  + LDA.W $0B12 
    ...
    SBC.W $0AF6 
    CLC 
    ADC.W SamusPhysicsConstants_CameraXOffsetFromSamusWhenTurning 
    STA.W $0DA2 
    BRA .return 
...
.running:
    ...
    STA.W $0AD0 
    STZ.W $0ACE 
    LDA.L SpeedBoostTimerResetValues 
    STA.W $0B3E 
...
.hasMomentum:
    ...
    BMI .accelerating 
    LDA.W SamusPhysicsConstants_MaxXExtraRunSpeeds_SpeedBooster,X 
    STA.W $0B42 
    LDA.W SamusPhysicsConstants_MaxXExtraRunSubSpeeds_SpeedBooster,X 
    STA.W $0B44 
    BRA .done 
...
.noSpeedBooster:
  ...
  + LDA.W $0B42 
    ...
    BMI .accelerating 
    LDA.W SamusPhysicsConstants_MaxXExtraRunSpeeds_NoSpeedBooster_0,X 
    STA.W $0B42 
    LDA.W SamusPhysicsConstants_MaxXExtraRunSpeeds_NoSpeedBooster_1,X 
    STA.W $0B44 
    BRA .done 
...
.accelerating:
    LDA.W $0B44 
    CLC 
    ADC.W SamusPhysicsConstants_XSubAccelerations_DashHeld,X 
    STA.W $0B44 
    LDA.W $0B42 
    ADC.W SamusPhysicsConstants_XAccelerations_DashHeld,X 
    STA.W $0B42 
    BRA .done 
...
.hiJumpEquipped:
    LDA.W SamusPhysicsConstants_InitialYSubSpeeds_HiJumpJumping,X 
    STA.W $0B2C 
    LDA.W SamusPhysicsConstants_InitialYSpeeds_HiJumpJumping,X 
    STA.W $0B2E 
...
.merge:
    ...
    BIT.W #$0100 
    BNE .hiJumpEquipped 
    LDA.W SamusPhysicsConstants_InitialYSubSpeeds_WallJumping,X 
    STA.W $0B2C 
    LDA.W SamusPhysicsConstants_InitialYSpeeds_WallJumping,X 
    STA.W $0B2E 
    BRA + 


.hiJumpEquipped:
    LDA.W SamusPhysicsConstants_InitialYSubSpeeds_HiJumpWallJumping,X 
    STA.W $0B2C 
    LDA.W SamusPhysicsConstants_InitialYSpeeds_HiJumpWallJumping,X 
    STA.W $0B2E 
...
.merge:
    LDA.W SamusPhysicsConstants_InitialYSubSpeeds_Knockback,X 
    STA.W $0B2C 
    LDA.W SamusPhysicsConstants_InitialYSpeeds_Knockback,X 
    STA.W $0B2E 
    STZ.W $0A9E 
    STZ.W $0AA0 
    LDA.W #$0001 
...
.merge:
    LDA.W SamusPhysicsConstants_InitialYSubSpeeds_BombJump,X 
    STA.W $0B2C 
    LDA.W SamusPhysicsConstants_InitialYSpeeds_BombJump,X 
    STA.W $0B2E 
    STZ.W $0A9E 
    STZ.W $0AA0 
    LDA.W #$0001 
...
.submergedInWater:
    ...
    BIT.W #$0004 
    BNE .gotoSpeedTableSet 
    LDA.W #SamusXSpeedTable_InWater 
    STA.W $0A6C 
    BRA .speedTableSet 


.submergedInAcidLava:
    LDA.W #SamusXSpeedTable_InLavaAcid 
    STA.W $0A6C 
...
.notSubmerged:
    LDA.W SamusPhysicsConstants_YSubAccelerationInAir 
    STA.W $0B32 
    LDA.W SamusPhysicsConstants_YAccelerationInAir 
    STA.W $0B34 
    BRA .return 
...
.submergedInWater:
    ...
    BIT.W #$0004 
    BNE .notSubmerged 
    LDA.W SamusPhysicsConstants_YSubAccelerationInWater 
    STA.W $0B32 
    LDA.W SamusPhysicsConstants_YAccelerationInWater 
    STA.W $0B34 
    BRA .return 


.submergedInAcidLava:
    LDA.W SamusPhysicsConstants_YSubAccelerationInAcidLava 
    STA.W $0B32 
    LDA.W SamusPhysicsConstants_YAccelerationInAcidLava 
    STA.W $0B34 
...
.trail:
  ...
  + LDA.W $0C04,X 
    ...
    LDA.W $0BDC,X 
    CLC 
    ADC.W ProjectileAccelerations_X,Y 
    STA.W $0BDC,X 
    LDA.W $0BF0,X 
    CLC 
    ADC.W ProjectileAccelerations_Y,Y 
    STA.W $0BF0,X 
    TYX 
    JSR.W (.pointers,X) 
...
.notDiagonal:
    LDA.W BeamSpeeds_Horizontal_Vertical,Y 
    STA.B $16 
    BRA .merge 


.diagonal:
    LDA.W BeamSpeeds_Diagonal,Y 
    STA.B $16 
...
AccelerateMissile:
    ...
    LDA.W $0C7C,X 
    CLC 
    ADC.W MissileInitializedBitset 
    STA.W $0C7C,X 
    AND.W #$FF00 
    BEQ .return 
    LDA.W $0C7C,X 
...
.superMissile:
    LDA.W #SuperMissileAccelerations 
    CLC 
    ADC.B $12 
    TAY 
...
.found:
    ...
    STA.W $D658,Y 
    STA.W $D67C,Y 
    LDA.L ProjectileTrail_InstListPointers_Left,X 
    STA.W $D6A0,Y 
    LDA.L ProjectileTrail_InstListPointers_Right,X 
    STA.W $D6C4,Y 
    LDX.W $0DDE 
...
.waveBeam:
  ...
  + STX.B $14 
    ...
    ASL A 
    TAY 
    LDA.W SamusBeamPreInstructionPointers,Y 
    STA.W $0C68,X 
    JSL.L InitializeBeamVelocities 
...
.initialize:
    ...
    CMP.W #$0001 
    BEQ .notMoonwalk 
    LDA.W ProjectileOriginOffsetsByDirection_ProjectileX_Default,X 
    CLC 
    ADC.W $0AF6 
    STA.W $0B64,Y 
    LDA.W ProjectileOriginOffsetsByDirection_ProjectileY_Default,X 
    CLC 
    ADC.W $0AFA 
    SEC 
    SBC.B $16 
...
.notMoonwalk:
    LDA.W ProjectileOriginOffsetsByDirection_ProjX_Moonwalk_Running,X 
    CLC 
    ADC.W $0AF6 
    STA.W $0B64,Y 
    LDA.W ProjectileOriginOffsetsByDirection_ProjY_Moonwalk_Running,X 
    CLC 
    ADC.W $0AFA 
    SEC 
    SBC.B $16 
...
.loopChargeBeam:
    ...
    STA.W $0CD6,X 
    TAY 
    LDA.W FlareAnimationDelays_Pointers,X 
    STA.B $00 
    LDA.B [$00],Y 
    AND.W #$00FF 
    CMP.W #$00FF 
...
DrawFlareAnimationComponent:
    ...
    CMP.W #$0004 
    BEQ .facingLeft 
    LDA.L FlareSpritemapTable_IndexOffsets_facingRight,X 
    CLC 
    ADC.B $12 
    STA.B $16 
    BRA + 
...
.facingLeft:
    LDA.L FlareSpritemapTable_IndexOffsets_facingLeft,X 
    CLC 
    ADC.B $12 
    STA.B $16 
...
.notRotating:
    ...
    CMP.W #$0001 
    BEQ .running 
    LDA.W ProjectileOriginOffsetsByDirection_FlareX_Default,X 
    CLC 
    ADC.W $0AF6 
    SEC 
    SBC.W $0911 
    STA.B $14 
    LDA.W ProjectileOriginOffsetsByDirection_FlareY_Default,X 
    CLC 
    ADC.W $0AFA 
    SEC 
    SBC.B $18 
...
.running:
    LDA.W ProjectileOriginOffsetsByDirection_FlareX_Running,X 
    CLC 
    ADC.W $0AF6 
    SEC 
    SBC.W $0911 
    STA.B $14 
    LDA.W ProjectileOriginOffsetsByDirection_FlareY_Running,X 
    CLC 
    ADC.W $0AFA 
    SEC 
    SBC.B $18 
...
.loop:
    ...
    JSR.W InitialWaveBeamBlockCollision 
    LDX.W $0DDE 
    LDA.L HyperBeamDamageValue 
    STA.W $0C2C,X 
    LDA.W #ProjectilePreInstruction_HyperBeam 
    STA.W $0C68,X 
    STX.B $14 
    JSL.L InitializeBeamVelocities 
    LDA.W #$0015 
...
.missile:
    JSL.L InitializeProjectile 
    LDA.W #ProjectilePreInstruction_Missile 
    STA.W $0C68,X 
    LDA.W #$00F0 
    STA.W $0C7C,X 
    BRA .return 
...
.super:
    ...
    PLX 
    JSL.L InitializeProjectile 
    LDA.W #ProjectilePreInstruction_SuperMissile 
    STA.W $0C68,X 
    LDA.W #$00F0 
    STA.W $0C7C,X 
...
.zeroDamage:
    ...
    LDA.W #ProjectilePreInstruction_SuperMissileLink 
    STA.W $0C68,X 
    STX.B $12 
    LDX.W $0DDE 
    LDA.W $0C7C,X 
...
.loopBomb:
    ...
    LDA.W $0AFA 
    STA.W $0B78,X 
    LDA.W BombTimerResetValue 
    STA.W $0C7C,X 
    JSL.L InitializeBomb 
    LDA.W #ProjectilePreInstruction_Bomb 
    STA.W $0C68,X 
    PLA 
    XBA 
    AND.W #$000F 
...
.loopPowerBomb:
    ...
    STA.W $0C7C,X 
    JSL.L InitializeBomb 
    LDA.W #ProjectilePreInstruction_PowerBomb 
    STA.W $0C68,X 
    PLA 
    XBA 
    AND.W #$000F 
...
.powerBombsSelected:
    ...
    LDA.W $09CE 
    SEC 
    SBC.W CostOfSBAsInPowerBombs,X 
    BPL + 
    LDA.W #$0000 
...
.loop:
    ...
    STA.W $0C18,X 
    STZ.W $0C04,X 
    LDA.W #ProjectilePreInstruction_WaveSBA 
    STA.W $0C68,X 
    LDA.W #$0258 
    STA.W $0BF0,X 
    STZ.W $0BDC,X 
...
.loop:
    ...
    STA.W $0C18,X 
    STZ.W $0C04,X 
    LDA.W #ProjectilePreInstruction_IceSBA_Main 
    STA.W $0C68,X 
    LDA.W IcePlasmaSBAProjectileOriginAngles,X 
    STA.W $0C7C,X 
    LDA.W #$0258 
    STA.W $0BF0,X 
    JSL.L InitializeProjectile 
...
.loop:
    LDA.W .initialTrailTimers,X 
    STA.W $0C90,X 
    LDA.W #$0005 
    STA.W $0C04,X 
    LDA.W #ProjectilePreInstruction_SpazerSBA 
    STA.W $0C68,X 
    LDA.W #$0028 
    STA.W $0BDC,X 
    LDA.W .angleDeltas,X 
...
.loop:
    ...
    STA.W $0C18,X 
    STZ.W $0C04,X 
    LDA.W #ProjectilePreInstruction_PlasmaSBA 
    STA.W $0C68,X 
    LDA.W IcePlasmaSBAProjectileOriginAngles,X 
    STA.W $0C7C,X 
    LDA.W #$0028 
...
.trail:
  ...
  + LDA.W $0C7C,X 
    ...
    DEC.W $0BF0,X 
    BNE .done 
    LDA.W #ProjectilePreInstruction_IceSBA_End 
    STA.W $0C68,X 
    LDA.W #$0028 
    STA.W $0BDC,X 
    LDA.W #$0024 
...
TriggerShinesparkWindup:
    ...
    PLB 
    REP #$30 
    LDA.W #SamusMovementHandler_ShinesparkWindup 
    STA.W $0A58 
    LDA.W #$0001 
    STA.W $0B36 
    LDA.W #$0400 
...
.facingLeft:
  ...
  + LDA.W #SamusMovementHandler_VerticalShinespark 
    STA.W $0A58 
    LDA.W #RTS_90E90E 
    STA.W $0A60 
    STZ.W $0AAE 
...
.facingLeft:
  ...
  + STZ.W $0B2C 
    ...
    STZ.W $0B1A 
    STZ.W $0B36 
    LDA.W #SamusMovementHandler_ShinesparkCrash_EchoesCircleSamus 
    STA.W $0A58 
    LDA.W #SamusDisplayHandler_ShinesparkCrashCircle 
    STA.W $0A5C 
    STZ.W $0AAE 
    LDA.W $0AF6 
    STA.W $0AB0 
...
.zeroDistance:
    LDA.W #ShinesparkCrash_EchoesFinishedCirclingSamus 
    STA.W $0A58 
    LDA.W #$001E 
    STA.W $0AA2 
    STZ.W $0AAE 
...
ShinesparkCrash_Finish:
    ...
    LDX.W #$0006 
    JSL.L Initialize_ShinesparkEcho_or_SpazerSBATrailProjectile 
    LDA.W #ProjectilePreInstruction_SpeedEcho 
    STA.W $0C6E 
    LDA.W $0A1C 
    SEC 
    SBC.W #$00C9 
...
.cancel:
    LDA.W #GrappleBeamFunction_HitNothing_Cancel 
    STA.W $0D32 
    RTS 
...
.storePose:
    ...
    LDA.W $0A1E 
    STA.W $0A22 
    LDA.W #SamusMovementHandler_CrystalFlash_RaiseSamus_GenerateBubble 
    STA.W $0A58 
    LDA.W $0A60 
    CMP.W #SamusPoseInputHandler_Demo 
...
SamusMovementHandler_CrystalFlash_RaiseSamus_GenerateBubble:
    ...
    LDA.W $0AFA 
    STA.W $0DF0 
    LDA.W #SamusMovementHandler_CrystalFlash_DecrementAmmo 
    STA.W $0A58 
    STZ.W $18A8 
    STZ.W $18AA 
    LDA.W #$0001 
...
.timerExpired:
    LDA.W #SamusMovementHandler_CrystalFlash_Finish 
    STA.W $0A58 
    LDA.W #SamusDrawingHandler_Default 
    STA.W $0A5C 
    LDA.W #$0003 
...
.loop:
    ...
    STA.W $0C18,X 
    STZ.W $0C04,X 
    LDA.W #ProjectilePreInstruction_BombSpread 
    STA.W $0C68,X 
    JSL.L InitializeBomb 
    LDA.W $0AF6 
    STA.W $0B64,X 
    ...
    SBC.W #$000A 
    TAY 
    LDA.W BombSpreadData_XVelocities,Y 
    STA.W $0BDC,X 
    ...
    AND.W #$0003 
    CLC 
    ADC.W BombSpreadData_YSpeeds,Y 
    EOR.W #$FFFF 
    INC A 
    STA.W $0BF0,X 
    STA.W $0CA4,X 
...
FireEndOfSpazerSBA:
    ...
    LDA.W #$0004 
    STA.W $0C90,Y 
    LDA.W #ProjectilePreInstruction_EndOfSpazerSBA 
    STA.W $0C68,Y 
    CPY.W #$0004 
    BPL .return 
    LDA.W #$8024 
...
SetupBombJump_Jumping_Turning_DamageBoost_TransitionPoses:
    LDA.W #SamusPoseInputHandler_Normal 
    STA.W $0A60 ; fallthrough to SetupBombJump_DraygonGrab_Shinespark_CF_Drained_DamagedMB
...
SamusMovementHandler_BombJump_Start:
    ...
    LDA.W #SamusMovementHandler_BombJump_Main 
    STA.W $0A58 
    STZ.W $0DC6 
    RTS 
...
SetSamusToBePushedOutOfCeresRidleysWay:
    ...
    LDA.W #RTS_90E90E 
    STA.W $0A58 
    LDA.W #SamusTimerHackHandler_PushSamusOutOfCeresRidleysWay 
    STA.W $0A5A 
    PLB 
    PLP 
    RTL 
...
.pushLeft:
  ...
  + LDA.W #$0005 
    ...
    STZ.W $0B2C 
    STZ.W $0A56 
    LDA.W #SamusTimerHackHandler_PushingSmausOutOfCeresRidleysWay 
    STA.W $0A5A 
    LDA.W #$FFFF 
    STA.W $0A28 
    STA.W $0A2A 
...
.merge:
    JSL.L InitializeSamusPose_1 
    JSL.L Set_Samus_AnimationFrame_if_PoseChanged 
    LDA.W #SamusTimerHackHandler_GrabbedByDraygon 
    STA.W $0A5A 
    LDA.W #RTS_90E90E 
    STA.W $0A58 
    STZ.W $0DEC 
...
UNUSED_PushMorphBallSamusOutOfCeresRidleysWay_90E37F:
    ...
    LDA.W #$0001 
    STA.W $0A62 
    LDA.W #UNUSED_SamusTimerHackHandler_PushMorphBallCeresRidley_90E3A3 
    STA.W $0A5A 
    LDA.W #SamusDrawingHandler_Default 
    STA.W $0A5C 
    PLB 
...
.facingLeft:
  ...
  + STZ.W $0A30 
    LDA.W #RTS_90E90E 
    STA.W $0A58 
    LDA.W #UNUSED_SamusTimerHackHandler_SpecialFalling_90E41B 
    STA.W $0A5A 
    PLB 
    PLP 
    RTL 
...
.pressedB:
    ...
    LDA.W #RTL_90E8CD 
    STA.W $0A42 
    LDA.W #SamusNewStateHandler_Debug 
    STA.W $0A44 
...
.loop:
    ...
    STA.W $0C18,X 
    STZ.W $0C04,X 
    LDA.W #UNUSED_ProjectilePreInstruction_UnknownProjectile27_90EFD3 
    STA.W $0C68,X 
    STZ.W $0BF0,X 
    STZ.W $0BDC,X 
    STZ.W $0C7C,X 
...
UNUSED_ProjectilePreInstruction_UnknownProjectile27_90EFD3:
    ...
    CPX.W #$0006 
    BNE .clear 
    LDA.W #UNUSED_SamusMovementHandler_90F04B 
    STA.W $0A58 
...
UNUSED_SamusMovementHandler_90F04B:
    ...
    LDA.W #$0078 
    STA.W $0A68 
    LDA.W #UNUSED_SamusMovementHandler_90F072 
    STA.W $0A58 
...
SamusCommand_18_SetupSamusForBeingDrained_UnableToStand:
    LDA.W #SamusTimerHackHandler_LetSamusFailToStandUpFromBeingDrained 
    STA.W $0A5A 
