...
InitAI_Waver:
    LDX.W $0E54 
    LDA.W #$0180 : AND.W #$FF00 
    XBA 
    STA.W $0FAA,X 
    LDA.W #$0180 : AND.W #$00FF 
    XBA 
    STA.W $0FA8,X 
    LDA.W $0FB4,X : AND.W #$0001 
    BNE .facingLeft 
    LDA.W #$0180 
    EOR.W #$FFFF 
    INC A 
...
.facingLeft:
    ...
    STZ.W $0FAC,X 
    STZ.W $0FB0,X 
    LDA.W #InstList_Waver_Steady_FacingLeft : STA.W $0F92,X 
    LDA.W $0FB4,X : AND.W #$0001 : STA.W $0FB2,X 
...
.noWallCollision:
    ...
    LDX.W $0E54 
    LDA.W $0FAE,X : CLC : ADC.W #$0080 : AND.W #$00FF 
    STA.W $0FAE,X 
    BRA .merge 
...
.noBlockCollision:
    LDX.W $0E54 
    LDA.W $0FAE,X : CLC : ADC.W #$0002 : STA.W $0FAE,X 

.merge:
    LDX.W $0E54 
    LDA.W $0FAE,X : AND.W #$007F 
    CMP.W #$0038 : BNE .notSpinning 
    LDA.W $0FB2,X : ORA.W #$0002 : STA.W $0FB2,X 
    JSR.W SetWaverInstList 

.notSpinning:
    LDA.W $0FB0,X : BEQ .return 
    STZ.W $0FB0,X 
    LDA.W $0FB2,X : AND.W #$0001 : STA.W $0FB2,X 
    JSR.W SetWaverInstList 
...
SetWaverInstList:
    LDX.W $0E54 
    LDA.W $0FB2,X : CMP.W $0FAC,X : BEQ .return 
    STA.W $0FAC,X 
    ASL A 
    TAY 
    LDA.W InstListPointers_Waver,Y : STA.W $0F92,X 
...
InitAI_Metaree:
    ...
    STZ.W $0FAE,X 
    STZ.W $0FB0,X 
    LDA.W #InstList_Metaree_Idling : STA.W $0F92,X 
    LDA.W #Function_Metaree_Idling : STA.W $0FAA,X 
    RTL 
...
Function_Metaree_Idling:
  ...
  + CMP.W #$0048 : BCS .return 
    ...
    LDA.W #Function_Metaree_PrepareToLaunchAttack : STA.W $0FAA,X 
...
DetermineMetareeYVelocity:
    LDA.W $0AFA : SEC : SBC.W $0F7E,X : STA.W $4204 
    SEP #$20 
    LDA.B #$18 : STA.W $4206 
    REP #$20 
    NOP #7
    LDA.W $4214 : AND.W #$00FF 
    CLC : ADC.W #$0004 : STA.W $0FB2,X 
    RTS 
...
Function_Metaree_LaunchedAttack:
    LDX.W $0E54 
    LDA.W #$0015 : STA.W $0FA8,X 
    LDA.W $0FB2,X : STA.B $14 
    STZ.B $12 
    LDA.W $0F86,X : ORA.W #$0003 : STA.W $0F86,X 
    LDX.W $0E54 
    JSL.L CheckForVerticalSolidBlockCollision_SkreeMetaree 
    BCS .collision 
    LDX.W $0E54 
    LDA.W $0F7E,X : CLC : ADC.W $0FB2,X : STA.W $0F7E,X 
    LDA.W #$0002 : STA.W $0E24 
    LDA.W $0F7A,X : CMP.W $0AF6 : BMI .steerLeft 
    LDA.W #$FFFE : STA.W $0E24 

.steerLeft:
    LDA.W $0F7A,X : CLC : ADC.W $0E24 : STA.W $0F7A,X 
    BRA .return 
...
Function_Metaree_Burrowing:
    ...
    DEC.W $0FA8,X 
    BEQ .delete 
    LDA.W $0FA8,X : CMP.W #$0008 : BNE .timerNot8 
    LDX.W $0E54 
...
.delete:
    LDX.W $0E54 
    LDA.W $0F96,X : ORA.W $0F98,X : STA.L $7E7006,X 
...
SetMetareeInstListPointer:
    LDX.W $0E54 
    LDA.W $0FAC,X : CMP.W $0FAE,X : BEQ .return 
    STA.W $0FAE,X 
    ASL A 
    TAY 
    LDA.W InstListPointers_Metaree,Y : STA.W $0F92,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
EnemyShot_Metaree:
    LDX.W $0E54 
    LDA.W $0F98,X : STA.W $0E2A 
    LDA.W $0F96,X : STA.W $0E2C 
    JSL.L CommonA3_NormalEnemyShotAI 
    LDX.W $0E54 
    LDA.W $0F8C,X : BNE .return 
    LDX.W $0E54 
    LDA.W $0E2A : STA.W $0F98,X 
    LDA.W $0E2C : STA.W $0F96,X 
    LDA.W $0FA8,X 
    LDX.W $0E54 
    LDY.W #EnemyProjectile_MetalSkreeParticles_DownRight 
    JSL.L SpawnEnemyProjectileY_ParameterA_XGraphics 
...
InitAI_Fireflea:
    LDX.W $0E54 
    LDA.W #InstList_Fireflea : STA.W $0F92,X 
    LDA.W $0FB4,X : AND.W #$00FF : STA.B $12 
    AND.W #$0002 
    BNE .circleMovement 
...
SetFirefleaRadius:
    ...
    ASL A 
    TAY 
    LDA.W FirefleaMovementRadii,Y : AND.W #$00FF : STA.W $0FAC,X 
    RTS 
...
SetFirefleaMinMaxYPositions:
    LDA.W $0F7E,X : SEC : SBC.W $0FAC,X : STA.L $7E7800,X 
    LDA.W $0F7E,X : CLC : ADC.W $0FAC,X : STA.L $7E7802,X 
    RTS 


MainAI_Fireflea:
    LDX.W $0E54 
    LDA.W $0FB4,X : AND.W #$0002 
    BEQ .verticalMovement 
    LDA.W $0FAC,X : STA.W $0E32 
    LDA.W $0FAE,X : AND.W #$FF00 
    XBA 
    ...
    JSL.L EightBitNegativeSineMultiplication_A0B0C6 
    CLC : ADC.W $0FB2,X : STA.W $0F7E,X 
    LDA.W $0FAE,X : CLC : ADC.W $0FA9,X : STA.W $0FAE,X 
    RTL 
...
.verticalMovement:
    ...
    LDA.W $0F7E,X : CMP.L $7E7800,X : BMI + 
    LDA.W $0F7E,X : CMP.L $7E7802,X : BPL + 
    RTL 
...
EnemyTouch_Fireflea:
    ...
    JSL.L EnemyDeath 
    LDA.W $177E : CLC : ADC.W #$0002 : CMP.W #$000E : BPL .return 
    STA.W $177E 
...
InitAI_Skultera:
    LDX.W $0E54 
    LDA.W #InstList_Skultera_SwimmingLeft_0 : STA.W $0F92,X 
    LDA.W #Function_Skultera_SwimmingLeft : STA.W $0FA8,X 
    LDA.W $0FB5,X : AND.W #$00FF 
    BNE .keepLeft 
    LDA.W #InstList_Skultera_SwimmingRight_0 : STA.W $0F92,X 
    LDA.W #Function_Skultera_SwimmingRight : STA.W $0FA8,X 

.keepLeft:
    LDA.W $0FB4,X : AND.W #$00FF 
    ASL #3
    TAY 
    LDA.W CommonEnemySpeeds_LinearlyIncreasing,Y : STA.W $0FAC,X 
    LDA.W CommonEnemySpeeds_LinearlyIncreasing+2,Y : STA.W $0FAA,X 
    LDA.W CommonEnemySpeeds_LinearlyIncreasing+4,Y : STA.W $0FB0,X 
    LDA.W CommonEnemySpeeds_LinearlyIncreasing+6,Y : STA.W $0FAE,X 
    LDA.W $0FB6,X : AND.W #$00FF : STA.L $7E7800,X 
    LDA.W $0FB7,X : AND.W #$00FF : STA.L $7E7804,X 
...
Function_Skultera_SwimmingLeft:
    ...
    JSL.L MoveEnemyRightBy_14_12_IgnoreSlopes 
    BCC .noWallCollision 
    LDA.W #Function_Skultera_TurningRight : STA.W $0FA8,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #InstList_Skultera_TurningRight : STA.W $0F92,X 
    BRA .merge 
...
.noBlockCollision:
    LDA.W $0FB2,X : CLC : ADC.L $7E7804,X : AND.W #$00FF 
    STA.W $0FB2,X 

.merge:
    LDA.L $7E7808,X : STA.L $7E7806,X 
    RTS 
...
Function_Skultera_SwimmingRight:
    ...
    JSL.L MoveEnemyRightBy_14_12_IgnoreSlopes 
    BCC .noWallCollision 
    LDA.W #Function_Skultera_TurningLeft : STA.W $0FA8,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #InstList_Skultera_TurningLeft : STA.W $0F92,X 
    BRA .merge 
...
InitAI_Elevator:
    LDX.W $0E54 
    LDA.W #Spritemap_CommonA3_Nothing : STA.W $0F8E,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #InstList_Elevator : STA.W $0F92,X 
    ASL.W $0FB4,X 
    LDA.W $0F7E,X : STA.W $0FA8,X 
    LDA.W $0E18 : CMP.W #$0002 : BEQ .doorTransition 
    STZ.W $0E16 
    STZ.W $0E18 
...
ElevatorAI_3_EnteringRoom:
    LDX.W $0E54 
    LDA.W $0FB4,X : BEQ .down 
    LDA.W $0F80,X : CLC : ADC.W #$8000 : STA.W $0F80,X 
    LDA.W $0F7E,X : ADC.W #$0001 : STA.W $0F7E,X 
    CMP.W $0FA8,X : BCS .reachedTarget 
...
.down:
    LDA.W $0F80,X : SEC : SBC.W #$8000 : STA.W $0F80,X 
    LDA.W $0F7E,X : SBC.W #$0001 : STA.W $0F7E,X 
    CMP.W $0FA8,X : BCC .reachedTarget 
    BRA PlaceSamusOnElevator 
...
PlaceSamusOnElevator:
    LDX.W $0E54 
    LDA.W $0F7E,X : SEC : SBC.W #$001A : STA.W $0AFA 
    STZ.W $0AFC 
...
InitAI_Sciser:
    LDX.W $0E54 
    LDA.W #$0008 : STA.W $0FB6,X 
    LDA.W $0F92,X : AND.W #$0003 
    ASL A 
    TAY 
    LDA.W InstListPointers_Sciser,Y : STA.W $0F92,X 
...
InitAI_Zero:
    LDX.W $0E54 
    LDA.W #$000A : STA.W $0FB6,X 
    LDA.W $0F92,X : AND.W #$0003 
    ASL A 
    TAY 
    LDA.W InitialInstListPointers_Zero,Y : STA.W $0F92,X 
    JMP.W InitAI_Crawlers_Common 
...
InitAI_Kamer2:
    LDX.W $0E54 
    LDA.W #$FFFF : STA.L $7E783E,X 
    LDY.W #InstList_Kamer2_VerticallyStill_Left_0 
    LDA.W $0FB4,X : STA.L $7E7804,X 
...
InitAI_Tripper_Kamer2_Common:
    ...
    STA.W $0FA8,X 
    STZ.W $0FB2,X 
    LDA.W $0FB7,X : AND.W #$00FF : STA.L $7E780A,X 
    RTL 
...
.SamusNotRiding:
    ...
    LDX.W $0E54 
    LDA.L $7E7800,X : CMP.L $7E780C,X : BEQ .noChange 
    STZ.W $0FB2,X 

.noChange:
    LDA.L $7E7800,X : STA.L $7E780C,X 
    RTL 


Function_Tripper_Kamer2_XMovement_0_MovingLeft:
    LDX.W $0E54 
    LDA.W $0F7A,X : STA.L $7E7802,X 
    LDA.W $0FAE,X : STA.B $12 
    LDA.W $0FB0,X : STA.B $14 
    JSL.L MoveEnemyRightBy_14_12_IgnoreSlopes 
    BCC .return 
...
Function_Tripper_Kamer2_YMovement_Rising:
    LDX.W $0E54 
    LDA.W $0F7E,X : CMP.W $0FA8,X : BMI .notMoving 
    JSR.W SetPlatformInstList_VerticallyMoving 
    INC.W $0FB2,X 
    LDA.W $0FB2,X : CMP.L $7E780A,X : BMI + 
...
Function_Tripper_Kamer2_YMovement_1_Sinking:
    LDX.W $0E54 
    LDA.W $0F7E,X : CMP.W $0FA8,X 
    JSR.W RTS_A39E46 
    INC.W $0FB2,X 
    LDA.W $0FB2,X : CMP.L $7E780A,X : BMI + 
    LDA.L $7E780A,X : STA.W $0FB2,X 

  + LDA.W $0F7A,X : SEC : SBC.L $7E7802,X : CLC : ADC.W $0B58 : STA.W $0B58 
...
.notCollidedWithBlock:
    LDA.W $0F7E,X : SEC : SBC.L $7E7802,X : CLC : ADC.W $0B5C : STA.W $0B5C 
    RTS 
...
SetPlatformInstList_VerticallyMoving:
    LDX.W $0E54 
    LDA.L $7E7806,X : BNE .merge 
    LDA.W #$0001 : STA.L $7E7806,X 
    LDA.L $7E7804,X : BEQ .movingLeft 
...
EnemyShot_Tripper:
    ...
    LDA.L $7E7804,X : BEQ .movingLeft 
    LDA.W #Spritemap_Tripper_Frozen_MovingRight : STA.W $0F8E,X 
    BRA .return 


.movingLeft:
    LDA.W #Spritemap_Tripper_Frozen_MovingLeft : STA.W $0F8E,X 
...
SetSbugInstList:
    LDX.W $0E54 
    LDA.L $7E8008,X : CMP.L $7E800A,X : BEQ .return 
    STA.L $7E800A,X 
    STA.W $0F92,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
InitAI_Sbug:
    ...
    LDA.L $7E8000,X 
    TAY 
    LDA.W InstListPointers_Sbug,Y : STA.L $7E8008,X 
    JSR.W SetSbugInstList 
    LDA.W #Function_Sbug_WaitForSamusToGetNear : STA.W $0FAA,X 
    RTL 


CalculateMovingForwardSpeeds:
    LDA.W $0FB4,X : AND.W #$00FF : STA.B $14 
    LDA.W $0FB5,X : AND.W #$00FF : STA.B $12 
    JSL.L Do_Some_Math_With_Sine_Cosine_Terrible_Label_Name ; ($16.$18, $1A.$1C) = ([$14] * |cos([$12] * pi / 80h)|, [$14] * |sin([$12] * pi / 80h)|)
    LDA.B $16 : STA.L $7E7802,X 
    LDA.B $18 : STA.L $7E7800,X 
    LDA.B $1A : STA.L $7E7806,X 
    LDA.B $1C : STA.L $7E7804,X 
    RTS 
...
UNUSED_CalculateMovingForwardVelocities_A3A1B0:
    ...
    LDA.W $0FB5,X : AND.W #$00FF 
    JSL.L EightBitCosineMultiplication_A0B0B2 
    LDA.W $0E36 : STA.L $7E7802,X 
    LDA.W $0E38 : STA.L $7E7800,X 
    LDA.W $0FB4,X : AND.W #$00FF : STA.W $0E32 
    LDA.W $0FB5,X : AND.W #$00FF 
    JSL.L EightBitNegativeSineMultiplication_A0B0C6 
    LDA.W $0E36 : STA.L $7E7806,X 
    LDA.W $0E38 : STA.L $7E7804,X 
    RTS 
endif ; !FEATURE_KEEP_UNREFERENCED
...
CalculateMovingLeftVelocities:
    LDA.W $0FB4,X : AND.W #$00FF : STA.W $0E32 
    LDA.W $0FB5,X : SEC : SBC.W #$0020 : AND.W #$00FF 
    JSL.L EightBitCosineMultiplication_A0B0B2 
    LDA.W $0E36 : STA.L $7E780A,X 
    LDA.W $0E38 : STA.L $7E7808,X 
    LDA.W $0FB4,X : AND.W #$00FF : STA.W $0E32 
    LDA.W $0FB5,X : SEC : SBC.W #$0020 : AND.W #$00FF 
    JSL.L EightBitNegativeSineMultiplication_A0B0C6 
    LDA.W $0E36 : STA.L $7E780E,X 
    LDA.W $0E38 : STA.L $7E780C,X 
    RTS 


CalculateMovingRightVelocities:
    LDA.W $0FB4,X : AND.W #$00FF : STA.W $0E32 
    LDA.W $0FB5,X : CLC : ADC.W #$0020 : AND.W #$00FF 
    JSL.L EightBitCosineMultiplication_A0B0B2 
    LDA.W $0E36 : STA.L $7E7812,X 
    LDA.W $0E38 : STA.L $7E7810,X 
    LDA.W $0FB4,X : AND.W #$00FF : STA.W $0E32 
    LDA.W $0FB5,X : CLC : ADC.W #$0020 : AND.W #$00FF 
    JSL.L EightBitNegativeSineMultiplication_A0B0C6 
    LDA.W $0E36 : STA.L $7E7816,X 
    LDA.W $0E38 : STA.L $7E7814,X 
    RTS 


DetermineFacingForwardInstListIndex:
    LDA.W $0FB5,X : SEC : SBC.W #$0030 : AND.W #$00FF 
    LSR #5
    ASL A 
    STA.L $7E8000,X 
    RTS 
...
DetermineFacingLeftInstListIndex:
    LDA.W $0FB5,X : SEC : SBC.W #$0030 : SEC : SBC.W #$0020 : AND.W #$00FF 
    LSR #5
    ASL A 
    STA.L $7E8002,X 
    RTS 
...
DetermineFacingRightInstListIndex:
    LDA.W $0FB5,X : SEC : SBC.W #$0030 : CLC : ADC.W #$0020 : AND.W #$00FF 
    LSR #5
    ASL A 
    STA.L $7E8004,X 
    RTS 
...
Function_Sbug_WaitForSamusToGetNear:
    ...
    ASL A 
    TAY 
    LDA.W ActivateFunctionPointers_Sbug,Y : STA.W $0FAA,X 
...
Function_Sbug_Activate_0_MoveForwards:
    LDX.W $0E54 
    LDA.W #Function_Sbug_Activated_0_MoveForwards : STA.W $0FAA,X 
    RTS 


Function_Sbug_Activate_1_MoveForwardsInAZigZag:
    LDX.W $0E54 
    LDA.W #Function_Sbug_Activated_1_MoveForwardsInAZigZag : STA.W $0FAA,X 
    RTS 


Function_Sbug_Activate_3_MoveRandomly_WaitForSamusIfHitBlock:
    LDX.W $0E54 
    LDA.W #$000B : STA.W $05E5 
    LDA.W #Function_Sbug_Activated_3_MoveRandomly_WaitForSamusIfHitBlock : STA.W $0FAA,X 
    RTS 
...
Function_Sbug_Activate_4_MoveRandomly_ReverseUntil6BlockAway:
    ...
    LDA.W #$000B : STA.W $05E5 
    LDA.W #Function_Sbug_Activated_4_MoveRandomly_ReverseUntil6BlocksAway : STA.W $0FAA,X 
    RTS 
...
Function_Sbug_Activate_5_MoveForwards_WaitForSamus:
    ...
    LDA.W #Function_Sbug_Activated_5_MoveForwards_WaitForSamus : STA.W $0FAA,X 
    RTS 
...
Function_Sbug_Activate_2_MoveAlong45DegreeAngleTowardsSamus:
    ...
    LDA.W InstListPointers_Sbug,Y : STA.L $7E8008,X 
    JSR.W SetSbugInstList 
    LDA.W #Function_Sbug_Activated_2_MoveAlong45DegreeAngleTowardsSamus : STA.W $0FAA,X 
    RTS 
...
Function_Sbug_Activate_6_MoveAlong45DegreeAngleAwayFromSamus:
    ...
    LDA.W InstListPointers_Sbug,Y : STA.L $7E8008,X 
    JSR.W SetSbugInstList 
    LDA.W #Function_Sbug_Activated_6_MoveAlong45DegAngleAwayFromSamus : STA.W $0FAA,X 
    RTS 


DetermineCustomInstListIndex:
    LDA.W $0FAC,X : SEC : SBC.W #$0030 : AND.W #$00FF 
    LSR #5
    ASL A 
    STA.L $7E8006,X 
    RTS 
...
Function_Sbug_MoveStraightAlongAngle_ReverseUntil6BlocksAway:
    ...
    DEC.W $0FB2,X 
    BMI .done 
    LDA.W $0F7A,X : SEC : SBC.W $0AF6 : JSL.L NegateA_A0B067 
    CMP.W #$0060 : BPL + 
    BRA .move 


  + LDA.W $0F7E,X : SEC : SBC.W $0AFA : JSL.L NegateA_A0B067 
...
Function_Sbug_Activated_4_MoveRandomly_ReverseUntil6BlocksAway:
    ...
    JSR.W SetSbugInstList 
    LDA.W #$0020 : STA.W $0FB2,X 
    LDA.W #Function_Sbug_MoveStraightAlongAngle_ReverseUntil6BlocksAway : STA.W $0FAA,X 
    RTS 
...
Function_Sbug_Activated_3_MoveRandomly_WaitForSamusIfHitBlock:
    ...
    JSR.W SetSbugInstList 
    LDA.W #$0020 : STA.W $0FB2,X 
    LDA.W #Function_Sbug_MoveAlongCustomAngle_WaitForSamusIfHitBlock : STA.W $0FAA,X 
    RTS 
...
ReverseSbugCustomAngle:
    ...
    INC A 
    STA.L $7E781C,X 
    LDA.L $7E8006,X : CLC : ADC.W #$0004 : AND.W #$0007 
    STA.L $7E8006,X 
    TAY 
    LDA.W InstListPointers_Sbug,Y : STA.L $7E8008,X 
    JSR.W SetSbugInstList 
...
MoveSbugForward:
    LDA.L $7E7802,X : STA.W $0E24 
    LDA.L $7E7800,X : STA.W $0E26 
    LDA.L $7E7806,X : STA.W $0E28 
    LDA.L $7E7804,X : STA.W $0E2A 
    LDA.W $0FB5,X : AND.W #$00FF : STA.W $0E20 
...
MoveSbugLeft:
    LDA.W $0F7A,X : CLC : ADC.L $7E780A,X : STA.W $0F7A,X 
    LDA.W $0F7C,X : CLC : ADC.L $7E7808,X : BCC + 
    INC.W $0F7A,X 

  + STA.W $0F7C,X 
    LDA.W $0F7E,X : CLC : ADC.L $7E780E,X : STA.W $0F7E,X 
    LDA.W $0F80,X : CLC : ADC.L $7E780C,X : BCC + 
    INC.W $0F7E,X 
...
MoveSbugRight:
    LDA.W $0F7A,X : CLC : ADC.L $7E7812,X : STA.W $0F7A,X 
    LDA.W $0F7C,X : CLC : ADC.L $7E7810,X : BCC + 
    INC.W $0F7A,X 

  + STA.W $0F7C,X 
    LDA.W $0F7E,X : CLC : ADC.L $7E7816,X : STA.W $0F7E,X 
...
MoveSbugAlongCustomAngle:
    LDA.W $0F7A,X : CLC : ADC.L $7E781A,X : STA.W $0F7A,X 
    LDA.W $0F7C,X : CLC : ADC.L $7E7818,X : BCC + 
    INC.W $0F7A,X 

  + STA.W $0F7C,X 
    LDA.W $0F7E,X : CLC : ADC.L $7E781E,X : STA.W $0F7E,X 
    LDA.W $0F80,X : CLC : ADC.L $7E781C,X : BCC + 
    INC.W $0F7E,X 
...
MoveSbugAlongCustomAngle_WaitForSamusIfHitBlock:
    LDA.L $7E7818,X : STA.B $12 
    LDA.L $7E781A,X : STA.B $14 
    JSL.L MoveEnemyRightBy_14_12_IgnoreSlopes 
...
.notCollidedWithWall:
    LDA.L $7E781C,X : STA.B $12 
    LDA.L $7E781E,X : STA.B $14 
    JSL.L MoveEnemyDownBy_14_12 
    BCC .return 
    LDA.W #Function_Sbug_WaitForSamusToGetNear : STA.W $0FAA,X 
...
Function_Mochtroid_0_NotTouchingSamus:
    ...
    STZ.B $12 
    STZ.B $14 
    LDA.W $0F7E,X : SEC : SBC.W $0AFA : LSR #2
    STA.B $13 
    AND.W #$2000 
    BEQ + 
    LDA.B $14 : ORA.W #$FFC0 : STA.B $14 

  + LDA.W $0FAC,X : SEC : SBC.B $12 : STA.W $0FAC,X 
    LDA.W $0FAE,X : SBC.B $14 : STA.W $0FAE,X 
    BMI .negativeY 
    CMP.W #$0003 : BCC + 
    LDA.W #$0003 : BRA .storeYVelocity 
...
.notCollidedWithBlock:
    ...
    STZ.B $12 
    STZ.B $14 
    LDA.W $0F7A,X : SEC : SBC.W $0AF6 : LSR #2
    STA.B $13 
    AND.W #$2000 
    BEQ + 
    LDA.B $14 : ORA.W #$FFC0 : STA.B $14 
...
UNUSED_Function_Mochtroid_2_Shaking_A3A88F:
    LDX.W $0E54 
    LDA.W $0FB0,X : AND.W #$0006 
    TAY 
    LDA.W $0F7A,X : CLC : ADC.W MocktroidShakeVelocityTable_X,Y : STA.W $0F7A,X 
    LDA.W $0F7E,X : CLC : ADC.W MocktroidShakeVelocityTable_Y,Y : STA.W $0F7E,X 
    STZ.W $0FA8,X 
    STZ.W $0FAA,X 
    STZ.W $0FAC,X 
    STZ.W $0FAE,X 
...
Function_Mochtroid_1_TouchingSamus:
    LDX.W $0E54 
    LDA.W $0F7A,X : CMP.W $0AF6 : BEQ .centeredX 
    BPL .moveLeft 
    BMI .moveRight 
...
.moveX:
    ...
    LDA.W $0FAA,X : STA.B $14 
    JSL.L MoveEnemyRightBy_14_12_IgnoreSlopes 
    LDA.W $0F7E,X : CMP.W $0AFA : BEQ .centeredY 
    BPL .moveUp 
    BMI .moveDown 
...
EnemyTouch_Mochtroid:
    ...
    CMP.W #$0007 : BNE .skipSFX 
    LDA.W $09C2 : CMP.W #$001E : BMI .skipSFX 
    LDA.W #$002D : JSL.L QueueSound_Lib3_Max6 

.skipSFX:
    LDA.L $7E8000,X : CMP.W #$0050 : BMI .return 
    LDA.W #$0000 : STA.L $7E8000,X 
...
InitAI_Hopper:
    ...
    LDX.W $0E54 
    STA.L $7E780C,X 
    LDA.W $0FB4,X : BNE .upsideDown 
    LDA.L $7E780C,X 
    TAY 
    LDA.W InstListPointers_Sidehopper_Landed_UpsideUp,Y : BRA + 
...
.sidehopper:
    ...
    LDA.L $7E780A,X 
    TAY 
    LDA.W HopTable_Small_JumpHeight,Y : STA.B $16 
    LDA.W HopTable_Small_YSpeedTableIndexDelta,Y : STA.B $18 
    JSR.W Hoppers_CalculateInitialHopSpeed 
    STA.L $7E7802,X 
    LDA.L $7E780A,X 
    TAY 
    LDA.W HopTable_Big_JumpHeight,Y : STA.B $16 
    LDA.W HopTable_Big_YSpeedTableIndexDelta,Y : STA.B $18 
    JSR.W Hoppers_CalculateInitialHopSpeed 
    STA.L $7E7804,X 
    LDA.W #Function_Hopper_Hop : STA.W $0FAA,X 
    RTL 
...
Function_Hopper_Hop:
    ...
    ASL A 
    TAY 
    LDA.W HopFunctionPointers_Sidehopper,Y : STA.W $0FAA,X 
    RTS 
...
Function_Hopper_SmallHop:
    ...
    LDA.L $7E780A,X 
    TAY 
    LDA.W HopTable_Small_YSpeedTableIndexDelta,Y : STA.W $0FB0,X 
    LDA.W HopTable_Small_XSpeed,Y : STA.W $0FAE,X 
    LDA.L $7E7802,X : STA.W $0FAC,X 
    LDA.W #Function_Hopper_Hop_UpsideUp : STA.W $0FAA,X 
    LDA.W $0FB4,X : BEQ .return 
    LDA.W #Function_Hopper_Hop_UpsideDown : STA.W $0FAA,X 
...
Function_Hopper_BigHop:
    ...
    LDA.L $7E780A,X 
    TAY 
    LDA.W HopTable_Big_YSpeedTableIndexDelta,Y : STA.W $0FB0,X 
    LDA.W HopTable_Big_XSpeed,Y : STA.W $0FAE,X 
    LDA.L $7E7804,X : STA.W $0FAC,X 
    LDA.W #Function_Hopper_Hop_UpsideUp : STA.W $0FAA,X 
    LDA.W $0FB4,X : BEQ .return 
    LDA.W #Function_Hopper_Hop_UpsideDown : STA.W $0FAA,X 
...
Function_Hopper_Hop_UpsideUp:
    LDX.W $0E54 
    LDA.W #Function_Hopper_HopBackwards_UpsideUp : STA.W $0FAA,X 
    JSL.L Get_SamusX_minus_EnemyX 
    BMI .return 
    LDA.W #Function_Hopper_HopForwards_UpsideUp : STA.W $0FAA,X 
...
Function_Hopper_Hop_UpsideDown:
    LDX.W $0E54 
    LDA.W #Function_Hopper_HopBackwards_UpsideDown : STA.W $0FAA,X 
    JSL.L Get_SamusX_minus_EnemyX 
    BMI .return 
    LDA.W #Function_Hopper_HopForwards_UpsideDown : STA.W $0FAA,X 
...
Function_Hopper_HopBackwards_UpsideUp:
    ...
    LDA.L $7E780C,X 
    TAY 
    LDA.W InstListPointers_Sidehopper_Hopping_UpsideUp,Y : STA.L $7E7800,X 
    JSR.W SetSidehopperInstList 
    LDA.W #Function_Hopper_Jumping_UpsideUp : STA.W $0FAA,X 
    RTS 
...
Function_Hopper_HopForwards_UpsideUp:
    ...
    LDA.W InstListPointers_Sidehopper_Hopping_UpsideUp,Y : STA.L $7E7800,X 
    JSR.W SetSidehopperInstList 
    LDA.W #Function_Hopper_Jumping_UpsideUp_duplicate : STA.W $0FAA,X 
    RTS 
...
Function_Hopper_HopBackwards_UpsideDown:
    ...
    LDA.L $7E780C,X 
    TAY 
    LDA.W InstListPointers_Sidehopper_Hopping_UpsideDown,Y : STA.L $7E7800,X 
    JSR.W SetSidehopperInstList 
    LDA.W #Function_Hopper_Jumping_UpsideDown : STA.W $0FAA,X 
    RTS 
...
Function_Hopper_HopForwards_UpsideDown:
    ...
    LDA.W InstListPointers_Sidehopper_Hopping_UpsideDown,Y : STA.L $7E7800,X 
    JSR.W SetSidehopperInstList 
    LDA.W #Function_Hopper_Jumping_UpsideDown_duplicate : STA.W $0FAA,X 
    RTS 
...
Function_Hopper_Landed:
    ...
    LDA.L $7E780C,X 
    TAY 
    LDA.W InstListPointers_Sidehopper_Landed_UpsideUp,Y : STA.L $7E7800,X 
    LDA.W $0FB4,X : BEQ .upsideDown 
    LDA.L $7E780C,X 
    TAY 
    LDA.W InstListPointers_Sidehopper_Landed_UpsideDown,Y : STA.L $7E7800,X 

.upsideDown:
    JSR.W SetSidehopperInstList 
    LDA.W #Function_Hopper_WaitToHop : STA.W $0FAA,X 
    RTS 
...
.notCollidedWithWall:
    LDA.W $0FAC,X : SEC : SBC.W $0FB0,X : STA.W $0FAC,X 
    BPL .return 
    LDA.W #$0001 : STA.L $7E7806,X 
...
HopperMovement_Falling_UpsideUp:
    ...
    BCC .notCollidedWithBlock 
    LDA.W #$0000 : STA.L $7E7806,X 
    LDA.W #Function_Hopper_Landed : STA.W $0FAA,X 
    BRA .return 
...
.notCollidedWithWall:
    LDA.W $0FAC,X : CLC : ADC.W $0FB0,X : CMP.W #$0040 : BMI + 
    LDA.W #$0040 
...
Instruction_Zoa_SetXSpeedTableIndexTo8:
    LDX.W $0E54 
    LDA.W #$0008 : STA.L $7E7800,X 
    RTL 


Instruction_Zoa_SetXSpeedTableIndexToC:
    LDX.W $0E54 
    LDA.W #$000C : STA.L $7E7800,X 
    RTL 


InitAI_Zoa:
    LDX.W $0E54 
    LDA.W #Function_Zoa_WaitForSamusToGetNear : STA.W $0FB4,X 
    LDA.W #$0000 : STA.W $0FAE,X 
    STA.W $0FB0,X 
    STA.L $7E7800,X 
    LDA.W #InstList_Zoa_FacingLeft_Shooting : STA.W $0F92,X 
...
.keepLeft:
    ...
    LDA.W #Function_Zoa_Rising : STA.W $0FB4,X 
...
Function_Zoa_Rising:
    ...
    JSR.W SetZoaInstList 
    STZ.W $0FB2,X 
    LDA.W #Function_Zoa_Shooting : STA.W $0FB4,X 
    RTL 
...
Function_Zoa_Shooting:
    ...
    LDA.L $7E7800,X 
    TAY 
    LDA.W ZoaXSpeedTable_speed,Y : STA.B $14 
    LDA.W ZoaXSpeedTable_subSpeed,Y : STA.B $12 
...
SetZoaInstList:
    LDX.W $0E54 
    LDA.W $0FAE,X : CMP.W $0FB0,X : BEQ .return 
    STA.W $0FB0,X 
    ASL A 
    TAY 
    LDA.W InstListPointers_Zoa,Y : STA.W $0F92,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
InitAI_Viola:
    LDX.W $0E54 
    LDA.W #$0006 : STA.W $0FB6,X 
    LDA.W $0F86,X : AND.W #$0003 
    ASL A 
    TAY 
    LDA.W InitialInstListPointers_Viola,Y : STA.W $0F92,X 
    JMP.W InitAI_Crawlers_Common 
...
Instruction_Bang_SetFinishedGrowingFlagTo1:
    LDX.W $0E54 
    LDA.W #$0001 : STA.L $7E8004,X 
    RTL 


InitAI_Bang:
    LDX.W $0E54 
    LDA.W $0F96,X : STA.W $0FAA,X 
    LDA.W $0F86,X : ORA.W #$1000 : STA.W $0F86,X 
    LDA.W #Function_Bang_Movement_MovementDelay : STA.W $0FB2,X 
    ...
    ASL A 
    TAY 
    LDA.W BangMaxSpeeds,Y : STA.L $7E7816,X 
    LDA.W $0FB7,X : AND.W #$00FF 
    ASL #2
    TAY 
    LDA.W BangAccelerationIntervalTimeResetValues_accel,Y : STA.L $7E7818,X 
    STA.L $7E781A,X 
    LDA.W BangAccelerationIntervalTimeResetValues_decel,Y : STA.L $7E781C,X 
    LDA.W $0F92,X : BNE .idling 
    LDA.W #Function_Bang_Movement_GetEnemyIndex : STA.W $0FB2,X 

.idling:
    LDA.W #InstList_Bang_Core_Growth0_Idling : STA.W $0F92,X 
    RTL 
...
BangAI_Electricity:
    LDX.W $0E54 
    LDA.L $7E8040,X : CLC : ADC.W #$000A : STA.L $7E8000,X 
...
BangAI_Shell:
    LDX.W $0E54 
    LDA.L $7E7FC0,X : CLC : ADC.W #$0014 : STA.L $7E8000,X 
    JSR.W SetBangInstList 
    LDA.W $0F86,X : ORA.W #$0400 : STA.W $0F86,X 
    RTL 
...
BangAI_Core:
    ...
    LDA.W $0F7A,X : STA.W $0F3A,X 
    STA.W $0FBA,X 
    LDA.W $0F7E,X : STA.W $0F3E,X 
    STA.W $0FBE,X 
    LDY.W $0FAA,X 
    LDA.L $7E8000,X : AND.W #$0001 
    BEQ + 
    LDY.W #$0C00 
  ...
  + LDA.W #$0000 : STA.L $7E8004,X 
    LDA.L $7E8000,X : CMP.W #$0009 : BNE + 
...
FireChargedBeamAtSamus:
    STA.W $1872 
    LDX.W $0E54 
    LDA.W $0CCE : CMP.W #$0005 : BPL .fail 
    LDA.W #$0000 
    TAY 

.loop:
    LDA.W $0C2C,Y : BEQ .zeroDamage 
    INY #2
    BRA .loop 


.zeroDamage:
    LDA.W $0F7A,X : STA.W $0B64,Y 
    LDA.W $0F7E,X : STA.W $0B78,Y 
    LDA.W $1872 : STA.W $0C04,Y 
    LDA.W $09A6 : AND.W #$000F 
    ORA.W #$0010 
    STA.W $0C18,Y 
    INC.W $0CCE 
    STY.B $14 
    JSL.L ProjectileReflection 
    LDA.W $0FB0,X : STA.W $0C2C,Y 
...
Function_Bang_Movement_MovementDelay:
    ...
    BNE .return 
    LDA.W #$0010 : STA.L $7E7800,X 
    LDA.W #Function_Bang_Movement_TargetSamus : STA.W $0FB2,X 
...
Function_Bang_Movement_TargetSamus:
    ...
    SEC : SBC.W #$0040 : AND.W #$00FF 
    STA.L $7E7802,X 
    LDA.W #Function_Bang_Movement_Accelerating : STA.W $0FB2,X 
...
TriggerBangDecelerationIfTooFarOffTarget:
    ...
    SEC : SBC.W #$0040 : AND.W #$00FF 
    STA.L $7E7804,X 
    SEC : SBC.L $7E7802,X : JSL.L Sign_Extend_A 
    JSL.L NegateA_A0B067 
    CMP.W #$0030 : BMI .return 
    LDA.W #Function_Bang_Movement_Decelerating : STA.W $0FB2,X 
...
Function_Bang_Movement_Decelerating:
    ...
    LDA.L $7E7814,X : BNE .delay 
    BMI .delay 
    LDA.L $7E7812,X : BEQ .delay 
    BPL .return 
...
AccelerateBang:
    ...
    STA.L $7E7818,X 
    BPL .return 
    LDA.L $7E781A,X : STA.L $7E7818,X 
    LDA.L $7E7814,X : CMP.L $7E7816,X : BPL .return 
    LDA.L $7E7812,X : CLC : ADC.W #$0016 : STA.L $7E7812,X 
    LDA.L $7E7814,X : CLC : ADC.L $7E7812,X : STA.L $7E7814,X 
...
DecelerateBang:
    ...
    STA.L $7E7818,X 
    BPL .return 
    LDA.L $7E781C,X : STA.L $7E7818,X 
    LDA.L $7E7812,X : SEC : SBC.W #$0016 : STA.L $7E7812,X 
    LDA.L $7E7814,X : SEC : SBC.L $7E7812,X : STA.L $7E7814,X 
...
SetBangInstList:
    LDX.W $0E54 
    LDA.L $7E8000,X : CMP.L $7E8002,X : BEQ .return 
    STA.L $7E8002,X 
    ASL A 
    TAY 
    LDA.W InstListPointers_Bang,Y : STA.W $0F92,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
EnemyShot_Bang:
    LDX.W $0E54 
    LDA.W $0FB2,X : CMP.W #Function_Bang_Movement_GetEnemyIndex : BEQ .RTSFunction 
    LDA.W $18A6 
    ASL A 
    TAY 
    ...
    ASL A 
    TAY 
    LDA.W BangAngles,Y : STA.L $7E7802,X 
    LDA.W #Function_Bang_Movement_Decelerating : STA.W $0FB2,X 
    LDA.W #$0000 : STA.L $7E780E,X 
    STA.L $7E7810,X 
    LDA.W #$0100 : STA.L $7E7812,X 
    LDA.W #$0600 : STA.L $7E7814,X 

.RTSFunction:
    LDA.L $7E8000,X : CMP.W #$0009 : BNE .notIndex9 
    RTL 
...
.notIndex9:
    ...
    ASL A 
    TAY 
    LDA.W $0C2C,Y : CLC : ADC.W $0FB0,X : STA.W $0FB0,X 
    LDA.W $0C04,Y : ORA.W #$0010 : STA.W $0C04,Y 
    LDX.W $0E54 
    LDA.L $7E8000,X : CMP.W #$0009 : BEQ + 
    RTL 
...
InitAI_Skree:
    ...
    STZ.W $0FAE,X 
    STZ.W $0FB0,X 
    LDA.W #InstList_Skree_Idling : STA.W $0F92,X 
    LDA.W #Function_Skree_Idling : STA.W $0FAA,X 
    RTL 
...
Function_Skree_Idling:
  ...
  + CMP.W #$0030 : BCS .return 
    ...
    LDA.W #Function_Skree_PrepareToLaunchAttack : STA.W $0FAA,X 
...
Function_Skree_LaunchedAttack:
    ...
    BCS .collision 
    LDX.W $0E54 
    LDA.W $0F7E,X : CLC : ADC.W #$0006 : STA.W $0F7E,X 
    LDA.W #$0001 : STA.W $0E24 
    LDA.W $0F7A,X : CMP.W $0AF6 : BMI .steerRight 
    LDA.W #$FFFF : STA.W $0E24 
...
SetSkreeInstListPointer:
    ...
    ASL A 
    TAY 
    LDA.W InstListPointers_Skree,Y : STA.W $0F92,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
...
Instruction_Yard_DirectionInY:
    PHY 
    LDA.W $0000,Y : STA.L $7E780E,X 
    ASL #3
    TAY 
    LDA.W YardDirectionData_airborneFacingDirection,Y : STA.L $000FAC,X 
    PLY 
    INY #2
    RTL 
...
Instruction_Yard_MoveByPixelsInY:
    LDA.W $0000,Y : CLC : ADC.W $0F7A,X : STA.W $0F7A,X 
    LDA.W $0002,Y : CLC : ADC.W $0F7E,X : STA.W $0F7E,X 
    INY #4
    RTL 


Instruction_Yard_GoBack4BytesIfHidingOr50PercentChance:
    LDA.L $7E7810,X : CMP.W #$0002 : BEQ .goBack 
    JSL.L GenerateRandomNumber 
    BIT.W #$0001 
    BNE .goBack 
    RTL 
...
InitAI_Yard:
    LDX.W $0E54 
    LDA.W #RTL_A3CF5F : STA.W $0FB2,X 
    LDA.W #Spritemap_CommonA3_Nothing : STA.W $0F8E,X 
    LDA.W #$0001 : STA.W $0F94,X 
    LDA.W $0F92,X 
    ASL #3
    TAY 
    LDA.W YardDirectionData_crawlingInstList,Y : STA.W $0F92,X 
    LDA.W YardDirectionData_movementDirection,Y : ORA.W $0F86,X : STA.W $0F86,X 
    LDA.W YardDirectionData_hidingInstList,Y : STA.W $0FAE,X 
    LDA.W YardDirectionData_airborneFacingDirection,Y : STA.W $0FAC,X 
    LDA.W #$0000 : STA.L $7E7810,X 
    LDA.W $0FB4,X : STA.L $7E780C,X ; fallthrough to SetYardCrawlingVelocities

SetYardCrawlingVelocities:
    LDA.W YardCrawlingVelocitySigns_X,Y : STA.B $12 
    LDA.W YardCrawlingVelocitySigns_X+2,Y : STA.B $14 
    LDA.W YardCrawlingVelocitySigns_Y,Y : STA.B $16 
    LDA.W YardCrawlingVelocitySigns_Y+2,Y : STA.B $18 
    LDA.W $0FB4,X 
    ASL A 
    TAY 
    LDA.W YardCrawlingSpeeds,Y 
    EOR.B $12 
    CLC : ADC.B $14 : STA.W $0FA8,X 
    LDA.W YardCrawlingSpeeds,Y 
    EOR.B $16 
    CLC : ADC.B $18 : STA.W $0FAA,X 
    RTL 
...
SetYardCrawlingMovementFunction:
    ...
    ASL A 
    TAY 
    LDA.W YardCrawlingMovementFunctions,Y : STA.W $0FB2,X 
    RTL 
...
DropYardIfSuperMissileQuake:
    LDA.L $7E7810,X : CMP.W #$0003 : BEQ .return 
    CMP.W #$0004 : BEQ .return 
    CMP.W #$0005 : BEQ .return 
    LDA.W $1840 : CMP.W #$001E : BNE .return 
    LDA.W $183E : CMP.W #$0014 : BNE .return 
    JSR.W DropYard 
...
HandleYardHiding:
    LDA.L $7E7810,X : CMP.W #$0001 : BEQ .return1 
    CMP.W #$0003 : BEQ .return1 
    CMP.W #$0004 : BEQ .return1 
    CMP.W #$0005 : BEQ .return1 
    LDA.W $0F7E,X : SEC : SBC.W $0AFA : CMP.W #$FFA0 : BMI .crawl 
    LDA.W $0F7A,X : CMP.W $0AF6 : BMI .leftOfSamus 
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0008 : BNE .crawl 
    BRA + 


.leftOfSamus:
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BNE .crawl 

  + LDA.L $7E7810,X : CMP.W #$0002 : BEQ .return0 
    LDA.W $0FAE,X : CMP.W #RTL_A3CF5F : BEQ .crawl 
    STA.W $0F92,X 
    LDA.W #Spritemap_CommonA3_Nothing : STA.W $0F8E,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #$0002 : STA.L $7E7810,X 
...
DetermineIfYardHitboxIsSolidToSamus:
    LDA.W $0FB2,X : CMP.W #Function_Yard_Movement_Airborne : BEQ .notSolid 
    LDA.L $7E7810,X : CMP.W #$0001 : BEQ .aggressivelyCrawling 
    LDA.W $0B3C : BNE .notSolid 
    LDA.L $7E7810,X : CMP.W #$0002 : BEQ .solid 
...
.aggressivelyCrawling:
    LDA.W $0B3C : BNE .notSolid 
    LDA.W $0FB2,X : CMP.W #RTL_A3CF5F : BEQ .solid 
    BRA .notSolid 
...
.notSolid:
    LDA.W $0F86,X : AND.W #$7FFF : STA.W $0F86,X 
    RTS 
...
Function_Yard_Movement_Hiding:
    LDA.L $7E780E,X : CMP.W #$0004 : BCS .notMovingVertically 
    STZ.B $12 
    STZ.B $14 
...
Function_Yard_Movement_Crawling_UpsideUp_MovingLeft:
    LDA.L $7E780A,X : BNE .upsideUpMovingLeftNoTurnTransition 
...
Function_Yard_Movement_Crawling_UpsideDown_MovingRight:
    LDA.L $7E780A,X : BNE .upsideDownMovingRightNoTurnTransition 
...
Function_Yard_Movement_Crawling_UpsideUp_MovingRight:
    LDA.L $7E780A,X : BNE .upsideUpMovingRightNoTurnTransition 
...
Function_Yard_Movement_Crawling_UpsideDown_MovingLeft:
    LDA.L $7E780A,X : BNE .upsideDownMovingLeftNoTurnTransition 
...
MoveYardAheadForOutsideTurnCheck:
    LDA.W $0F7A,X : CLC : ADC.W $0000,Y : STA.W $0F7A,X 
    LDA.W $0F7E,X : CLC : ADC.W $0002,Y : STA.W $0F7E,X 
    RTS 


MoveYardBackForOutsideTurnCheck:
    PHP 
    LDA.W $0F7A,X : SEC : SBC.W $0000,Y : STA.W $0F7A,X 
    LDA.W $0F7E,X : SEC : SBC.W $0002,Y : STA.W $0F7E,X 
    PLP 
    RTS 
...
HandleTurnTransitionDisabling:
    ...
    LDA.L $7E7808,X 
    INC A 
    CMP.W #$0010 : BCS .enableTurnTransition 
    STA.L $7E7808,X 
    RTS 
...
DropYard:
    PHY 
    LDA.L $7E7810,X : CMP.W #$0003 : BEQ .return 
    LDA.W #$0003 : STA.L $7E7810,X 
    LDA.W #Function_Yard_Movement_Airborne : STA.W $0FB2,X 
    LDA.W $0FAC,X 
    ASL #2
    TAY 
    LDA.W .airbornePointers,Y : STA.W $0F92,X 
    LDA.W .hidingPointers,Y : STA.W $0FAE,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W #$0000 : STA.L $7E7804,X 
    STA.L $7E7806,X 
...
Function_Yard_Movement_Airborne:
    LDA.L $7E7810,X : CMP.W #$0003 : BEQ .XMovementEnd 
    LDA.L $7E7804,X : STA.B $12 
    LDA.L $7E7806,X : STA.B $14 
    JSL.L MoveEnemyRightBy_14_12_IgnoreSlopes 
    BCS .hitWall 
    LDA.L $7E7806,X : BMI .right 
    LDA.W #$1000 
    EOR.W #$FFFF 
    INC A 
    STA.B $16 
...
.XMovementEnd:
    ...
    LDA.L $7E7802,X : STA.B $14 
    JSL.L MoveEnemyDownBy_14_12 
    BCS .collidedVertically 
    CLC 
    LDA.L $7E7800,X : ADC.W #$2000 : STA.L $7E7800,X 
    LDA.L $7E7802,X : ADC.W #$0000 : CMP.W #$0004 : BPL .return 
    STA.L $7E7802,X 
...
.land:
    ...
    STA.L $7E7808,X 
    LDA.W #$0001 : STA.L $7E780A,X 
    LDA.L $7E7810,X : CMP.W #$0003 : BEQ .dropped 
    LDA.W #$0001 : STA.L $7E7810,X 
    LDA.W #$0008 : STA.W $0FB4,X 
...
.dropped:
  ...
  + LDA.W $0F86,X : AND.W #$FFFC 
    ORA.W $0FAC,X 
    STA.W $0F86,X 
    JSL.L InitAI_Crawlers_Common 
    LDA.W #RTL_A3CF5F : STA.W $0FB2,X 
    LDA.W $0FAE,X : STA.W $0F92,X 
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    RTL 
...
UNUSED_MakeYardFaceSamus_A3D315:
    LDA.L $7E780A,X : BEQ .turningEnabled 
    CLC 
    RTL 


.turningEnabled:
    LDA.L $7E780E,X : CMP.W #$0004 : BCS MakeYardFaceSamusHorizontally 
    BIT.W #$0001 
    BNE .movingDown 
    LDA.W $0F7E,X : CMP.W $0AFA : BCC TurnYardAround 
    CLC 
    RTL 


.movingDown:
    LDA.W $0F7E,X : CMP.W $0AFA : BCS TurnYardAround 
    RTL 
endif ; !FEATURE_KEEP_UNREFERENCED


MakeYardFaceSamusHorizontally:
    LDA.W $0FAC,X : BNE .facingRight 
    LDA.W $0F7A,X : CMP.W $0AF6 : BCC TurnYardAround 
    CLC 
    RTL 


.facingRight:
    LDA.W $0F7A,X : CMP.W $0AF6 : BCS TurnYardAround 
    RTL 


TurnYardAround:
    LDA.L $7E7810,X : CMP.W #$0002 : BEQ .failed 
    LDA.W $0FB2,X : CMP.W #RTL_A3CF5F : BEQ .failed 
    LDA.L $7E780E,X 
    ASL A 
    TAY 
    LDA.W YardOppositeDirection,Y : STA.L $7E780E,X 
    ASL #3
    TAY 
    LDA.W YardDirectionData_crawlingInstList,Y : STA.W $0F92,X 
    LDA.W $0F86,X : AND.W #$FFFC 
...
EnemyTouch_Yard:
    LDX.W $0E54 
    LDA.L $7E7810,X : CMP.W #$0001 : BNE .notAggressiveCrawling 
    LDA.W $0FB2,X : CMP.W #RTL_A3CF5F : BEQ .notAggressiveCrawling 
...
.notAggressiveCrawling:
    LDA.W $0FB2,X : CMP.W #Function_Yard_Movement_Airborne : BEQ .kicked 
    LDA.W $0B3C : BEQ .notKicked 

.kicked:
    JSR.W KickYardIntoAIr 
    LDA.W $0FB2,X : CMP.W #Function_Yard_Movement_Airborne : BNE .returnUpper 
    LDA.W #$0070 : JSL.L QueueSound_Lib2_Max3 
...
.notKicked:
    LDA.W $0FB2,X : CMP.W #RTL_A3CF5F : BEQ .returnLower 
    LDA.L $7E7810,X : CMP.W #$0004 : BEQ .returnLower 
    CMP.W #$0003 : BEQ .returnLower 
    JSL.L CommonA3_NormalEnemyTouchAI 
    LDA.L $7E780C,X : STA.W $0FB4,X 
    LDA.L $7E7810,X : CMP.W #$0000 : BEQ .setIdleCrawling 
...
CheckIfSamusIsDirectingTowardsYard:
    ...
    DEC A 
    STA.B $12 
    LDA.W $0FAC,X : AND.W #$0001 : STA.B $14 
    LDA.B $12 : BNE .notPressingRight 
    LDA.B $14 : BEQ .towardsYard 
    BRA .awayFromYard 


.notPressingRight:
    LDA.B $14 : BEQ .awayFromYard 
    BRA .towardsYard 
...
UNUSED_CheckIfYardIsMovingTheDirectionSamusIsFacing_A3D446:
    LDA.W $0FA8,X : BPL .positiveXVelocity 
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0008 : BNE .movingDirectionSamusFacing 
    BRA .movingOppositeDirection 


.positiveXVelocity:
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BNE .movingDirectionSamusFacing 
    BRA .movingOppositeDirection 
...
.shot:
    LDA.L $7E7810,X : CMP.W #$0003 : BEQ .playSFX 
...
KickYardIntoAIr:
    ...
    LDA.W #$0001 : STA.W $0F94,X 
    STZ.W $0F90,X 
    LDA.W $0DA4 : STA.L $7E7804,X 
    LDA.W $0DA2 : STA.L $7E7806,X 
    CMP.W #$0010 : BCC + 
    LDA.W #$000F 
...
ShootYardIntoAir:
    ...
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BNE .SamusFacingRight 
    LDA.W #$FFFF : STA.L $7E7806,X 
    BRA .return 
...
.loop:
    LDA.W ReflecPaletteCycleColors,Y : STA.L $7EC112,X 
    INY #2
    INX #2
    DEC.W $060B 
    BNE .loop 
...
InitAI_Reflec:
    ...
    LDA.W #EnemyGraphicsDrawnHook_Reflec_PeriodicallyCyclePalettes : STA.W $178C 
    LDA.W #EnemyGraphicsDrawnHook_Reflec_PeriodicallyCyclePalettes>>16 : STA.W $178E 
    LDA.W $0F96,X 
    ASL #4
    AND.W #$FF00 
    XBA 
...
Function_Reflec_ReflectionOffset_Vertical_UpRight_DownRight:
    LDX.W $0E54 
    LDA.W $0F7A,X : SEC : SBC.W #$0008 : STA.W $0E36 
    LDA.W $0B64,Y : CLC : ADC.W $0BB4,Y : CMP.W $0E36 : BPL .return1 
    LDA.W #$0000 
    RTS 
...
Function_Reflec_ReflectionOffset_Vertical_UpLeft_DownLeft:
    LDX.W $0E54 
    LDA.W $0F7A,X : CLC : ADC.W #$0008 : STA.W $0E36 
    LDA.W $0B64,Y : SEC : SBC.W $0BB4,Y : CMP.W $0E36 : BMI .return1 
    LDA.W #$0000 
    RTS 
...
Function_Reflec_ReflectionOffset_UpRightDiagonal_Up:
    LDX.W $0E54 
    LDA.W $0F7A,X : STA.W $0E36 
    LDA.W $0B64,Y : CLC : ADC.W $0BB4,Y : CMP.W $0E36 : BMI .return1 
    LDA.W #$0000 
    RTS 
...
Function_Reflec_ReflectionOffset_UpRightDiagonal_Right:
    LDX.W $0E54 
    LDA.W $0F7E,X : STA.W $0E36 
    LDA.W $0B78,Y : SEC : SBC.W $0BC8,Y : CMP.W $0E36 : BPL .return1 
    LDA.W #$0000 
    RTS 
...
Function_Reflec_ReflectionOffset_UpRightDiagonal_Down:
    LDX.W $0E54 
    LDA.W $0F7A,X : STA.W $0E36 
    LDA.W $0B64,Y : SEC : SBC.W $0BB4,Y : CMP.W $0E36 : BPL .return1 
    LDA.W #$0000 
    RTS 
...
Function_Reflec_ReflectionOffset_UpRightDiagonal_Left:
    LDX.W $0E54 
    LDA.W $0F7E,X : STA.W $0E36 
    LDA.W $0B78,Y : CLC : ADC.W $0BC8,Y : CMP.W $0E36 : BMI .return1 
    LDA.W #$0000 
    RTS 
...
Function_Reflec_ReflectionOffset_Horizontal_UpRight_UpLeft:
    LDX.W $0E54 
    LDA.W $0F7E,X : CLC : ADC.W #$0008 : STA.W $0E36 
    LDA.W $0B78,Y : SEC : SBC.W $0BC8,Y : CMP.W $0E36 : BMI .return1 
    LDA.W #$0000 
    RTS 
...
Func_Reflec_ReflectionOffset_Horizontal_DownRight_DownLeft:
    LDX.W $0E54 
    LDA.W $0F7E,X : SEC : SBC.W #$0008 : STA.W $0E36 
    LDA.W $0B78,Y : CLC : ADC.W $0BC8,Y : CMP.W $0E36 : BPL .return1 
    LDA.W #$0000 
    RTS 
...
Function_Reflec_ReflectionOffset_DownRightDiagonal_Right:
    LDX.W $0E54 
    LDA.W $0F7E,X : STA.W $0E36 
    LDA.W $0B78,Y : CLC : ADC.W $0BC8,Y : CMP.W $0E36 : BPL .return0 
    LDA.W #$0001 
    RTS 
...
InitAI_HZoomer:
    ...
    ASL A 
    TAY 
    LDA.W HZoomerInitialInstListPointers,Y : STA.W $0F92,X 
    LDA.W #.return : STA.W $0FB2,X 
    LDA.W $0FB4,X 
    ASL A 
    TAY 
    LDA.W CrawlersSpeedTable,Y : STA.W $0FA8,X 
    STA.W $0FAA,X 
    LDA.W $0F86,X : AND.W #$0003 
    BNE + 
    LDA.W $0FA8,X 
...
Function_HZoomer_CrawlingVertically:
    LDA.W $1840 : CMP.W #$001E : BNE .noQuake 
    LDA.W $183E : CMP.W #$0014 : BNE .noQuake 
    LDA.W $0FB2,X : STA.L $7E7806,X 
    LDA.W #Function_Crawlers_Falling : STA.W $0FB2,X 
...
.moveDown:
    ...
    BCS .insideTurn 
    LDX.W $0E54 
    LDA.W $0AFA : SEC : SBC.W $0F7E,X : BPL .SamusRightOfZHoomer 
    LDA.W $0FAA,X : BMI .return 
    BRA .negateY 


.SamusRightOfZHoomer:
    LDA.W $0FAA,X : BPL .return 
...
.moveRight:
    ...
    JSL.L AlignEnemyYPositionWIthNonSquareSlope 
    LDX.W $0E54 
    LDA.W $0AF6 : SEC : SBC.W $0F7A,X : BPL .SamusToTheRight 
    LDA.W $0FA8,X : BMI .return 
    BRA .negate 


.SamusToTheRight:
    LDA.W $0FA8,X : BPL .return 
...
InitAI_Zeela:
    ...
    ASL A 
    TAY 
    LDA.W InitialInstListPointers_Crawlers,Y : STA.W $0F92,X 
    JMP.W InitAI_Crawlers_Common 
...
InitAI_Zoomer_MZoomer:
    ...
    ASL A 
    TAY 
    LDA.W InitialInstListPointers_Crawlers,Y : STA.W $0F92,X ; fallthrough to InitAI_Crawlers_Common

InitAI_Crawlers_Common:
    LDA.W #Spritemap_CommonA3_Nothing : STA.W $0F8E,X 
    LDA.W #$0001 : STA.W $0F94,X 
    LDA.W #.return : STA.W $0FB2,X 
    LDA.W $0FB4,X : CMP.W #$00FF : BEQ .skipSpeedTable 
    ASL A 
    TAY 
    LDA.W CrawlersSpeedTable,Y : STA.W $0FA8,X 
    STA.W $0FAA,X 
...
.insideTurn:
    ...
    STA.W $0FA8,X 
    LDY.W $0FB6,X 
    LDA.W $0FAA,X : BPL .insideTurn_up 
    LDA.W CrawlersInstListPointerTable_upsideDown,Y : BRA + 
...
.negate:
    ...
    STA.W $0FAA,X 
    LDY.W $0FB6,X 
    LDA.W $0FAA,X : BPL .positiveYVelocity 
    LDA.W CrawlersInstListPointerTable_upsideDown,Y : BRA .outsideTurn_up 
...
Function_Crawlers_Falling:
    LDA.L $7E7802,X : STA.B $12 
    LDA.L $7E7804,X : STA.B $14 
    JSL.L MoveEnemyDownBy_14_12 
    BCC .noCollision 
    LDA.W $0FB4,X : CMP.W #$00FF : BNE .skipSpeed 
    LDA.W #$0080 : STA.W $0FA8,X 
    STA.W $0FAA,X 
...
.skipSpeed:
    ...
    STA.L $7E7804,X 
    STA.L $7E7808,X 
    LDA.L $7E7806,X : STA.W $0FB2,X 
    RTL 


.noCollision:
    LDA.L $7E7804,X : CMP.W #$0004 : BPL .fallSpeedCapped 
...
.fallSpeedCapped:
    ...
    LDA.W #Function_Crawlers_CrawlingVertically : STA.W $0FB2,X 
...
.insideTurn:
    ...
    STA.W $0FAA,X 
    LDY.W $0FB6,X 
    LDA.W $0FA8,X : BPL ..left 
    LDA.W CrawlersInstListPointerTable_upsideRight,Y : BRA + 
...
.notFalling:
    ...
    STA.W $0FA8,X 
    LDY.W $0FB6,X 
    LDA.W $0FA8,X : BPL .outsideTurn_left 
    LDA.W CrawlersInstListPointerTable_upsideRight,Y : BRA + 
...
.positiveYVelocity:
    ...
    CMP.W #$1000 : BNE .normalSpeed 
    LDX.W $0DC4 
    LDA.L $7F6402,X : AND.W #$001F 
    CMP.W #$0005 : BCC .normalSpeed 
    ASL #2
    TAX 
    LDY.W .adjustedSpeedMultiplier,X 
    LDX.W $0E54 
    LDA.W $0FA8,X : BPL .multiply 
    EOR.W #$FFFF 
    INC A 
...
FrozenAI_Metroid:
    ...
    DEC.W $0FB0,X 
    LDA.W #$0002 : STA.W $0F9C,X 

.timerExpired:
    LDA.L $7E7800,X 
    TAX 
    LDA.W #$0C00 : STA.L $7EF078,X 
    LDA.W #$0001 : STA.L $7EF2F8,X 
    LDA.W #InstList_SpriteObject_32_MetroidElectricity : STA.L $7EEF78,X 
    LDX.W $0E54 
    LDA.L $7E7802,X 
    TAX 
    LDA.W #$0C00 : STA.L $7EF078,X 
    LDA.W #$0001 : STA.L $7EF2F8,X 
    LDA.W #InstList_SpriteObject_34_MetroidShell : STA.L $7EEF78,X 
    RTL 
...
.flash:
    ...
    LDA.L $7E7800,X 
    TAX 
    LDA.L $7EF078,X : AND.W #$F1FF : STA.L $7EF078,X 
    LDX.W $0E54 
    LDA.L $7E7802,X 
    TAX 
    LDA.L $7EF078,X : AND.W #$F1FF : STA.L $7EF078,X 
...
Function_Metroid_0_ChaseSamus:
    ...
    STZ.B $12 
    STZ.B $14 
    LDA.W $0F7E,X : SEC : SBC.W $0E32 : LSR #2
    STA.B $13 
    AND.W #$2000 
    BEQ + 
    LDA.B $14 : ORA.W #$FFC0 : STA.B $14 
...
Function_Metroid_1_LatchOntoSamus:
    ...
    STZ.B $12 
    STZ.B $14 
    LDA.W $0E32 : SEC : SBC.W $0F7E,X : XBA 
    AND.W #$FF00 
    LSR #3
    STA.B $14 
    AND.W #$1000 
    BEQ + 
    LDA.B $14 : ORA.W #$E000 : STA.B $14 

  + LDA.B $14 : BMI .negativeY 
    CMP.W #$0003 : BCC .moveDown 
    LDA.W #$0003 : BRA .alwaysClamped 
...
.moveDown:
    LDA.B $12 : STA.W $0FAC,X 
    LDA.B $14 : STA.W $0FAE,X 
    LDX.W $0E54 
    JSL.L MoveEnemyDownBy_14_12 
    BCC .notCollidedWithBlock 
    LDX.W $0E54 
...
.notCollidedWithBlock:
    ...
    STZ.B $12 
    STZ.B $14 
    LDA.W $0AF6 : SEC : SBC.W $0F7A,X : XBA 
    AND.W #$FF00 
    LSR #3
    STA.B $14 
    AND.W #$1000 
...
.moveRight:
    LDA.B $12 : STA.W $0FA8,X 
    LDA.B $14 : STA.W $0FAA,X 
    LDX.W $0E54 
    JSL.L MoveEnemyRightBy_14_12_IgnoreSlopes 
    BCC .return 
    LDX.W $0E54 
...
Function_Metroid_3_BombedOffSamus:
    LDX.W $0E54 
    LDA.W $0FB0,X : AND.W #$0003 
    ASL A 
    TAY 
    LDA.W $0F7A,X : CLC : ADC.W BombedOffVelocities_X,Y : STA.W $0F7A,X 
    LDA.W $0F7E,X : CLC : ADC.W BombedOffVelocities_Y,Y : STA.W $0F7E,X 
    STZ.W $0FA8,X 
    STZ.W $0FAA,X 
    STZ.W $0FAC,X 
    STZ.W $0FAE,X 
...
EnemyTouch_Metroid:
    LDA.W $0AFA : SEC : SBC.W #$0008 : STA.W $0E32 
    LDA.W $0A6E : BEQ .normal 
    LDX.W $0E54 
    LDA.W $0FB2,X : CMP.W #$0002 : BEQ .return 
    STZ.W $0FA8,X 
    STZ.W $0FAC,X 
    LDY.W #$0000 
    LDA.W $0F7A,X : SEC : SBC.W $0AF6 : BPL + 
  ...
  + PHA 
    ...
    STA.W $0FA9,X 
    LDY.W #$0000 
    LDA.W $0F7E,X : SEC : SBC.W $0E32 : BPL + 
    LDY.W #$FF00 
...
.skipSFX:
  ...
  + LDA.W $0FB2,X : CMP.W #$0002 : BCS .return 
    LDY.W #$0001 
    LDA.W $0F7A,X : SEC : SBC.W $0AF6 : BPL + 
    EOR.W #$FFFF 
    INC A 
...
.setFunction:
    ...
    STA.W $0FB2,X 
    CMP.W #$0002 : BNE .return 
    LDA.W #InstList_Metroid_DrainingSamus : STA.W $0F92,X 
    LDA.W #$0001 : STA.W $0F94,X 
    RTL 
...
DealMetroidContactDamageToSamus:
    ...
    LSR A 
    BCC .powerSuit 
    LDA.W #$6000 : BRA .merge 


.gravitySuit:
    LDA.W #$3000 : BRA .merge 
...
.notFrozen:
    LDA.W $0FB2,X : CMP.W #$0002 : BNE .notLatched 
    LDA.W $0C18,Y : AND.W #$0F00 
    CMP.W #$0500 : BNE .returnLower 
...
.notLatched:
    ...
    STZ.W $0FAC,X 
    LDY.W #$0000 
    LDA.W $0F7A,X : SEC : SBC.W $0B64,Y : BPL + 
    LDY.W #$FF00 
  ...
  + PHA 
    ...
    STA.W $0FA9,X 
    LDY.W #$0000 
    LDA.W $0F7E,X : SEC : SBC.W $0B78,Y : BPL + 
    LDY.W #$FF00 
