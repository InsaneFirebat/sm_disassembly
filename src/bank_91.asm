...
NormalSamusPoseInputHandler_Crouching:
    ...
    LDA.W $0A1F : AND.W #$00FF 
    BNE .return 
    LDA.W $0AFA : SEC : SBC.W #$0005 : STA.W $0AFA 
    LDA.W $0B14 : SEC : SBC.W #$0005 : STA.W $0B14 
    BRA .return 
...
UNUSED_AutoJumpFromCrouchFall_9180BE:
    LDA.W $0A1C : CMP.W #$0029 : BEQ .fallingNotAiming 
...
.foundTransition:
    LDA.W $0004,Y : CMP.W $0A1C : BEQ .notFound 
    STA.W $0A28 
    STZ.W $0A56 
    SEC 
    RTS 
...
TranslateCustomControllerBindingsToDefaultBindings:
    LDA.B $8F : AND.W #$0F00 : STA.B $12 
    LDA.B $8B : AND.W #$0F00 : STA.B $14 
    LDA.B $8F : BIT.W $09B2 
    BEQ .checkJump12 
    LDA.B $12 : ORA.W #$0040 : STA.B $12 
    LDA.B $8F 

.checkJump12:
    BIT.W $09B4 
    BEQ .checkRun12 
    LDA.B $12 : ORA.W #$0080 : STA.B $12 
    LDA.B $8F 

.checkRun12:
    BIT.W $09B6 
    BEQ .checkItemCancel12 
    LDA.B $12 : ORA.W #$8000 : STA.B $12 
    LDA.B $8F 

.checkItemCancel12:
    BIT.W $09B8 
    BEQ .checkAimUp12 
    LDA.B $12 : ORA.W #$4000 : STA.B $12 
    LDA.B $8F 

.checkAimUp12:
    BIT.W $09BE 
    BEQ .checkAimDown12 
    LDA.W $09BE : BIT.W #$0030 
    BEQ .reloadNewInputs 
    LDA.B $12 : ORA.W #$0010 : STA.B $12 
...
.checkShot14:
    ...
    LDA.B $8B : BIT.W $09B2 
    BEQ .checkJump14 
    LDA.B $14 : ORA.W #$0040 : STA.B $14 
    LDA.B $8B 

.checkJump14:
    BIT.W $09B4 
    BEQ .checkRun14 
    LDA.B $14 : ORA.W #$0080 : STA.B $14 
    LDA.B $8B 

.checkRun14:
    BIT.W $09B6 
    BEQ .checkItemCancel14 
    LDA.B $14 : ORA.W #$8000 : STA.B $14 
    LDA.B $8B 

.checkItemCancel14:
    BIT.W $09B8 
    BEQ .checkAimUp14 
    LDA.B $14 : ORA.W #$4000 : STA.B $14 
    LDA.B $8B 
...
.consultPoseDefinition:
    ...
    ASL #3
    TAX 
    LDA.W PoseDefinitions_newPose,X : AND.W #$00FF 
    CMP.W #$00FF : BEQ .retainCurrentPose 
    STA.W $0A28 
...
Set_ProspectivePoseChangeCommand:
    LDA.W $0A1F : AND.W #$00FF 
    TAX 
    LDA.W .poseChangeCommands,X : AND.W #$00FF 
    CMP.W #$0001 : BEQ .decelerate 
...
Pause_Terminate_Reset_DemoRecorder:
    ...
    LDA.W $0A8A : ORA.W #$8000 : STA.W $0A8A 
...
PreInstruction_DemoInput_BabyMetroidDiscovery_RunningLeft:
    LDA.W $0AF6 : CMP.W #$00B2 : BPL .return 
...
LoadDemoData:
    ...
    ASL A 
    TAX 
    LDA.W DemoData_Pointers,X : CLC : ADC.B $12 : TAX 
    ...
    ASL A 
    TAX 
    LDA.W DemoSamusSetup_Pointers,X : CLC : ADC.B $12 : TAX 
...
DemoSamusSetup_MorphBallFacingLeft:
    LDA.W #$001F : BRA InitializeSamusWithPoseInA 
...
DemoSamusSetup_StandingFacingLeft:
    LDA.W #$0002 : BRA InitializeSamusWithPoseInA 


DemoSamusSetup_FallingFacingLeft:
    LDA.W #$002A : BRA InitializeSamusWithPoseInA 
...
PreInstruction_DemoInput_Normal:
    LDA.W $0998 : CMP.W #$002C : BNE .return 
...
Calc_Xray_HDMADataTable_OffScreen:
    ...
    STA.B $16 
    STY.B $18 
    LDA.B $12 : SEC : SBC.B $14 : STA.B $1A 
    BPL + 
    LDA.W #$0100 : CLC : ADC.B $1A : STA.B $1A 

  + LDA.B $12 : CLC : ADC.B $14 : STA.B $1C 
    CMP.W #$0101 : BMI + 
    SEC : SBC.W #$0100 : STA.B $1C 

  + LDA.B $14 : BNE + 
    LDA.B $12 : CMP.W #$0040 : BEQ .strictlyHorizontal 
    CMP.W #$00C0 : BEQ .strictlyHorizontal 

  + LDA.B $1A : CMP.W #$0080 : BPL + 
    CMP.W #$0040 : BPL .bottomHalf 
    LDA.B $1C : CMP.W #$0040 : BMI .topHalf 
    BRA .right 


  + CMP.W #$00C0 : BPL .topHalf 
    LDA.B $1C : CMP.W #$00C0 : BMI .bottomHalf 
    BRA .left 
...
.merge:
    LDA.B $1A : CMP.W #$0080 : BMI + 
    SEC : SBC.W #$0080 

  + ASL A 
    TAX 
    LDA.W AbsoluteTangentTable,X : STA.B $1E 
    LDA.B $1C : CMP.W #$0080 : BMI + 
    SEC : SBC.W #$0080 
...
.loopLeftOffScreen:
    LDA.B $22 : CLC : ADC.B $1E : STA.B $22 
    BCS + 
    DEY #2
  ...
  + LDA.B $23 : ORA.W #$FF00 : STA.B [$00],Y 
    INY #2
    STY.B $12 
    TYA 
    SEC : SBC.W #$0004 : TAY 
...
.loopRightOffScreen:
    LDA.B $24 : CLC : ADC.B $20 : STA.B $24 
    BCS + 
    INY #2
    CPY.W #$01CC : BMI .loopRightOffScreen 
    STY.B $14 
    JMP.W .rightEdgeEnd 


  + LDA.B $25 : ORA.W #$FF00 : STA.B [$00],Y 
    DEY #2
    STY.B $14 
    TYA 
    CLC : ADC.W #$0004 : TAY 
...
.loopRightOnScreen:
    ...
    LDA.B $25 : ORA.W #$FF00 : STA.B [$00],Y 
    INY #2
    CPY.W #$01CC : BMI .loopRightOnScreen 
    BRA .rightEdgeEnd 
...
.loopRightOffScreen:
    LDA.B $24 : SEC : SBC.B $20 : STA.B $24 
    BCC + 
    DEY #2
  ...
  + LDA.B $24 : AND.W #$FF00 : STA.B [$00],Y 
    INY #2
    STY.B $12 
    TYA 
    SEC : SBC.W #$0004 : TAY 
...
.loopLeftOffScreen:
    LDA.B $22 : SEC : SBC.B $1E : STA.B $22 
    BCC + 
    INY #2
    CPY.W #$01CC : BMI .loopLeftOffScreen 
    STY.B $14 
    JMP.W .leftEdgeEnd 


  + LDA.B $22 : AND.W #$FF00 : STA.B [$00],Y 
    DEY #2
    STY.B $14 
    TYA 
    CLC : ADC.W #$0004 : TAY 
...
Calc_Xray_HDMADataTable_OffScreen_AimedUpwards:
    ...
    LDA.B $16 : STA.B $22 
    STA.B $24 
    LDA.B $1A : CMP.W #$00C0 : BPL + 
    LDX.W #$0000 
    BRA .merge 


  + LDA.B $1C : CMP.W #$00C0 : BPL + 
    LDX.W #$0002 
    BRA .merge 
...
Calc_Xray_HDMADataTable_OffScreen_AimedDownwards:
    ...
    LDA.B $16 : STA.B $22 
    STA.B $24 
    LDA.B $1C : CMP.W #$0080 : BPL + 
    LDX.W #$0000 
    BRA .merge 


  + LDA.B $1A : CMP.W #$0080 : BPL .index4 
    LDX.W #$0002 
    BRA .merge 
...
.loopLeftOnScreen:
    ...
    REP #$20 
    INY #2
    CPY.W #$01CC : BMI .loopLeftOnScreen 
    BRA .leftEdgeEnd 
...
Calc_Xray_HDMADataTable_OffScreen_AimedDownwards_Down:
    ...
    REP #$30 
    PHY 
    LDA.B $20 : BNE .loopRightOffScreen 
    STY.B $12 
    LDA.W #$0000 
...
.next:
    DEY #2
    .loopTop:
    LDA.B [$00],Y : CMP.W #$00FF : BEQ .loopBottom 
    LDA.W #$00FF : STA.B [$00],Y 
    DEY #2
    BPL .loopTop 
...
.loop:
    LDA.B [$00],Y : CMP.W #$00FF : BEQ .return 
    LDA.W #$00FF : STA.B [$00],Y 
    INY #2
    CPY.W #$01CC : BMI .loop 
...
Calc_Xray_HDMADataTable_OnScreen_AimedRight:
    ...
    ASL A 
    TAY 
    LDA.B $17 : ORA.W #$FF00 : STA.B [$00],Y 
    DEY #2
    LDA.B $16 : STA.B $22 
    STA.B $24 
...
Calc_Xray_HDMADataTable_OnScreen_AimedLeft:
    ...
    ASL A 
    TAY 
    LDA.B $16 : AND.W #$FF00 : STA.B [$00],Y 
    DEY #2
    LDA.B $16 : STA.B $22 
    STA.B $24 
...
.loopLeft:
    ...
    BEQ .return 
    INY #2
    CPY.W #$01CC : BPL .return 
    LDA.W #$00FF 

.loopEnd:
    STA.B [$00],Y 
    INY #2
    CPY.W #$01CC : BMI .loopEnd 
...
XraySetup_4_BuildBG2Tilemap_ReadBG2Tilemap_1stScreen:
    PHP 
    REP #$30 
    LDA.W $091F : CLC : ADC.W $0915 : AND.W #$00F0 
    ASL #2
    STA.B $18 
    LDA.W $091D : CLC : ADC.W $0911 : AND.W #$00F0 
    LSR #3
    CLC : ADC.B $18 : STA.B $18 
    LDA.W $091D : CLC : ADC.W $0911 : AND.W #$0100 
    ASL #2
    CLC : ADC.B $18 : STA.B $18 
    STZ.B $16 
    LDA.W #$0010 : STA.B $14 
...
.loopCopyBG1Row:
    LDA.W #$0010 : STA.B $12 
    LDA.B $18 : AND.W #$07E0 : STA.B $1A 
    LDA.B $18 : AND.W #$001F : STA.B $1C 
    STZ.B $1E 

.loopCopyBG1Column:
    LDA.B $1C : CLC : ADC.B $1E : CMP.W #$0020 : BMI + 
    LDA.B $1A : CLC : ADC.W #$0400 : AND.W #$07E0 
    STA.B $1A 
    LDA.W #$0000 : STA.B $1C 
    STA.B $1E 

  + LDA.B $1A : CLC : ADC.B $1C : ADC.B $1E : ASL A 
    TAX 
    LDA.L $7E6000,X 
    PHA 
    LDA.L $7E6002,X 
    ...
    LDA.B $18 : AND.W #$0400 : STA.B $20 
    LDA.B $18 : CLC : ADC.W #$0040 : AND.W #$03FF 
    CLC : ADC.B $20 : STA.B $18 
    LDA.B $16 : CLC : ADC.W #$0040 : STA.B $16 
    DEC.B $14 
    BEQ + 
...
.loopRevealedColumn:
    ...
    LDA.B $16 
    PHA 
    CLC : ADC.W #$07C0 : STA.B $16 
    JSR.W LoadRevealedBlock 
    PLA 
    CLC : ADC.W #$0040 : STA.B $16 
    LDA.B $22 : CLC : ADC.W $07A5 : STA.B $22 
    DEC.B $14 
    BNE .loopRevealedRow 
...
CopyLastBG1BlockOfRowToXrayBG2Tilemap:
    LDA.B $1A : STA.B $20 
    LDA.B $1C : CLC : ADC.B $1E : CMP.W #$0020 : BMI + 
    LDA.B $20 : CLC : ADC.W #$0400 : AND.W #$07E0 
    STA.B $20 
    LDA.W #$0000 
...
LoadRevealedBlockCommand:
    LDA.L $7F6402,X : AND.W #$00FF : STA.B $26 
    TXA 
    ASL A 
    TAX 
    LDA.L $7F0002,X : AND.W #$F000 : STA.B $28 
    LDX.W #$0000 
...
GetBlockTypeAndBTS:
    ...
    STA.W $4202 
    NOP #2
    LDA.B $2A : CLC : ADC.W $4216 : TAX 
    LDA.L $7F6402,X : AND.W #$00FF : STA.B $2E 
    TXA 
    ASL A 
    TAX 
    LDA.L $7F0002,X : AND.W #$F000 : STA.B $30 
    RTS 
...
RevealedBlockCommand_VerticalExtension:
    ...
    LDA.B $28 : STA.B $30 
    LDA.B $26 : BEQ Copy1x1BlockToXrayBG2TilemapIfScrollPLMTrigger 
    BIT.W #$0080 
    BEQ + 
    ORA.W #$FF00 
...
Copy1x1BlockToXrayBG2TilemapIfScrollPLMTrigger:
    LDA.W RevealedBlockTable_1_blockType : CMP.B $30 : BNE .gotoDone 
    LDA.W RevealedBlockTable_1_pointers : STA.B $00 
    LDY.W #$0000 

.loop:
    LDA.B ($00),Y : CMP.W #$FFFF : BEQ .gotoDone 
    CMP.W #$FF00 : BEQ + 
    CMP.B $2E : BEQ + 
    INY #4
    BRA .loop 
...
RevealedBlockCommand_Copy1x1BlockToXrayBG2TilemapIfBrinstar:
    INY #2
    LDA.W $079F : CMP.W #$0001 : BNE .gotoDone 
    JSR.W CopyRevealedBlockCommandArgumentToXrayBG2Tilemap 
...
RevealedBlockCommand_Copy2x1BlockToXrayBG2Tilemap:
    INY #2
    JSR.W CopyRevealedBlockCommandArgumentToXrayBG2Tilemap 
    LDA.B $12 : CMP.W #$0001 : BEQ .gotoDone 
    INY #2
...
XraySetup_5_ReadBG2Tilemap_2ndScreen:
    ...
    BEQ .noReveal 
    LDA.W $1840 : BEQ + 
    LDA.W $091D : CLC : ADC.W $0911 : STA.B $B1 
    LDA.W $091F : CLC : ADC.W $0915 : STA.B $B3 

  + LDA.B $B1 : AND.W #$000F : STA.B $B5 
    LDA.B $B3 : AND.W #$000F : STA.B $B7 
    SEP #$20 
    LDA.B #$49 : STA.B $59 
    REP #$20 
...
CheckIfXrayShouldShowAnyBlocks:
    LDA.W $079B : CMP.W #RoomHeader_Statues : BEQ .return 
    CMP.W #RoomHeader_GlassTunnel : BEQ .return 
    LDA.W $196E : CMP.W #$0024 : BEQ .return 
    LDA.W $179C : CMP.W #$0003 : BEQ .return 
...
PreInstruction_HDMAObject_XraySetup:
    ...
    PHX 
    LDX.W #$1000 
    LDA.W $196E : CMP.W #$0024 : BEQ .fireflea 
    LDX.W #$2000 
    JSL.L CheckIfXrayShouldShowAnyBlocks 
...
.fireflea:
    LDA.B $74 : AND.W #$001F 
    CMP.W #$0007 : BPL .setBackdropColorEnd 
...
HandleBeamChargePalettes:
    LDA.W $0B18 : BNE .chargedShotGlow 
    LDA.W $0D32 : CMP.W #GrappleBeamFunction_Inactive : BNE .noChargeGlow 
    LDA.W $0CD0 : BEQ .noChargeGlow 
    CMP.W #$003C : BMI .noChargeGlow 
    LDA.W $0A6E : CMP.W #$0004 : BNE .notPseudoScrew 
    LDX.W $0A74 
...
.notPseudoScrew:
  ...
  + LDA.W $0B62 : CLC : ADC.B $24 : TAX 
    LDA.W $0000,X 
    TAX 
    JSR.W Load20BytesOfSamusPaletteInX 
    LDA.W $0B62 
    INC #2
    CMP.W #$000C : BMI .setPaletteIndex 
    LDA.W #$0000 
...
HandleMiscSamusPalette:
    LDA.W $0A4A : BNE .gotoSuperSpecial 
    LDA.W $0A48 : BNE .timerNotExpired 
    RTS 
...
.timerNotExpired:
    ...
    LDA.W $1F51 : BNE .noSFX 
    LDA.W $0A44 : CMP.W #RTL_90E8D9 : BNE .notDrained 
    LDA.W $0A1C : CMP.W #$0054 : BEQ .noSFX 
...
.nonHurtSFX:
    ...
    LDA.W $0A1F : AND.W #$00FF 
    CMP.W #$0003 : BEQ .spinning 
    CMP.W #$0014 : BEQ .spinning 
    LDA.W $0CD0 : CMP.W #$0010 : BMI .returnUpper 
    LDA.B $8B : BIT.W $09B2 
    BEQ .returnUpper 
...
.wallJumping:
    LDA.W $09A2 : BIT.W #$0008 
    BEQ .returnWallJump 
    LDA.W $0A96 : CMP.W #$0003 : BMI .resetIndex 

.merge:
    LDX.W $0A74 
    LDA.W .screwAttackPaletteTablePointers,X : STA.B $24 
    LDA.W $0ACE : CLC : ADC.B $24 : TAX 
    LDA.W $0000,X 
    TAX 
    JSR.W Load20BytesOfSamusPaletteInX 
    LDA.W $0ACE 
...
.timerExpired:
    ...
    LDA.W $0ACE 
    INC #2
    CMP.W #$0008 : BMI .storeIndexSpeedBooster 
    LDA.W #$0006 
...
HandleSpeedBoosterShinePalette:
    LDA.W $0A68 : CMP.W #$00AA : BNE .notAA 
    PHA 
...
.CFPaletteTimerExpired:
    ...
    LDA.W $0AD0 : CLC : ADC.W #$0004 : CMP.W #$0028 : BMI .storeTimer 
    LDA.W #$0000 
...
HandleXrayPalette:
    LDA.W $0A80 : BMI .finish 
    BNE .paletteSet 
    LDA.W $0A7A : CMP.W #$0002 : BPL .notWidening 
    DEC.W $0AD0 
    BEQ .timerExpired 
    BPL .returnCarrySet 
...
.timerExpired:
    ...
    LDX.W $0ACE 
    LDA.L SamusPalettes_Visor,X : STA.L $7EC188 
    LDA.W $0ACE : CMP.W #$0004 : BPL .returnCarrySet 
    INC #2
    STA.W $0ACE 
...
Restore_A_Energy_ToSamus:
    ...
    CMP.W $09C4 : BMI .return 
    SEC : SBC.W $09C4 : CLC : ADC.W $09D6 : CMP.W $09D4 : BMI .maxReserve 
    LDA.W $09D4 

.maxReserve:
    STA.W $09D6 
    BEQ .maxEnergy 
    LDA.W $09C0 : BNE .maxEnergy 
...
.noCrash:
    ...
    LDA.W $0A78 : BNE .return 
    LDA.W $09C2 : SEC : SBC.B $12 : STA.W $09C2 
    BPL .return 
    STZ.W $09C2 
...
Restore_A_Missiles_ToSamus:
    ...
    CMP.W $09C8 : BMI .return 
    SEC : SBC.W $09C8 : STA.B $12 
    LDA.W $09C8 : CMP.W #$0063 : BMI .lessThan99 
    LDA.B $12 : CLC : ADC.W $09D8 : STA.W $09D8 
...
.loopClearSamusRAM:
    STA.W $0000,X 
    DEX 
    CPX.W #$0A02 : BPL .loopClearSamusRAM 
    REP #$20 
    LDA.W $0998 : CMP.W #$0028 : BEQ .demo 
...
.demo:
    ...
    STA.W $0A2A 
    STA.W $0A2C 
    LDA.W $079F : CMP.W #$0006 : BNE .notCeres 
...
.loopProjectilePreInstructions:
    ...
    INX #2
    CPX.W #$0014 : BMI .loopProjectilePreInstructions 
...
XraySetup:
    PHP : PHB : PHK : PLB 
    REP #$30 
    LDA.W $0CCC : CMP.W #$0007 : BNE + 
    LDA.W $0CD2 : CMP.W #$0005 : BNE + 
    LDA.W $0A66 : CMP.W #$0002 : BEQ .returnCarryClear 

  + LDA.W $0A1C : CMP.W #$00A4 : BMI .notLanding 
...
.notLanding:
    ...
    LDA.W $0592 : BNE .returnCarryClear 
    LDA.W $0B2E : BNE .returnCarryClear 
    LDA.W $0B2C : BNE .returnCarryClear 
    LDA.W $0A11 : AND.W #$00FF 
    TAX 
    LDA.W .allowedPoses,X : AND.W #$00FF 
...
.crouching:
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BEQ .crouchingFacingLeft 
...
Debug_HandleSelectL_B:
    PHP 
    REP #$30 
    LDA.W $05C5 : AND.W #$8000 
    BNE .checkTileViewer 
    JMP.W .handledInput 


.checkTileViewer:
    LDA.W $0DF6 : BEQ .toggleOn 
    JMP.W .toggleOff 
...
.toggleOn:
    ...
    AND.W #$0FFF 
    CMP.W #$000C : BMI + 
    LDA.W $09A6 : AND.W #$F000 : STA.W $09A6 
  ...
  + JSL.L Update_Beam_Tiles_and_Palette 
    ...
    LDA.W $09A6 : ORA.W #$1000 : STA.W $09A6 
...
.initSamus:
    ...
    LDA.W $0A1C : STA.W $0A20 
    LDA.W $0A1E : STA.W $0A22 
    LDA.W $0B00 : CMP.W #$0018 : BEQ .facingForwardRadius18 
    LDA.W $0AFA : SEC : SBC.W #$0003 : STA.W $0AFA 
    STA.W $0B14 
...
.facingLeft:
  ...
  + LDA.W #$0002 : STA.W $0A9A 
    ...
    ASL #3
    TAX 
    LDA.W PoseDefinitions_YRadius,X : AND.W #$00FF : STA.W $0B00 
    STZ.W $0B46 
    STZ.W $0B48 
    STZ.W $0B2C 
    STZ.W $0B2E 
...
DrainedSamusController_2_ReleaseSamusFromDrainedPose:
    LDA.W $0A1C : CMP.W #$00E8 : BEQ .crouchingFalling 
...
.speedBoosterEquipped:
  ...
  + LDA.W $0D32 : CMP.W #GrappleBeamFunction_Inactive : BEQ .checkCharge 
...
.chargeEquipped:
    LDA.W $0CD0 : CMP.W #$0010 : BMI .playedSFX 
    LDA.W #$0041 : JSL.L QueueSound_Lib1_Max6 

.playedSFX:
    JSL.L LoadSamusSuitPalette 
    LDA.W $09C2 : CMP.W #$001F : BPL .return 
...
PSP_Falling:
    LDA.W $0DC7 : AND.W #$00FF 
    CMP.W #$0004 : BNE .changed 
    RTS 
...
PSP_Landed_MorphBallGrounded_NotBouncing:
    LDA.W $0B2E : CMP.W #$0003 : BMI PSP_Landed_MorphBallGrounded_SecondBounce 
    LDA.W $0A1C : STA.W $0A28 
    CLC 
    RTS 
...
PSP_Landed_SpringBallGrounded_NotBouncing:
    LDA.W $0B2E : CMP.W #$0003 : BMI PSP_Landed_SpringBallGrounded_SecondBounce 
    LDA.W $0A1C : STA.W $0A28 
    CLC 
    RTS 
...
CheckIfProspectivePoseRunsIntoAWall:
    LDA.W $0DCE : BEQ .notKilledBySolidCollision 
    LDA.W $0A1F : AND.W #$00FF 
    CMP.W #$0001 : BEQ .ranIntoWall 

.notKilledBySolidCollision:
    LDA.W $0A28 : CMP.W #$FFFF : BEQ .returnPoseUnchanged 
    ASL #3
    TAX 
    LDA.W PoseDefinitions_movementType,X : AND.W #$00FF 
    CMP.W #$0001 : BNE .returnPoseUnchanged 
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BEQ .facingLeft 
    LDA.W #$0001 : STA.B $12 
    STA.W $0B02 
...
.prospectivePoseRanIntoWall:
    LDA.W $0A28 : BRA .setRanIntoWallPose 
...
UpdateSamusPose:
    ...
    PHA 
    LDA.W $0A32 : CMP.W #$0003 : BEQ .animationFinished 
...
.animationFinished:
    LDA.W $0A30 : CMP.W #$0009 : BNE .superSpecialProspectivePose 
    PLA 
...
.notSuperSpecialProspectivePose:
    LDA.W $0A2A : BPL .specialProspectivePose 
    JSR.W CheckIfProspectivePoseRunsIntoAWall 
    LDA.W $0A28 : BMI .return 
    BRA .prospectivePose 
...
ProspectivePoseCmd_1_Decelerate:
    LDA.W $0B46 : BNE .nonZeroXSpeed 
    LDA.W $0B48 : BNE .nonZeroXSpeed 
...
ProspectivePoseCmd_7_StartTransitionAnimation:
    LDA.W $0A1C : CMP.W #$00DB : BPL .aiming 
...
DetermineKnockbackDirection_Falling:
    LDA.W $0A5A : CMP.W #UNUSED_SamusTimerHackHandler_SpecialFalling_90E41B : BNE DetermineKnockbackDirection_Normal 
    CLC 
    RTS 
...
DetermineKnockbackDirection_Normal:
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BEQ .facingLeft 
    LDA.W $0A54 : BEQ .facingRightKnockbackLeft 
    LDA.B $8B : BIT.W #$0100 
    BNE .pressingRight 
...
.facingLeft:
    LDA.W $0A54 : BEQ .facingLeftKnockbackLeft 
    LDA.B $8B : BIT.W #$0200 
    BNE ..pressingLeft 
    LDA.W #$0002 : STA.W $0A52 
    BRA + 
...
ConnectingGrapple_KillSpeed_ClampScrollingSpeed:
    ...
    LDA.W $0AF6 : SEC : SBC.W #$000C : STA.W $0B10 
    BRA .YPosition 


  + CMP.W #$FFF4 : BPL .YPosition 
    LDA.W $0AF6 : CLC : ADC.W #$000C : STA.W $0B10 

.YPosition:
    LDA.W $0AFA : SEC : SBC.W $0B14 : BMI + 
    CMP.W #$000D : BMI .killSpeed 
    LDA.W $0AFA : SEC : SBC.W #$000C : STA.W $0B14 
    BRA .killSpeed 


  + CMP.W #$FFF4 : BPL .killSpeed 
    LDA.W $0AFA : CLC : ADC.W #$000C : STA.W $0B14 
...
SolidVerticalCollision_Falling:
    LDA.W $0B36 : CMP.W #$0001 : BEQ .fallingUp 
    STZ.W $0B20 
    STZ.W $0B2C 
    STZ.W $0B2E 
...
.spinJumping:
    LDA.W $1F51 : BNE .notEndingSFX 
    LDA.W $0A20 : CMP.W #$0081 : BEQ .screwAttack 
    CMP.W #$0082 : BEQ .screwAttack 
...
HandleLandingGraphics_Crateria:
    LDA.W $1F51 : BNE DeleteLandingAtmosphericGraphics 
    LDA.W $079D : CMP.W #$001C : BEQ .crateriaSpacePirateShaft 
    TAX 
    CPX.W #$0010 : BPL .gotoDelete 
    LDA.W .data,X : AND.W #$00FF 
    BIT.W #$0001 
    BNE .landingSite 
    BIT.W #$0002 
...
.wreckedShipEntrance:
    LDA.W $0AFA : CMP.W #$03B0 : BPL HandleLandingGraphics_Maridia_HandleLandingFootstepSplashes 
    BRA DeleteLandingAtmosphericGraphics 


.landingSite:
    LDA.W $196E : CMP.W #$000A : BNE DeleteLandingAtmosphericGraphics 
...
.nonLiquidPhysics:
    ...
    STA.W $0ADA 
    LDA.W $0AF6 : CLC : ADC.W #$0004 : STA.W $0AE0 
    SEC : SBC.W #$0007 : STA.W $0AE2 
    LDA.B $12 : SEC : SBC.W #$0004 : STA.W $0AE8 
    STA.W $0AEA 
...
.nonLiquidPhysics:
    ...
    LDA.W #$0003 : STA.W $0AD8 
    STA.W $0ADA 
    LDA.W $0AF6 : CLC : ADC.W #$0008 : STA.W $0AE0 
    SEC : SBC.W #$0010 : STA.W $0AE2 
    LDA.B $12 : STA.W $0AE8 
    STA.W $0AEA 
...
HandleLandingGraphics_Brinstar:
    LDA.W $079D : CMP.W #$0008 : BEQ HandleLandingGraphics_Norfair_WreckedShip_HandleLandingDust ; fallthrough to HandleLandingGraphics_Tourian

HandleLandingGraphics_Tourian:
    LDA.W $079D : CMP.W #$0005 : BMI .greaterThan4 
...
MorphBallBounce_MorphBall_NotBouncing:
    LDA.W $0B2E : CMP.W #$0003 : BMI MorphBallBounce_MorphBall_SecondBounce 
    INC.W $0B20 
...
MorphBallBounce_SpringBall_NotBouncing:
    LDA.W $0B2E : CMP.W #$0003 : BMI MorphBallBounce_SpringBall_SecondBounce 
...
SolidVerticalCollision_6:
    LDA.W $0DCE : BEQ .return 
    LDA.W $0A23 : AND.W #$00FF 
    CMP.W #$0009 : BNE .return 
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BEQ .disableHorizontalSlopeDetection 
...
SuperSpecialProspectivePoseCmd_2_ShinesparkFinished:
    JSL.L AlignSamusBottomPositionWithPreviousPose 
    LDA.W #SamusMovementHandler_Normal : STA.W $0A58 
    LDA.W $0998 : CMP.W #$002A : BEQ .demo 
    LDA.W #SamusPoseInputHandler_Normal : STA.W $0A60 
    RTS 
...
SuperSpecialProspectivePoseCmd_3_TransitionAnimationFinished:
    STZ.W $0B20 
    LDA.W $0A94 : CLC : ADC.W $0A9C : STA.W $0A94 
    RTS 


SuperSpecialProspectivePoseCmd_4:
    LDA.W $0911 : CLC : ADC.W #$0080 : STA.W $0AF6 
    STA.W $0B10 
    LDA.W $0915 : CLC : ADC.W #$0080 : STA.W $0AFA 
    STA.W $0B14 
    RTS 


SuperSpecialProspectivePoseCmd_5:
    LDA.W $0AFA : CLC : ADC.W #$0005 : STA.W $0AFA 
    STA.W $0B14 
    RTS 
...
InitializeSamusPose_Running:
    LDA.W $0A23 : AND.W #$00FF 
    CMP.W #$0001 : BNE .notRunning 
    LDA.W #$8000 : STA.W $0A9A 

.notRunning:
    LDA.W $0DF8 : BEQ .returnCarryClear 
    LDA.W $0A1C : CMP.W #$0045 : BEQ .turnLeft 
...
InitializeSamusPose_NormalJumping:
    LDA.W $0A1C : CMP.W #$004E : BEQ .shinesparkFacingLeft 
...
.notShinespark:
    LDA.W $0B42 : BNE .nonZeroExtraRunSpeed 
    LDA.W $0B44 : BNE .nonZeroExtraRunSpeed 
    STZ.W $0B4A 
    BRA + 
...
.nonZeroExtraRunSpeed:
  ...
  + LDA.W $0A1C : CMP.W #$0015 : BEQ .normalJump 
    CMP.W #$0016 : BNE .noAnimationSkip 

.normalJump:
    LDA.W $0A20 : CMP.W #$0055 : BEQ .skipArmCannonMovingUp 
...
InitializeSamusPose_Crouching:
    LDA.W $0A1C : CMP.W #$0085 : BEQ .crouchingAimingUp 
    CMP.W #$0086 : BNE .returnCarryClear 

.crouchingAimingUp:
    LDA.W $0A20 : CMP.W #$00F1 : BEQ .skipArmCannonMovingUp 
...
.spinJumping:
    LDA.W #$0001 : STA.W $0A9A 
    LDA.W $0A22 : AND.W #$000F 
    CMP.W #$0008 : BEQ + 
    CMP.W #$0004 : BNE .notTurningAround 
    LDA.W $0A1E : CMP.W #$0308 : BEQ .speed 
    BRA .notTurningAround 


  + LDA.W $0A1E : CMP.W #$0304 : BNE .notTurningAround 
...
.notTurningAround:
    ...
    JSL.L Get_Samus_BottomTop_Boundary 
    LDA.W $195E : BMI .negativeYPosition 
    CMP.B $14 : BPL .nonLiquidPhysicsRight 
    LDA.W $197E : BIT.W #$0004 
    BNE .nonLiquidPhysicsRight 
...
.negativeYPosition:
    LDA.W $1962 : BMI .nonLiquidPhysicsRight 
    CMP.B $14 : BMI .returnUpperCarryClear 
...
.facingLeft:
    ...
    JSL.L Get_Samus_BottomTop_Boundary 
    LDA.W $195E : BMI .negativeYPosition2 
    CMP.B $14 : BPL .nonLiquidPhysicsLeft 
    LDA.W $197E : BIT.W #$0004 
    BNE .nonLiquidPhysicsLeft 
...
.negativeYPosition2:
    LDA.W $1962 : BMI .nonLiquidPhysicsLeft 
    CMP.B $14 : BMI .returnMiddleCarryClear 
...
InitializeSamusPose_TransitionPoses:
    LDA.W $0A1C : CMP.W #$00F1 : BPL .aiming 
...
InitializeSamusPose_CrouchingTransition:
    LDA.W $0B3E : AND.W #$FF00 
    CMP.W #$0400 : BMI .returnCarryClear 
...
UNUSED_InitializeSamusPose_UnusedPose39_91F7F4:
    LDA.W $0A23 : AND.W #$00FF 
    CMP.W #$0008 : BEQ .wasFalling 
    CMP.W #$0013 : BEQ .wasFalling 
    LDA.W $09A2 : BIT.W #$0000 
...
InitializeSamusPose_TurningAround_OnGround:
    ...
    TAX 
    LDA.W $0A23 : AND.W #$00FF 
    CMP.W #$0010 : BNE .notMoonwalking 
    LDA.W $0A20 
    ASL #3
    TAY 
    LDA.W PoseDefinitions_directionShotsFired,Y : AND.W #$00FF 
    ORA.W #$0100 
    STA.W $0B5E 
    LDA.B $8B : BIT.W $09B4 
    BEQ .standing 
    LDA.W TurningSamusPoses_moonwalk,X : AND.W #$00FF : STA.W $0A1C 
    BRA .done 
...
.standing:
    LDA.W TurningSamusPoses_standing,X : AND.W #$00FF : STA.W $0A1C 
    BRA .done 


.crouching:
    LDA.W TurningSamusPoses_crouching,X : AND.W #$00FF : STA.W $0A1C 
...
InitializeSamusPose_TurningAround_Jumping:
    ...
    LDA.W PoseDefinitions_directionShotsFired,X : AND.W #$00FF 
    TAX 
    LDA.W TurningSamusPoses_jumpingInAir,X : AND.W #$00FF : STA.W $0A1C 
    LDA.W $0B44 : CLC : ADC.W $0B48 : STA.W $0B48 
    LDA.W $0B42 : ADC.W $0B46 : STA.W $0B46 
    STZ.W $0B44 
    STZ.W $0B42 
...
InitializeSamusPose_TurningAround_Falling:
    ...
    LDA.W PoseDefinitions_directionShotsFired,X : AND.W #$00FF 
    TAX 
    LDA.W TurningSamusPoses_falling,X : AND.W #$00FF : STA.W $0A1C 
    LDA.W $0B44 : CLC : ADC.W $0B48 : STA.W $0B48 
    LDA.W $0B42 : ADC.W $0B46 : STA.W $0B46 
    STZ.W $0B44 
    STZ.W $0B42 
...
InitializeSamusPose_MorphBall:
    LDA.W $0A23 : AND.W #$00FF 
    CMP.W #$0004 : BEQ .preserveAnimationFrame 
...
ApplyMomentumIfTurningInMorphBall:
    LDA.W $0A22 : AND.W #$00FF 
    CMP.W #$0008 : BEQ .directionChanged 
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0008 : BEQ .speed 
    BRA .return 
...
InitializeSamusPose_SpringBall:
    LDA.W $0A23 : AND.W #$00FF 
    CMP.W #$0011 : BEQ .preserveAnimationFrame 
...
.nonLiquidPhysics:
    ...
    LDA.W $0AF6 : CLC : ADC.W #$0006 : STA.W $0AE2 
    CLC 
    RTS 


.facingRight:
    LDA.W $0AF6 : SEC : SBC.W #$0006 : STA.W $0AE2 
...
InitializeSamusPose_Shinespark_CF_Drained_DamagedMB:
    LDA.W $0A1C : CMP.W #$00CF : BPL .returnCarryClear 
    SEC : SBC.W #$00C9 : ASL A 
    TAX 
...
.merge:
    LDA.W $0A9A : BMI .return 
    LDA.W $0A1C : CMP.W $0A20 : BEQ .return 
    LDA.W #$0000 : CLC : ADC.W $0A9A : STA.W $0A96 
    TAY 
    LDA.W $0A1C 
    ASL A 
    TAX 
    TYA 
    CLC : ADC.W AnimationDelayTable,X : TAY 
...
HandleJumpTransition_SpringBall_InAir:
    LDA.W $0A1C : CMP.W #$007F : BNE .facingLeft 
    LDA.W $0A23 : AND.W #$00FF 
    CMP.W #$0011 : BEQ .jump 
    BRA .return 
...
UNUSED_HandleJumpTransition_MovementTypeD_91FC42:
    LDA.W $0A1C : CMP.W #$0065 : BNE .notPose65 
    LDA.W $0A20 : CMP.W #$0064 : BEQ .jump 
    BRA .return 


.notPose65:
    CMP.W #$0066 : BNE .return 
    LDA.W $0A20 : CMP.W #$0063 : BNE .return 
...
HandleJumpTransition_NormalJumping:
    LDA.W $0A1C : CMP.W #$004B : BEQ .normalJump 
    CMP.W #$004C : BEQ .normalJump 
    CMP.W #$0055 : BMI .return 
    CMP.W #$005B : BPL .return 

.normalJump:
    LDA.W $0A20 : CMP.W #$0027 : BEQ .crouchJump 
    CMP.W #$0028 : BNE .jump 

.crouchJump:
    LDA.W $0AFA : SEC : SBC.W #$000A : STA.W $0AFA 
...
XraySamusPoseInputHandler:
    ...
    REP #$30 
    LDA.W $0A1F : AND.W #$00FF 
    CMP.W #$000E : BNE .notTurningOnGround 
    JMP.W .turningOnGround 


.notTurningOnGround:
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BEQ .notTurningFacingLeft 
    LDA.B $8B : BIT.W $09AE 
    BEQ .returnMiddle 
    LDA.W #$0100 : SEC : SBC.W $0A82 : STA.W $0A82 
    LDA.W $0A1F : AND.W #$00FF 
    CMP.W #$0005 : BEQ ..crouching 
    LDA.W #$0025 : STA.W $0A1C 
    BRA .notTurningMerge 
...
.turningOnGround:
    LDA.W $0A96 : CMP.W #$0002 : BNE .returnLower 
    LDA.W $0A94 : CMP.W #$0001 : BNE .returnLower 
    LDA.W $0A1E : AND.W #$00FF 
    CMP.W #$0004 : BEQ .turningFacingLeft 
    LDA.W $0A1C : CMP.W #$0026 : BNE ..crouching 
...
.turningFacingLeft:
    LDA.W $0A1C : CMP.W #$0025 : BNE ..XrayCrouching 
...
.larger:
    STA.W $0B00 
    LDA.B $12 : SEC : SBC.W $0B00 : STA.W $0A3A 
    STA.B $12 
    STZ.B $14 
...
.noCollision:
    ...
    LDA.W $0A34 : ORA.W #$0002 : STA.W $0A34 
...
.noCollisionAgain:
    ...
    LDA.W $0A36 : ORA.W #$0002 : STA.W $0A36 
...
PoseChangeCollision_SolidEnemy_FromAbove:
    LDA.W $0A3A : SEC : SBC.W $0A3E : STA.B $12 
    STZ.B $14 
    LDA.W $0B00 
    PHA 
    LDA.W $0A1C 
...
PoseChangeCollision_SolidEnemy_FromBelow:
    LDA.W $0A3A : SEC : SBC.W $0A40 : STA.B $12 
    STZ.B $14 
    LDA.W $0B00 
    PHA 
    LDA.W $0A1C 
...
PoseChangeCollision_Block_FromAbove:
    LDA.W $0A3A : SEC : SBC.W $0A38 : STA.B $12 
    STZ.B $14 
    JSL.L BlockCollisionDetectionDueToChangeOfPose 
    BCS .returnCarrySet 
    LDA.W $0A34 : BIT.W #$0002 
...
PoseChangeCollision_Block_FromBelow:
    LDA.W $0A3A : SEC : SBC.W $0A3C : EOR.W #$FFFF 
    INC A 
    STA.B $12 
    STZ.B $14 
    JSL.L BlockCollisionDetectionDueToChangeOfPose 
    BCS .returnCarrySet 
    LDA.W $0A34 : BIT.W #$0001 
    BNE HandleCollisionFromBothSidesDueToPoseChange 
    LDA.W $0AFA : SEC : SBC.B $12 : STA.W $0AFA 
    STA.W $0B14 
    CLC 
...
HandleBlockCollisionToPoseChange_NoCollision_Enemy_FromAbove:
    LDA.W $0AFA : CLC : ADC.W $0A3E : STA.W $0AFA 
    STA.W $0B14 
    CLC 
    RTS 
...
HandleBlockCollisionToPoseChange_NoCollision_Enemy_FromBelow:
    LDA.W $0AFA : SEC : SBC.W $0A40 : STA.W $0AFA 
    STA.W $0B14 
    CLC 
    RTS 
...
HandleCollisionFromBothSidesDueToPoseChange:
    LDA.W $0B00 : CMP.W #$0008 : BPL .notMorphBall 
    SEC 
    RTS 
...
.facingLeft:
  ...
  + STA.W $0A1C 
    ...
    TAX 
    LDA.L PoseDefinitions_YRadius,X : AND.W #$00FF : STA.B $12 
    LDA.W $0B00 : CMP.B $12 : BPL .returnCarryClear 
